...
def write_c_f90(library, output):
    """Write opencmiss_iron_c.f90 containing Fortran routines

    Arguments:
    output -- File to write to
    """

    output.write('!\n! opencmiss_iron_c.f90. This file is automatically generated '
...
def subroutine_c_names(subroutine):
    """Get the name of the routine as used from C and in opencmiss_iron_c.f90
