...
PROGRAM HELMHOLTZEXAMPLE
  ...
  !CALL DIAGNOSTICS_SET_ON(ALL_DIAG_TYPE,DIAG_LEVEL_LIST,"HelmholtzExample",DIAG_ROUTINE_LIST,ERR,ERROR,*999)
  ...
  CALL GENERATED_MESH_TYPE_SET(GENERATED_MESH,GENERATED_MESH_REGULAR_MESH_TYPE,ERR,ERROR,*999)
  !Set the basis
  ...
  CALL EQUATIONS_SET_SPECIFICATION_SET(EQUATIONS_SET,EQUATIONS_SET_CLASSICAL_FIELD_CLASS,EQUATIONS_SET_HELMHOLTZ_EQUATION_TYPE, &
    & EQUATIONS_SET_NO_SOURCE_HELMHOLTZ_SUBTYPE,ERR,ERROR,*999)
...
!  ENDDO !rank_idx
  ...
  CALL PROBLEM_SPECIFICATION_SET(PROBLEM,PROBLEM_CLASSICAL_FIELD_CLASS,PROBLEM_HELMHOLTZ_EQUATION_TYPE, &
    & PROBLEM_NO_SOURCE_HELMHOLTZ_SUBTYPE,ERR,ERROR,*999)
