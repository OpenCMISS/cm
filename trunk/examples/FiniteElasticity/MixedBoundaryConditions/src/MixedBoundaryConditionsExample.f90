...
PROGRAM MIXEDBOUNDARYCONDITIONSEXAMPLE
  ...
  CALL FIELD_COMPONENT_VALUES_INITIALISE(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,4,-8.0_DP,ERR,ERROR,*999)
  ...
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_DELUDELN_VARIABLE_TYPE,1,2,1,BOUNDARY_CONDITION_FIXED,1.1_DP,ERR, &
    & ERROR,*999)
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_DELUDELN_VARIABLE_TYPE,1,4,1,BOUNDARY_CONDITION_FIXED,1.1_DP,ERR, &
    & ERROR,*999)
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_DELUDELN_VARIABLE_TYPE,1,6,1,BOUNDARY_CONDITION_FIXED,1.1_DP,ERR, &
    & ERROR,*999)
  CALL BOUNDARY_CONDITIONS_SET_NODE(BOUNDARY_CONDITIONS,FIELD_DELUDELN_VARIABLE_TYPE,1,8,1,BOUNDARY_CONDITION_FIXED,1.1_DP,ERR, &
    & ERROR,*999)
