...
!> Main program
PROGRAM LinearElasticity3DCubicHermiteBasis
  ...
  Interpolation(1,:) = &
    & (/CMISSBasisCubicHermiteInterpolation,CMISSBasisCubicHermiteInterpolation,CMISSBasisCubicHermiteInterpolation/)
  Interpolation(2,:) = &
    & (/CMISSBasisCubicHermiteInterpolation,CMISSBasisCubicHermiteInterpolation,CMISSBasisCubicHermiteInterpolation/)
  Interpolation(3,:) = &
    & (/CMISSBasisCubicHermiteInterpolation,CMISSBasisCubicHermiteInterpolation,CMISSBasisCubicHermiteInterpolation/)
  ...
  DisplacementBC%MeshComponent(1)%NumberOfBCNodesForDerivative(3)=4
  DisplacementBC%MeshComponent(1)%NumberOfBCNodesForDerivative(5)=4
  DisplacementBC%MeshComponent(1)%NumberOfBCNodesForDerivative(7)=4
  DisplacementBC%MeshComponent(1)%NumberOfBCNodesForDerivative(8)=4
  ...
  DisplacementBC%MeshComponent(1)%Derivative(3)%NodeNumber(:)=(/1,3,5,7/)
  DisplacementBC%MeshComponent(1)%Derivative(5)%NodeNumber(:)=(/1,3,5,7/)
  DisplacementBC%MeshComponent(1)%Derivative(7)%NodeNumber(:)=(/1,3,5,7/)
  DisplacementBC%MeshComponent(1)%Derivative(8)%NodeNumber(:)=(/1,3,5,7/)
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL CMISSFieldIONodesExport(Fields,"LinearElasticity3DCubicHermiteBasisExample","FORTRAN",Err)
    CALL CMISSFieldIOElementsExport(Fields,"LinearElasticity3DCubicHermiteBasisExample","FORTRAN",Err)
...
END PROGRAM LinearElasticity3DCubicHermiteBasis
