...
gfx modify spectrum flow linear reverse range -1 3 extend_above extend_below rainbow colour_range 0 1 component 2;
...
gfx modify g_element OpenCMISS node_points glyph arrow_solid general size "0.3*0.3*0.3" centre 0,0,0 select_on material default selected_material default_selected data vector_field orientation vector_field scale_factors "0.3*0.3*0.3" spectrum flow
