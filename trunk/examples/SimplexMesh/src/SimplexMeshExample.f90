!> \file
!> $Id: SimplexMeshExample.f90 20 2007-05-28 20:22:52Z cpb $
...
PROGRAM SIMPLEXMESHEXAMPLE
  ...
  !DIAG_LEVEL_LIST(5)=5
  !DIAG_ROUTINE_LIST(1)=""
  !CALL DIAGNOSTICS_SET_ON(ALL_DIAG_TYPE,DIAG_LEVEL_LIST,"SimplexMeshExample",DIAG_ROUTINE_LIST,ERR,ERROR,*999)
  ...
  CALL MESH_TOPOLOGY_ELEMENTS_ELEMENT_NODES_SET(1,MESH_ELEMENTS,(/1,3,7,2,5,4/),ERR,ERROR,*999)
  CALL MESH_TOPOLOGY_ELEMENTS_ELEMENT_NODES_SET(2,MESH_ELEMENTS,(/7,3,9,5,6,8/),ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,2,1,0.5_DP,ERR,ERROR,*999)
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,3,1,1.0_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,5,1,0.5_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,8,1,0.5_DP,ERR,ERROR,*999)
  ...
  CALL FIELD_PARAMETER_SET_UPDATE_NODE(GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,1,4,2,0.5_DP,ERR,ERROR,*999)
