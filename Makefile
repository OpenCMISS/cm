...
$(PYTHON_WRAPPER) $(PYTHON_MODULE) : $(SWIG_INTERFACE) $(HEADER_INCLUDE)
	( cd $(BINDINGS_DIR)/python/opencmiss ; swig -python -o $(PYTHON_WRAPPER) -module opencmiss_swig -outdir . -I$(INC_DIR) $(SWIG_INTERFACE) )
