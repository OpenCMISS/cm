...
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  EXTERNAL_DIR := $(EXTERNAL_ROOT)/$(LIB_ARCH_DIR)$(DEBUG_SUFFIX)$(PROF_SUFFIX)/$(MPI)/$(COMPILER)
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    EXTERNAL_DIR := $(EXTERNAL_ROOT)/$(LIB_ARCH_DIR)$(DEBUG_SUFFIX)$(PROF_SUFFIX)
  else# windows
    EXTERNAL_DIR := $(EXTERNAL_ROOT)/$(LIB_ARCH_DIR)$(DEBUG_SUFFIX)$(PROF_SUFFIX)
  endif
endif
...
TAO_INCLUDE_PATH =#
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  TAO_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
  TAO_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
  TAO_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/finclude )
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    TAO_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
    TAO_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
...
PETSC_INCLUDE_PATH =#
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  PETSC_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
  PETSC_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
  PETSC_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/conf )
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    PETSC_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
    PETSC_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
...
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  SUNDIALS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
  SUNDIALS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    SUNDIALS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
    SUNDIALS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
...
HYPRE_INCLUDE_PATH =#
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  HYPRE_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
  HYPRE_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    HYPRE_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
    HYPRE_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
...
MUMPS_INCLUDE_PATH =#
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  MUMPS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
  MUMPS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    MUMPS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
    MUMPS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
...
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  SCALAPACK_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
  SCALAPACK_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    SCALAPACK_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
    SCALAPACK_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
...
BLACS_INCLUDE_PATH =#
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  BLACS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
  BLACS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
    BLACS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/ )
    BLACS_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/include/ )
...
ifeq ($(OPERATING_SYSTEM),linux)# Linux
  ifeq ($(MPI),mpich2)
    ...
    ifeq ($(MPI),intel)
      ...
      MPI_INCLUDE_PATH += $(addprefix -I, $(EXTERNAL_DIR)/lib/ )
    endif
  endif
else
  ifeq ($(OPERATING_SYSTEM),aix)# AIX
...
OBJECTS = $(OBJECT_DIR)/analytic_analysis_routines.o \
