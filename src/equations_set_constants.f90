...
MODULE EQUATIONS_SET_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ODE_CLASS=9
  ...
  !ODE class
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NONLINEAR_ODE_TYPE=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_LINEAR_ODE_TYPE=2
