...
MODULE EQUATIONS_SET_CONSTANTS
 ...
 !Bioelectrics class
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MOONEY_RIVLIN_ACTIVECONTRACTION_SUBTYPE=20
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STVENANT_KIRCHOFF_ACTIVECONTRACTION_SUBTYPE=21
  !Fluid mechanics class
  !  Stokes equations
