...
!   INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_FINITE_ELASTICITY_DARCY_SUBTYPE=8
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MULTI_COMP_TRANSPORT_ADVEC_DIFF_SUBTYPE=17
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MULTI_COMP_TRANSPORT_ADVEC_DIFF_SUPG_SUBTYPE=18
  !Bioelectrics class
  !  Monodomain equation
  !  Bidomain equation
