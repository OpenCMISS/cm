...
MODULE EQUATIONS_SET_CONSTANTS
 ...
 !Bioelectrics class
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE=9
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE=13
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE=18
