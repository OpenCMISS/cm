...
MODULE EQUATIONS_SET_CONSTANTS
 ...
 !Bioelectrics class
  ...
  !Elasticity class
  !  Linear elasticity
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_THREE_DIMENSIONAL_LINEAR_ELASTICITY_SUBTYPE=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PLANE_STRESS_SUBTYPE=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PLANE_STRAIN_SUBTYPE=3
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PLATE_SUBTYPE=4
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SHELL_SUBTYPE=5
  !  Finite elasticity
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STANDARD_DARCY_SUBTYPE=3
  ...
  !> \brief the analytic representive of darcy equation
  !> \see DARCY_EQUATIONS_ROUTINES
  !>@{
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_1=3 !<???
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_2=4 !<???
 !>@}
