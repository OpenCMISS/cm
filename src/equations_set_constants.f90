...
MODULE EQUATIONS_SET_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INTERFACE_CLASS=9  ! <<>>
 ...
 !Bioelectrics class
  ...
  !Interface class  		<<>>
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INTEGRAL_EQUATION_TYPE=1  ! <<>>
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NODAL_EQUATION_TYPE=2     ! <<>>
  ...
  !Interface equations class  <<>>
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FULL_KINEMATIC_SUBTYPE=1   ! <<>>
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NORMAL_KINEMATIC_SUBTYPE=2   ! <<>>
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_VECTOR_SOURCE_POISSON_SUBTYPE=5
  !  Helmholtz equation
