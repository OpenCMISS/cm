...
MODULE EQUATIONS_SET_CONSTANTS
 ...
 !Bioelectrics class
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANSVERSE_ISOTROPIC_ACTIVE_SUBTYPE=24
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_ACTIVE_TRANSITION_SUBTYPE=25
