...
MODULE EQUATIONS_SET_CONSTANTS
  ...
  !> \see EQUATIONS_SET_CONSTANTS
  !>@{
  INTEGER(INTG), PARAMETER :: NUMBER_OF_EQUATIONS_SET_TIME_TYPES=3 !<The number of problem time dependence types defined. \see EQUATIONS_SET_CONSTANTS_TimeDependenceTypes,EQUATIONS_SET_CONSTANTS
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STATIC=1 !<The problem is static and has no time dependence \see EQUATIONS_SET_CONSTANTS_TimeDependenceTypes,EQUATIONS_SET_CONSTANTS
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC=2 !<The problem is dynamic \see EQUATIONS_SET_CONSTANTS_TimeDependenceTypes,EQUATIONS_SET_CONSTANTS
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_QUASISTATIC=3 !<The problem is quasi-static \see EQUATIONS_SET_CONSTANTS_TimeDependenceTypes,EQUATIONS_SET_CONSTANTS
  !>@}
