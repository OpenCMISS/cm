...
MODULE EQUATIONS_SET_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FMM_CLASS=10
...
! The following types / numbers are already defined above and thus blocked
!   INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_FINITE_ELASTICITY_DARCY_SUBTYPE=8
!   INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE=10
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MAT_PROPERTIES_INRIA_MODEL_GALERKIN_PROJ_SUBTYPE=4
  !Modal class
  ...
  !>@{
  INTEGER(INTG), PARAMETER :: NUMBER_OF_EQUATIONS_LINEARITY_TYPES=4 !<The number of equations linearity types defined. \see EQUATIONS_SET_CONSTANTS_LinearityTypes,EQUATIONS_SET_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_STATEITERATION=4 !<The equations have non-linear boundary conditions. \see EQUATIONS_SET_CONSTANTS_LinearityTypes,EQUATIONS_SET_CONSTANTS
  !>@}
