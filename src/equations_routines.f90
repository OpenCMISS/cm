...
998 CALL ERRORS("EQUATIONS_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_INTERPOLATION_FINALISE(EQUATIONS_INTERPOLATION,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_INTERPOLATION)) THEN
      ...
      CALL FIELD_INTERPOLATED_POINT_FINALISE(EQUATIONS_INTERPOLATION%INDEPENDENT_INTERP_POINT,ERR,ERROR,*999)
      ...
      CALL FIELD_INTERPOLATED_POINT_METRICS_FINALISE(EQUATIONS_INTERPOLATION%INDEPENDENT_INTERP_POINT_METRICS,ERR,ERROR,*999)
        ...
        ELSE
          ...
          IF(ASSOCIATED(EQUATIONS%INTERPOLATION%INDEPENDENT_FIELD)) THEN
            CALL FIELD_INTERPOLATION_PARAMETERS_INITIALISE(EQUATIONS%INTERPOLATION%INDEPENDENT_FIELD, &
              & FIELD_U_VARIABLE_TYPE,EQUATIONS%INTERPOLATION%INDEPENDENT_INTERP_PARAMETERS,ERR,ERROR,*999)
            CALL FIELD_INTERPOLATED_POINT_INITIALISE(EQUATIONS%INTERPOLATION%INDEPENDENT_INTERP_PARAMETERS,  &
              & EQUATIONS%INTERPOLATION%INDEPENDENT_INTERP_POINT,ERR,ERROR,*999)
            CALL FIELD_INTERPOLATED_POINT_METRICS_INITIALISE(EQUATIONS%INTERPOLATION%INDEPENDENT_INTERP_POINT,  &
