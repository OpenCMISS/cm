...
MODULE FIELD_ROUTINES
  ...
  PUBLIC FIELD_CREATE_FINISH, &
    ...
    & FIELD_COMPONENT_VALUES_INITIALISE, &
    ...
    & FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_ELEMENT_GET, &
    & FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_LINE_GET, &
...
999 CALL ERRORS("FIELD_INTERPOLATION_PARAMETERS_LINE_GET",ERR,ERROR)
  ...
  SUBROUTINE FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_ELEMENT_GET(ELEMENT_NUMBER,INTERPOLATION_PARAMETERS,ERR,ERROR,*)
    ...
    CALL ENTERS("FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_ELEMENT_GET",ERR,ERROR,*999)
    ...
    CALL EXITS("FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_ELEMENT_GET")
    RETURN
999 CALL ERRORS("FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_ELEMENT_GET",ERR,ERROR)
    CALL EXITS("FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_ELEMENT_GET")
    RETURN 1
  END SUBROUTINE FIELD_INTERPOLATION_PARAMETERS_SCALE_FACTORS_ELEMENT_GET
...
999 CALL ERRORS("FIELD_NEXT_NUMBER_FIND",ERR,ERROR)
  ...
  SUBROUTINE FIELD_NUMBER_OF_COMPONENTS_GET(FIELD,FIELD_VARIABLE_NUMBER,NUMBER_OF_COMPONENTS,ERR,ERROR,*)
    ...
    INTEGER(INTG), INTENT(OUT) :: NUMBER_OF_COMPONENTS !<On return, the number of components to be get.
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    TYPE(VARYING_STRING) :: LOCAL_ERROR
