...
999 CALL ERRORS("GENERATED_MESH_CREATE_FINISH",ERR,ERROR)
  ...
  SUBROUTINE GENERATED_MESH_CREATE_START(USER_NUMBER,REGION,GENERATED_MESH,ERR,ERROR,*)
    ...
    CALL GENERATED_MESH_USER_NUMBER_FIND(USER_NUMBER,NEW_GENERATED_MESH,ERR,ERROR,*999)
    IF(ASSOCIATED(NEW_GENERATED_MESH)) THEN
    ...
    ELSE
      ...
      IF(ASSOCIATED(REGION)) THEN
        ...
        ELSE
          ...
          NEW_GENERATED_MESH%GENERATED_MESH_FINISHED=.FALSE.          
...
999 IF(ALLOCATED(NUMBER_ELEMENTS_XI)) DEALLOCATE(NUMBER_ELEMENTS_XI)
  ...
  SUBROUTINE GENERATED_MESH_CYLINDER_CREATE_FINISH(GENERATED_MESH,MESH_USER_NUMBER,ERR,ERROR,*)
    ...
    TYPE(REGION_TYPE), POINTER :: REGION 
    TYPE(NODES_TYPE), POINTER :: NODES
    INTEGER(INTG) :: TOTAL_NUMBER_OF_NODES_XI(3),TOTAL_NUMBER_ELEMENTS_XI(3)
...
999 CALL ERRORS("MESH_USER_NUMBER_FIND",ERR,ERROR)
  ...
  SUBROUTINE GENERATED_MESHES_FINALISE(ERR,ERROR,*)
    ...
    DO WHILE(GENERATED_MESHES%NUMBER_OF_GENERATED_MESHES>0)
      ...
      CALL GENERATED_MESH_DESTROY_NUMBER(USER_NUMBER,ERR,ERROR,*999)
    ENDDO !generated_mesh_idx
...
999 CALL ERRORS("GENERATED_MESH_REGULAR_GEOMETRIC_PARAMETERS_CALCULATE",ERR,ERROR)
  ...
  SUBROUTINE GENERATED_MESH_CYLINDER_GEOMETRIC_PARAMETERS_CALCULATE(CYLINDER_MESH,FIELD,ERR,ERROR,*)
    ...
    REAL(DP) :: CYLINDER_EXTENT(3),ORIGIN(3),DERIV
    TYPE(VARYING_STRING) :: LOCAL_ERROR
