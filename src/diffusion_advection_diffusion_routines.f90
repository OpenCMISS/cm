...
CONTAINS
  ...
  SUBROUTINE DIFFUSION_ADVEC_DIFF_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("DIFFUSION_ADVEC_DIFF_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    EXITS("DIFFUSION_ADVEC_DIFF_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("DIFFUSION_ADVEC_DIFF_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    ENTERS("DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SETUP",ERR,ERROR,*999)

          CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
             
    EXITS("DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SETUP")
    RETURN
999 ERRORSEXITS("DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SETUP",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DIFFUSION_ADVECTION_DIFFUSION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("DIFFUSION_ADVECTION_DIFFUSION_FINITE_ELEMENT_CALCULATE",ERR,ERROR,*999)

    CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
      
  EXITS("DIFFUSION_ADVECTION_DIFFUSION_FINITE_ELEMENT_CALCULATE")
    RETURN
999 ERRORSEXITS("DIFFUSION_ADVECTION_DIFFUSION_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR,*999)
    
    CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
       
    EXITS("DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SUBTYPE_SET")
    RETURN
999 ERRORSEXITS("DIFFUSION_ADVECTION_DIFFUSION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DIFFUSION_ADVECTION_DIFFUSION_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("DIFFUSION_ADVECTION_DIFFUSION_PROBLEM_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("DIFFUSION_ADVECTION_DIFFUSION_PROBLEM_SUBTYPE_SET")
    RETURN
999 ERRORSEXITS("DIFFUSION_ADVECTION_DIFFUSION_PROBLEM_SUBTYPE_SET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DIFFUSION_ADVECTION_DIFFUSION_POST_SOLVE",ERR,ERROR)
  ...
  SUBROUTINE DIFFUSION_ADVECTION_DIFFUSION_POST_SOLVE_OUTPUT_DATA(CONTROL_LOOP,SOLVER,ERR,ERROR,*)
    ...
    ENTERS("DIFFUSION_ADVECTION_DIFFUSION_POST_SOLVE_OUTPUT_DATA",ERR,ERROR,*999)
    ...
    EXITS("DIFFUSION_ADVECTION_DIFFUSION_POST_SOLVE_OUTPUT_DATA")
    RETURN
999 ERRORSEXITS("DIFFUSION_ADVECTION_DIFFUSION_POST_SOLVE_OUTPUT_DATA",ERR,ERROR)
    RETURN 1
