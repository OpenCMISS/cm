...
CONTAINS
  ...
  SUBROUTINE POISEUILLE_EQUATION_ANALYTIC_CALCULATE(EQUATIONS_SET,BOUNDARY_CONDITIONS,ERR,ERROR,*)
    ...
    ENTERS("POISEUILLE_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("POISEUILLE_EQUATION_ANALYTIC_CALCULATE")
    RETURN
999 ERRORSEXITS("POISEUILLE_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SETUP",ERR,ERROR)
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("POISEUILLE_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SUBTYPE_SET")
    RETURN
999 ERRORSEXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    ENTERS("POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP",ERR,ERROR,*999)
...
!!TODO: Check valid setup
    ...
    EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP")
    RETURN
999 ERRORSEXITS("POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("POISEUILLE_EQUATION_PROBLEM_SETUP",ERR,ERROR)
  ...
  SUBROUTINE POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE",ERR,ERROR,*999)
...
!TODO
    ...
    EXITS("POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE")
    RETURN
999 ERRORSEXITS("POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
    RETURN 1
