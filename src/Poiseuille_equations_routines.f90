...
! temporary input for vector-source
  ...
  PUBLIC POISEUILLE_EQUATION_EQUATIONS_SET_SETUP,POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET, &
    & POISEUILLE_EQUATION_ANALYTIC_CALCULATE, &
    & PoiseuilleEquation_EquationsSetSpecificationSet,POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE,POISEUILLE_PRE_SOLVE, &
    & PoiseuilleEquation_ProblemSpecificationSet,POISEUILLE_EQUATION_PROBLEM_SETUP,POISEUILLE_POST_SOLVE
...
CONTAINS
  ...
  SUBROUTINE POISEUILLE_EQUATION_ANALYTIC_CALCULATE(EQUATIONS_SET,BOUNDARY_CONDITIONS,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR,*999)
    ...
    CALL EXITS("POISEUILLE_EQUATION_ANALYTIC_CALCULATE")
    RETURN
999 CALL ERRORS("POISEUILLE_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR)
    CALL EXITS("POISEUILLE_EQUATION_ANALYTIC_CALCULATE")
    RETURN 1
  END SUBROUTINE POISEUILLE_EQUATION_ANALYTIC_CALCULATE
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_EQUATION_EQUATIONS_SET_SETUP",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_STATIC_POISEUILLE_SUBTYPE)
        CALL POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*999)
    ...
    CALL EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SETUP")
    RETURN
999 CALL ERRORS("POISEUILLE_EQUATION_EQUATIONS_SET_SETUP",ERR,ERROR)
    CALL EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SETUP")
    RETURN 1
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 CALL ERRORS("POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    CALL EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN 1
  END SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET

  !
  !================================================================================================================================
  !

  !>Sets the equation specification for a Poiseuille equation type of a fluid mechanics equations set class.
  SUBROUTINE PoiseuilleEquation_EquationsSetSpecificationSet(equationsSet,specification,err,error,*)
    ...
    CALL Enters("PoiseuilleEquation_EquationsSetSpecificationSet",err,error,*999)
    ...
    CALL Exits("PoiseuilleEquation_EquationsSetSpecificationSet")
    RETURN
999 CALL Errors("PoiseuilleEquation_EquationsSetSpecificationSet",err,error)
    CALL Exits("PoiseuilleEquation_EquationsSetSpecificationSet")
    RETURN 1
  END SUBROUTINE PoiseuilleEquation_EquationsSetSpecificationSet
  ...
  SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP",ERR,ERROR,*999)
      ...
      IF(EQUATIONS_SET%SPECIFICATION(3)==EQUATIONS_SET_STATIC_POISEUILLE_SUBTYPE) THEN
        ...
        CASE(EQUATIONS_SET_SETUP_INITIAL_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            CALL POISEUILLE_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,EQUATIONS_SET_FEM_SOLUTION_METHOD,ERR, &
              & ERROR,*999)
...
!!TODO: Check valid setup
    ...
    CALL EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP")
    RETURN
999 CALL ERRORS("POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP",ERR,ERROR)
    CALL EXITS("POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP")
    RETURN 1
  END SUBROUTINE POISEUILLE_EQUATION_EQUATIONS_SET_STATIC_SETUP
  ...
  SUBROUTINE POISEUILLE_EQUATION_PROBLEM_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_EQUATION_PROBLEM_SETUP",ERR,ERROR,*999)
    ...
    CALL EXITS("POISEUILLE_EQUATION_PROBLEM_SETUP")
    RETURN
999 CALL ERRORS("POISEUILLE_EQUATION_PROBLEM_SETUP",ERR,ERROR)
    CALL EXITS("POISEUILLE_EQUATION_PROBLEM_SETUP")
    RETURN 1
  ...
  SUBROUTINE POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE",ERR,ERROR,*999)
...
!TODO
    ...
    CALL EXITS("POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE")
    RETURN
999 CALL ERRORS("POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
    CALL EXITS("POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE")
    RETURN 1
  END SUBROUTINE POISEUILLE_EQUATION_FINITE_ELEMENT_CALCULATE
  ...
  SUBROUTINE PoiseuilleEquation_ProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    CALL Enters("PoiseuilleEquation_ProblemSpecificationSet",err,error,*999)
    ...
    IF(ASSOCIATED(problem)) THEN
      ...
      ELSE
        CALL FlagError("Poiseuille equation problem specification must have three entries.",err,error,*999)
      END IF
    ELSE
      CALL FlagError("Problem is not associated.",err,error,*999)
    END IF

    CALL Exits("PoiseuilleEquation_ProblemSpecificationSet")
    RETURN
999 CALL Errors("PoiseuilleEquation_ProblemSpecificationSet",err,error)
    CALL Exits("PoiseuilleEquation_ProblemSpecificationSet")
    RETURN 1
  END SUBROUTINE PoiseuilleEquation_ProblemSpecificationSet
  ...
  SUBROUTINE POISEUILLE_EQUATION_PROBLEM_STATIC_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_EQUATION_PROBLEM_STATIC_SETUP",ERR,ERROR,*999)
    ...
    CALL EXITS("POISEUILLE_EQUATION_PROBLEM_STATIC_SETUP")
    RETURN
999 CALL ERRORS("POISEUILLE_EQUATION_PROBLEM_STATIC_SETUP",ERR,ERROR)
    CALL EXITS("POISEUILLE_EQUATION_PROBLEM_STATIC_SETUP")
    RETURN 1
  ...
  SUBROUTINE POISEUILLE_POST_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_POST_SOLVE",ERR,ERROR,*999)
    NULLIFY(SOLVER2)
...
!               do nothing
    ...
    CALL EXITS("POISEUILLE_POST_SOLVE")
    RETURN
999 CALL ERRORS("POISEUILLE_POST_SOLVE",ERR,ERROR)
    CALL EXITS("POISEUILLE_POST_SOLVE")
    RETURN 1
  ...
  SUBROUTINE POISEUILLE_PRE_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*)
    ...
    CALL ENTERS("POISEUILLE_PRE_SOLVE",ERR,ERROR,*999)
    NULLIFY(SOLVER2)
...
!               do nothing
    ...
    CALL EXITS("POISEUILLE_PRE_SOLVE")
    RETURN
999 CALL ERRORS("POISEUILLE_PRE_SOLVE",ERR,ERROR)
    CALL EXITS("POISEUILLE_PRE_SOLVE")
    RETURN 1
