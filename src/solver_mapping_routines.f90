...
999 CALL ERRORS("SOLVER_MAPPING_EQUATS_ROW_TO_SOL_ROWS_MAP_INITIALISE",ERR,ERROR)    
  ...
  SUBROUTINE SOLVER_MAPPING_EQUATIONS_SET_ADD(SOLVER_MAPPING,EQUATIONS_SET,EQUATIONS_SET_INDEX,ERR,ERROR,*)
    ...
    INTEGER(INTG), ALLOCATABLE :: NEW_DYNAMIC_VARIABLE_TYPE(:),NEW_MATRIX_VARIABLE_TYPES(:,:,:),NEW_RHS_VARIABLE_TYPE(:), &
      & NEW_RESIDUAL_VARIABLE_TYPE(:),NEW_SOURCE_VARIABLE_TYPE(:)
    LOGICAL :: MATRIX_DONE
    TYPE(EQUATIONS_TYPE), POINTER :: EQUATIONS
    TYPE(EQUATIONS_MAPPING_TYPE), POINTER :: EQUATIONS_MAPPING
                ...
                IF(ASSOCIATED(EQUATIONS_MAPPING)) THEN                
                  IF(ASSOCIATED(SOLVER_MAPPING%CREATE_VALUES_CACHE)) THEN
                    IF(SOLVER_MAPPING%NUMBER_OF_EQUATIONS_SETS>0) THEN
                      ...
                      ALLOCATE(NEW_RESIDUAL_VARIABLE_TYPE(SOLVER_MAPPING%NUMBER_OF_EQUATIONS_SETS+1),STAT=ERR)
                      ...
                      NEW_RESIDUAL_VARIABLE_TYPE(1:SOLVER_MAPPING% &
                        & NUMBER_OF_EQUATIONS_SETS)=SOLVER_MAPPING%CREATE_VALUES_CACHE%RESIDUAL_VARIABLE_TYPE
                      ...
                      NEW_RESIDUAL_VARIABLE_TYPE(SOLVER_MAPPING%NUMBER_OF_EQUATIONS_SETS+1)=0
                      ...
                      CALL MOVE_ALLOC(NEW_RESIDUAL_VARIABLE_TYPE,SOLVER_MAPPING%CREATE_VALUES_CACHE%RESIDUAL_VARIABLE_TYPE)
...
999 IF(ALLOCATED(NEW_MATRIX_VARIABLE_TYPES)) DEALLOCATE(NEW_MATRIX_VARIABLE_TYPES)
    IF(ALLOCATED(NEW_RESIDUAL_VARIABLE_TYPE)) DEALLOCATE(NEW_RESIDUAL_VARIABLE_TYPE)
