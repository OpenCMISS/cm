...
MODULE ELASTICITY_ROUTINES
  ...
  PUBLIC ELASTICITY_EQUATIONS_SET_CLASS_TYPE_SET,ELASTICITY_FINITE_ELEMENT_CALCULATE,ELASTICITY_FINITE_ELEMENT_JACOBIAN_EVALUATE,  &
    ...
    & ELASTICITY_PROBLEM_CLASS_TYPE_SET,ELASTICITY_PROBLEM_SETUP
...
999 CALL ERRORS("ELASTICITY_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR)
 ...
 !
  ...
  SUBROUTINE ELASTICITY_EQUATIONS_SET_SETUP(EQUATIONS_SET,SETUP_TYPE,ACTION_TYPE,FIELD_USER_NUMBER,FIELD,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      SELECT CASE(EQUATIONS_SET%TYPE)
      CASE(EQUATIONS_SET_LINEAR_ELASTICITY_TYPE)
        CALL LINEAR_ELASTICITY_EQUATIONS_SET_SETUP(EQUATIONS_SET,SETUP_TYPE,ACTION_TYPE,FIELD_USER_NUMBER,FIELD,ERR,ERROR,*999)
      CASE(EQUATIONS_SET_FINITE_ELASTICITY_TYPE)
        CALL FINITE_ELASTICITY_EQUATIONS_SET_SETUP(EQUATIONS_SET,SETUP_TYPE,ACTION_TYPE,FIELD_USER_NUMBER,FIELD,ERR,ERROR,*999)
      CASE DEFAULT
