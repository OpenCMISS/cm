...
MODULE SOLVER_ROUTINES
  ...
  PUBLIC SOLVER_DYNAMIC_DEGREE_SET,SOLVER_DYNAMIC_LINEAR_SOLVER_GET,SOLVER_DYNAMIC_NONLINEAR_SOLVER_GET, & 
    & SOLVER_TIME_STEPPING_MONITOR,SOLVER_DYNAMIC_ORDER_SET,SOLVER_DYNAMIC_SCHEME_SET,SOLVER_DYNAMIC_THETA_SET, & 
...
998 CALL ERRORS("SOLVER_VARIABLES_DYNAMIC_FIELD_UPDATE",ERR,ERROR)    
  ...
  SUBROUTINE SOLVER_VARIABLES_DYNAMIC_NONLINEAR_UPDATE(SOLVER,ERR,ERROR,*)
    ...
    TYPE(EQUATIONS_MATRICES_TYPE), POINTER :: EQUATIONS_MATRICES
    TYPE(DISTRIBUTED_VECTOR_TYPE), POINTER :: SOLVER_VECTOR,PREDICTED_MEAN_DISPLACEMENT_VECTOR
    TYPE(EQUATIONS_SET_TYPE), POINTER :: EQUATIONS_SET
    TYPE(FIELD_TYPE), POINTER :: DEPENDENT_FIELD
    TYPE(FIELD_VARIABLE_TYPE), POINTER :: DEPENDENT_VARIABLE
    TYPE(SOLVER_EQUATIONS_TYPE), POINTER :: SOLVER_EQUATIONS
