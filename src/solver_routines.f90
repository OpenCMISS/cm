  ...
  SUBROUTINE SOLVER_CREATE_FINISH(SOLVER,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(SOLVER)) THEN
      ...
      ELSE
        ...
        ENDDO !solver_idx
        !###########################
        !Removed in most recent merge with opencmiss/cm on 26 Aug 2013
