...
MODULE SOLVER_ROUTINES
  ...
  PUBLIC SOLVER_NEWTON_ABSOLUTE_TOLERANCE_SET,SOLVER_NEWTON_RELATIVE_TOLERANCE_SET, &
    & SOLVER_NEWTON_MAXIMUM_ITERATIONS_SET,SOLVER_NEWTON_MAXIMUM_FUNCTION_EVALUATIONS_SET, &
    & SOLVER_NEWTON_TRUSTREGION_TOLERANCE_SET

  PUBLIC SOLVER_NEWTON_LINESEARCH_ALPHA_SET,SOLVER_NEWTON_LINESEARCH_TYPE_SET
