...
999 ERRORSEXITS("EQUATIONS_MAPPING_CREATE_START",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_CREATE_VALUES_CACHE_FINALISE(CREATE_VALUES_CACHE,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_CREATE_VALUES_CACHE_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_CREATE_VALUES_CACHE_FINALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_CREATE_VALUES_CACHE_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_CREATE_VALUES_CACHE_INITIALISE(EQUATIONS_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_CREATE_VALUES_CACHE_INITIALISE",ERR,ERROR,*998)
...
! SEBK 19/08/2009 not sure about mapping here
    ...
    EXITS("EQUATIONS_MAPPING_CREATE_VALUES_CACHE_INITIALISE")
    RETURN
999 CALL EQUATIONS_MAPPING_CREATE_VALUES_CACHE_FINALISE(EQUATIONS_MAPPING%CREATE_VALUES_CACHE,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("EQUATIONS_MAPPING_CREATE_VALUES_CACHE_INITIALISE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("EQUATIONS_MAPPING_DYNAMIC_MAPPING_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_DYNAMIC_MAPPING_INITIALISE(EQUATIONS_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_DYNAMIC_MAPPING_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("EQUATIONS_MAPPING_DYNAMIC_MAPPING_INITIALISE")
    RETURN
999 CALL EQUATIONS_MAPPING_DYNAMIC_MAPPING_FINALISE(EQUATIONS_MAPPING%DYNAMIC_MAPPING,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("EQUATIONS_MAPPING_DYNAMIC_MAPPING_INITIALISE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("EQUATIONS_MAPPING_DYNAMIC_MATRICES_SET_2",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1(EQUATIONS_MAPPING,DAMPING_MATRIX_COEFFICIENT, &
    ...
    ENTERS("EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2(EQUATIONS_MAPPING,MASS_MATRIX_COEFFICIENT, &
    ...
    ENTERS("EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("EQUATIONS_MAPPING_DYNAMIC_VARIABLE_TYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_FINALISE(EQUATIONS_JACOBIAN_TO_VAR_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_FINALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_FINALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_INITIALISE(EQUATIONS_JACOBIAN_TO_VAR_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_INITIALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_EQUATS_JACOBIAN_TO_VAR_MAP_INITIALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_EQUATIONS_MATRIX_TO_VAR_MAP_FINALISE(EQUATIONS_MATRIX_TO_VAR_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_EQUATIONS_MATRIX_TO_VAR_MAP_FINALISE",ERR,ERROR,*999)

    IF(ALLOCATED(EQUATIONS_MATRIX_TO_VAR_MAP%COLUMN_TO_DOF_MAP)) &
      & DEALLOCATE(EQUATIONS_MATRIX_TO_VAR_MAP%COLUMN_TO_DOF_MAP)
    
    EXITS("EQUATIONS_MAPPING_EQUATIONS_MATRIX_TO_VAR_MAP_FINALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_EQUATIONS_MATRIX_TO_VAR_MAP_FINALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_EQUATS_MATRIX_TO_VAR_MAP_INITIALISE(EQUATIONS_MATRIX_TO_VAR_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_EQUATS_MATRIX_TO_VAR_MAP_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_EQUATS_MATRIX_TO_VAR_MAP_INITIALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_EQUATS_MATRIX_TO_VAR_MAP_INITIALISE",ERR,ERROR)    
    RETURN 1
...
998 ERRORSEXITS("EQUATIONS_MAPPING_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_RESIDUAL_VARIABLES_NUMBER_SET(EQUATIONS_MAPPING,NUMBER_OF_VARIABLES,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_RESIDUAL_VARIABLES_NUMBER_SET",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_RESIDUAL_VARIABLES_NUMBER_SET")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_RESIDUAL_VARIABLES_NUMBER_SET",ERR,ERROR)
    RETURN 1
...
998 ERRORSEXITS("EQUATIONS_MAPPING_LINEAR_MAPPING_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_LINEAR_MATRICES_COEFFS_SET(EQUATIONS_MAPPING,LINEAR_MATRIX_COEFFICIENTS,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_LINEAR_MATRICES_COEFFS_SET",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_LINEAR_MATRICES_COEFFS_SET")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_LINEAR_MATRICES_COEFFS_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_LINEAR_MATRICES_NUMBER_SET(EQUATIONS_MAPPING,NUMBER_OF_LINEAR_EQUATIONS_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_LINEAR_MATRICES_NUMBER_SET",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_LINEAR_MATRICES_NUMBER_SET")
    RETURN
999 IF(ALLOCATED(OLD_LINEAR_MATRIX_VARIABLE_TYPES)) DEALLOCATE(OLD_LINEAR_MATRIX_VARIABLE_TYPES)    
    IF(ALLOCATED(OLD_LINEAR_MATRIX_COEFFICIENTS)) DEALLOCATE(OLD_LINEAR_MATRIX_COEFFICIENTS)    
    ERRORSEXITS("EQUATIONS_MAPPING_LINEAR_MATRICES_NUMBER_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_LINEAR_MATRICES_VARIABLE_TYPES_SET(EQUATIONS_MAPPING,LINEAR_MATRIX_VARIABLE_TYPES,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_LINEAR_MATRICES_VARIABLE_TYPES_SET",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_LINEAR_MATRICES_VARIABLE_TYPES_SET")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_LINEAR_MATRICES_VARIABLE_TYPES_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_NONLINEAR_MAPPING_FINALISE(NONLINEAR_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_NONLINEAR_MAPPING_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_NONLINEAR_MAPPING_FINALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_NONLINEAR_MAPPING_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_NONLINEAR_MAPPING_INITIALISE(EQUATIONS_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_NONLINEAR_MAPPING_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("EQUATIONS_MAPPING_NONLINEAR_MAPPING_INITIALISE")
    RETURN
999 CALL EQUATIONS_MAPPING_NONLINEAR_MAPPING_FINALISE(EQUATIONS_MAPPING%NONLINEAR_MAPPING,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("EQUATIONS_MAPPING_NONLINEAR_MAPPING_INITIALISE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("EQUATIONS_MAPPING_RESIDUAL_COEFF_SET",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_RESIDUAL_VARIABLE_TYPES_SET(EQUATIONS_MAPPING,RESIDUAL_VARIABLE_TYPES,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_RESIDUAL_VARIABLE_TYPES_SET",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_RESIDUAL_VARIABLE_TYPES_SET")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_RESIDUAL_VARIABLE_TYPES_SET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("EQUATIONS_MAPPING_SOURCE_VARIABLE_TYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MAPPING_VAR_TO_EQUATS_COLUMN_MAP_FINALISE(VAR_TO_EQUATIONS_COLUMN_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_VAR_TO_EQUATS_COLUMN_MAP_FINALISE",ERR,ERROR,*999)
    
    IF(ALLOCATED(VAR_TO_EQUATIONS_COLUMN_MAP%COLUMN_DOF)) &
      & DEALLOCATE(VAR_TO_EQUATIONS_COLUMN_MAP%COLUMN_DOF)
    
    EXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_COLUMN_MAP_FINALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_COLUMN_MAP_FINALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_FINALISE(VAR_TO_EQUATIONS_JACOBIAN_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_FINALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_FINALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_INITIALISE(VAR_TO_EQUATIONS_JACOBIAN_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_INITIALISE",ERR,ERROR,*999)
    
    VAR_TO_EQUATIONS_JACOBIAN_MAP%VARIABLE_TYPE=0
    NULLIFY(VAR_TO_EQUATIONS_JACOBIAN_MAP%VARIABLE)
    
    EXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_INITIALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_JACOBIAN_MAP_INITIALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_FINALISE(VAR_TO_EQUATIONS_MATRICES_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_FINALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_FINALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_INITIALISE(VAR_TO_EQUATIONS_MATRICES_MAP,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_INITIALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MAPPING_VAR_TO_EQUATS_MATRICES_MAP_INITIALISE",ERR,ERROR)    
    RETURN 1
