        ...
        DO comp_idx=1,FIELD%VARIABLES(var_idx)%NUMBER_OF_COMPONENTS
          ...
          DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
            ...
            DO dev_idx=1,NUM_OF_NODAL_DEV 
              CALL ANALYTIC_ANALYSIS_NODE_NUMERICIAL_VALUE_GET(FIELD,var_idx,comp_idx,node_idx,VALUE_BUFFER(1),ERR,ERROR,*999)
              CALL ANALYTIC_ANALYSIS_NODE_ANALYTIC_VALUE_GET(FIELD,var_idx,comp_idx,node_idx,VALUE_BUFFER(2),ERR,ERROR,*999)
              CALL ANALYTIC_ANALYSIS_NODE_PERCENT_ERROR_GET(FIELD,var_idx,comp_idx,node_idx,VALUE_BUFFER(3),ERR,ERROR,*999)
              CALL ANALYTIC_ANALYSIS_NODE_ABSOLUTE_ERROR_GET(FIELD,var_idx,comp_idx,node_idx,VALUE_BUFFER(4),ERR,ERROR,*999)
              CALL ANALYTIC_ANALYSIS_NODE_RELATIVE_ERROR_GET(FIELD,var_idx,comp_idx,node_idx,VALUE_BUFFER(5),ERR,ERROR,*999)
