...
MODULE ANALYTIC_ANALYSIS_ROUTINES
  ...
  PUBLIC ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE,ANALYTIC_ANALYSIS_ABSOLUTE_ERROR_GET_NODE, &
    & ANALYTIC_ANALYSIS_RELATIVE_ERROR_GET_NODE

  PUBLIC ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_ELEMENT,ANALYTIC_ANALYSIS_ABSOLUTE_ERROR_GET_ELEMENT, &
    & ANALYTIC_ANALYSIS_RELATIVE_ERROR_GET_ELEMENT

  PUBLIC ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_CONSTANT,ANALYTIC_ANALYSIS_ABSOLUTE_ERROR_GET_CONSTANT, &
          ...
          DO comp_idx=1,FIELD%VARIABLES(var_idx)%NUMBER_OF_COMPONENTS
            ...
            DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
              ...
              DO dev_idx=1,NUM_OF_NODAL_DEV
                ...
                CALL ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE(FIELD,var_idx,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx, &
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_INTEGRAL_NUMERICAL_VALUE_GET(FIELD,VARIABLE_NUMBER,POWER,DERIVATIVE_NUMBERS,VALUE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(FIELD)) THEN
      ...
      DO comp_idx=1,FIELD%VARIABLES(VARIABLE_NUMBER)%NUMBER_OF_COMPONENTS
        ...
        DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
          DO dev_idx=1,SIZE(DERIVATIVE_NUMBERS)
            CALL FIELD_PARAMETER_SET_GET_NODE(FIELD,VARIABLE_NUMBER,FIELD_VALUES_SET_TYPE,DERIVATIVE_NUMBERS(dev_idx),node_idx, &
              & comp_idx,NUMERICAL_VALUE,ERR,ERROR,*999)
            NUMBER_OF_SURROUNDING_ELEMENTS=FIELD%VARIABLES(1)%COMPONENTS(comp_idx)%DOMAIN%TOPOLOGY%NODES%NODES(node_idx)% &
                & NUMBER_OF_SURROUNDING_ELEMENTS
            ! Uses Trapezoidal 2D Rule
!TODO implement integration calculation for 3D
...
999 CALL ERRORS("ANALYTIC_ANALYSIS_ABSOLUTE_ERROR_GET_NODE",ERR,ERROR)
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE(FIELD,VARIABLE_TYPE,DERIVATIVE_NUMBER,USER_NODE_NUMBER, &
    ...
    CALL ENTERS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE",ERR,ERROR,*999)
    ...
    CALL EXITS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE")
    RETURN
999 CALL ERRORS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE",ERR,ERROR)
    CALL EXITS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE")
    RETURN 1
  END SUBROUTINE ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE
...
999 CALL ERRORS("ANALYTIC_ANALYSIS_ABSOLUTE_ERROR_GET_ELEMENT",ERR,ERROR)
  ...
  !>Get percentage error value for the node
  SUBROUTINE ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_ELEMENT(FIELD,VARIABLE_TYPE,USER_ELEMENT_NUMBER,COMPONENT_NUMBER,VALUE,ERR,ERROR,*)
    ...
    CALL ENTERS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_ELEMENT",ERR,ERROR,*999)
    ...
    CALL EXITS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_ELEMENT")
    RETURN
999 CALL ERRORS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_ELEMENT",ERR,ERROR)
    CALL EXITS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_ELEMENT")
    RETURN 1
  END SUBROUTINE ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_ELEMENT
...
999 CALL ERRORS("ANALYTIC_ANALYSIS_ABSOLUTE_ERROR_GET_CONSTANT",ERR,ERROR)
  ...
  !>Get percentage error value for the node
  SUBROUTINE ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_CONSTANT(FIELD,VARIABLE_TYPE,COMPONENT_NUMBER,VALUE,ERR,ERROR,*)
    ...
    CALL ENTERS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_CONSTANT",ERR,ERROR,*999)
    ...
    CALL EXITS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_CONSTANT")
    RETURN
999 CALL ERRORS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_CONSTANT",ERR,ERROR)
    CALL EXITS("ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_CONSTANT")
    RETURN 1
  END SUBROUTINE ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_CONSTANT
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_RMS_PERCENT_ERROR_GET(FIELD,VARIABLE_NUMBER,DERIVATIVE_NUMBERS,VALUE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(FIELD)) THEN
      ...
      DO comp_idx=1,FIELD%VARIABLES(VARIABLE_NUMBER)%NUMBER_OF_COMPONENTS
        ...
        DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
          DO dev_idx=1,SIZE(DERIVATIVE_NUMBERS)
            CALL ANALYTIC_ANALYSIS_PERCENT_ERROR_GET_NODE(FIELD,VARIABLE_NUMBER,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx, &
