            ...
            IF(ASSOCIATED(DECOMPOSITION_TOPOLOGY)) THEN
              ...
              DO var_idx=1,FIELD%NUMBER_OF_VARIABLES
                ...
                IF(ASSOCIATED(FIELD_VARIABLE)) THEN
                  ...
                  IF(FIELD_VARIABLE%FIELD%DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT%NUMBER_COMPUTATIONAL_NODES>1) THEN 
                    ...
                    CALL MPI_ALLREDUCE(MPI_IN_PLACE,INTEGRAL_ERRORS,6*FIELD_VARIABLE%NUMBER_OF_COMPONENTS,MPI_DOUBLE_PRECISION, &
                      ...
                      & MPI_SUM,FIELD_VARIABLE%FIELD%DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
...
!                  CALL MPI_ALLREDUCE(MPI_IN_PLACE,NUMBER,1,MPI_INTEGER,MPI_SUM,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
                  CALL MPI_ALLREDUCE(MPI_IN_PLACE,NUMBER,1,MPI_INTEGER,MPI_SUM,FIELD%DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT% &
                    & MPI_COMM,MPI_IERROR)
                  CALL MPI_ERROR_CHECK("MPI_ALLREDUCE",MPI_IERROR,ERR,ERROR,*999)
