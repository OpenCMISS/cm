          ...
          DO comp_idx=1,FIELD%VARIABLES(var_idx)%NUMBER_OF_COMPONENTS
            ...
            DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
              ...
              DO dev_idx=1,NUM_OF_NODAL_DEV
                CALL ANALYTIC_ANALYSIS_NODE_NUMERICIAL_VALUE_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,var_idx, &
                  & VALUE_BUFFER(1),ERR,ERROR,*999)
                CALL ANALYTIC_ANALYSIS_NODE_ANALYTIC_VALUE_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,var_idx, &
                  & VALUE_BUFFER(2),ERR,ERROR,*999)
                CALL ANALYTIC_ANALYSIS_NODE_PERCENT_ERROR_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,var_idx, &
                  & VALUE_BUFFER(3),ERR,ERROR,*999)
                CALL ANALYTIC_ANALYSIS_NODE_ABSOLUTE_ERROR_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,var_idx, &
                  & VALUE_BUFFER(4),ERR,ERROR,*999)
                CALL ANALYTIC_ANALYSIS_NODE_RELATIVE_ERROR_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,var_idx, &
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_INTEGRAL_NUMERICAL_VALUE_GET(FIELD,VARIABLE_NUMBER,POWER,DERIVATIVE_NUMBERS,VALUE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(FIELD)) THEN
      ...
      DO comp_idx=1,FIELD%VARIABLES(VARIABLE_NUMBER)%NUMBER_OF_COMPONENTS
        ...
        DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
          DO dev_idx=1,SIZE(DERIVATIVE_NUMBERS)
            CALL ANALYTIC_ANALYSIS_NODE_NUMERICIAL_VALUE_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,VARIABLE_NUMBER, & 
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_NODE_ANALYTIC_VALUE_GET(FIELD,VARIABLE_TYPE,DERIVATIVE_NUMBER,NODE_NUMBER,COMPONENT_NUMBER,VALUE, &
    ...
    IF(ASSOCIATED(FIELD)) THEN
      IF(VARIABLE_TYPE>=1.AND.VARIABLE_TYPE<=FIELD_NUMBER_OF_VARIABLE_TYPES) THEN
        FIELD_VARIABLE=>FIELD%VARIABLE_TYPE_MAP(VARIABLE_TYPE)%PTR
        IF(ASSOCIATED(FIELD_VARIABLE)) THEN
          CALL FIELD_PARAMETER_SET_DATA_GET(FIELD,VARIABLE_TYPE,FIELD_ANALYTIC_VALUES_SET_TYPE,ANALYTIC_PARAMETERS,ERR,ERROR,*999)
          IF(ASSOCIATED(ANALYTIC_PARAMETERS)) THEN      
            DOMAIN_NODES=>FIELD_VARIABLE%COMPONENTS(COMPONENT_NUMBER)%DOMAIN%TOPOLOGY%NODES
            IF(ASSOCIATED(DOMAIN_NODES)) THEN
              NUMBER_OF_DERIVATIVES=DOMAIN_NODES%NODES(node_number)%NUMBER_OF_DERIVATIVES
              VALUE=ANALYTIC_PARAMETERS(DOMAIN_NODES%NUMBER_OF_NODES*NUMBER_OF_DERIVATIVES+(NODE_NUMBER-1)* &
          ...
          ENDIF
          CALL FIELD_PARAMETER_SET_DATA_RESTORE(FIELD,VARIABLE_TYPE,FIELD_ANALYTIC_VALUES_SET_TYPE,ANALYTIC_PARAMETERS, &
            & ERR,ERROR,*999)
        ELSE
...
999 CALL ERRORS("ANALYTIC_ANALYSIS_NODE_ANALYTIC_VALUE_GET",ERR,ERROR)
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_NODE_NUMERICIAL_VALUE_GET(FIELD,DERIVATIVE_NUMBER,NODE_NUMBER,COMPONENT_NUMBER,VARIABLE_TYPE, &
    & VALUE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(FIELD)) THEN
      IF(VARIABLE_TYPE>=1.AND.VARIABLE_TYPE<=FIELD_NUMBER_OF_VARIABLE_TYPES) THEN
        FIELD_VARIABLE=>FIELD%VARIABLE_TYPE_MAP(VARIABLE_TYPE)%PTR
        IF(ASSOCIATED(FIELD_VARIABLE)) THEN
          CALL FIELD_PARAMETER_SET_DATA_GET(FIELD,VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,NUMERICAL_PARAMETERS,ERR,ERROR,*999)          
          IF(ASSOCIATED(NUMERICAL_PARAMETERS)) THEN      
            DOMAIN_NODES=>FIELD_VARIABLE%COMPONENTS(COMPONENT_NUMBER)%DOMAIN%TOPOLOGY%NODES
            IF(ASSOCIATED(DOMAIN_NODES)) THEN
              NUMBER_OF_DERIVATIVES=DOMAIN_NODES%NODES(node_number)%NUMBER_OF_DERIVATIVES
              VALUE=NUMERICAL_PARAMETERS(DOMAIN_NODES%NUMBER_OF_NODES*NUMBER_OF_DERIVATIVES+(NODE_NUMBER-1) &
                & *NUMBER_OF_DERIVATIVES+DERIVATIVE_NUMBER)  
            ELSE
              CALL FLAG_ERROR("Domain nodes are not associated",ERR,ERROR,*999)
            ENDIF
          ...
          ENDIF
          CALL FIELD_PARAMETER_SET_DATA_RESTORE(FIELD,VARIABLE_TYPE,FIELD_VALUES_SET_TYPE,NUMERICAL_PARAMETERS,ERR,ERROR,*999)
        ELSE
          LOCAL_ERROR="The field variable type of "//TRIM(NUMBER_TO_VSTRING(VARIABLE_TYPE,"*",ERR,ERROR))// &
            & " has not been created on field number "//TRIM(NUMBER_TO_VSTRING(FIELD%USER_NUMBER,"*",ERR,ERROR))//"."
          CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_RMS_PERCENT_ERROR_GET(FIELD,VARIABLE_NUMBER,DERIVATIVE_NUMBERS,VALUE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(FIELD)) THEN
      ...
      DO comp_idx=1,FIELD%VARIABLES(VARIABLE_NUMBER)%NUMBER_OF_COMPONENTS
        ...
        DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
          DO dev_idx=1,SIZE(DERIVATIVE_NUMBERS)
            CALL ANALYTIC_ANALYSIS_NODE_PERCENT_ERROR_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,VARIABLE_NUMBER, & 
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_RMS_ABSOLUTE_ERROR_GET(FIELD,VARIABLE_NUMBER,DERIVATIVE_NUMBERS,VALUE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(FIELD)) THEN
      ...
      DO comp_idx=1,FIELD%VARIABLES(VARIABLE_NUMBER)%NUMBER_OF_COMPONENTS
        ...
        DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
          DO dev_idx=1,SIZE(DERIVATIVE_NUMBERS)
            CALL ANALYTIC_ANALYSIS_NODE_ABSOLUTE_ERROR_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,VARIABLE_NUMBER, & 
  ...
  SUBROUTINE ANALYTIC_ANALYSIS_RMS_RELATIVE_ERROR_GET(FIELD,VARIABLE_NUMBER,DERIVATIVE_NUMBERS,VALUE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(FIELD)) THEN
      ...
      DO comp_idx=1,FIELD%VARIABLES(VARIABLE_NUMBER)%NUMBER_OF_COMPONENTS
        ...
        DO node_idx=1,DOMAIN_NODES%NUMBER_OF_NODES
          DO dev_idx=1,SIZE(DERIVATIVE_NUMBERS)
            CALL ANALYTIC_ANALYSIS_NODE_RELATIVE_ERROR_GET(FIELD,DERIVATIVE_NUMBERS(dev_idx),node_idx,comp_idx,VARIABLE_NUMBER, & 
