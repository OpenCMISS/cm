...
999 ERRORSEXITS("MULTI_PHYSICS_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
  ...
  SUBROUTINE MULTI_PHYSICS_FINITE_ELEMENT_JACOBIAN_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("MULTI_PHYSICS_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR,*999)
    ...
    EXITS("MULTI_PHYSICS_FINITE_ELEMENT_JACOBIAN_EVALUATE")
    RETURN
999 ERRORSEXITS("MULTI_PHYSICS_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE MULTI_PHYSICS_FINITE_ELEMENT_RESIDUAL_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("MULTI_PHYSICS_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR,*999)
...
!         CALL ELASTICITY_DARCY_FINITE_ELEMENT_RESIDUAL_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*999)
    ...
    EXITS("MULTI_PHYSICS_FINITE_ELEMENT_RESIDUAL_EVALUATE")
    RETURN
999 ERRORSEXITS("MULTI_PHYSICS_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("MULTI_PHYSICS_EQUATIONS_SET_SETUP",ERR,ERROR)
  ...
  SUBROUTINE MULTI_PHYSICS_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("MULTI_PHYSICS_EQUATIONS_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    EXITS("MULTI_PHYSICS_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("MULTI_PHYSICS_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
