!> \file
!> $Id: cmiss_petsc_types.f90 27 2007-07-24 16:52:51Z cpb $
...
#include "include/finclude/petscviewer.h"
  ...
  PUBLIC PETSC_IS_TYPE,PETSC_ISLOCALTOGLOBALMAPPING_TYPE,PETSC_KSP_TYPE,PETSC_MAT_TYPE,PETSC_PC_TYPE,PETSC_SNES_TYPE,PETSC_VEC_TYPE
