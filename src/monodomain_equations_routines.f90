...
MODULE MONODOMAIN_EQUATIONS_ROUTINES
  ...
  PUBLIC MONODOMAIN_EQUATIONS_SET_CLASS_TYPE_SET
  
  PUBLIC MONODOMAIN_PROBLEM_CLASS_TYPE_SET

  PUBLIC MONODOMAIN_PROBLEM_CLASS_TYPE_GET
...
CONTAINS
  ...
  SUBROUTINE MONODOMAIN_CONTROL_LOOP_POST_LOOP(CONTROL_LOOP,ERR,ERROR,*)
    ...
    CALL ENTERS("MONODOMAIN_CONTROL_LOOP_POST_LOOP",ERR,ERROR,*999)
    ...
    CALL EXITS("MONODOMAIN_CONTROL_LOOP_POST_LOOP")
    RETURN
999 CALL ERRORS("MONODOMAIN_CONTROL_LOOP_POST_LOOP",ERR,ERROR)
    CALL EXITS("MONODOMAIN_CONTROL_LOOP_POST_LOOP")
    RETURN 1
