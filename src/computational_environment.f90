...
MODULE COMP_ENVIRONMENT
  ...
  PUBLIC COMPUTATIONAL_WORK_GROUP_ADD_SUBGROUP
...
CONTAINS
  ...
  !>
  SUBROUTINE COMPUTATIONAL_WORK_GROUP_ADD_SUBGROUP(PARENT_WORK_GROUP, NUMBER_COMPUTATIONAL_NODES, &
   & ADDED_WORK_GROUP,ERR,ERROR,*)
    !Argument Variables
    TYPE(COMPUTATIONAL_WORK_GROUP_TYPE),POINTER, INTENT(IN) :: PARENT_WORK_GROUP
	...
	DEALLOCATE(PARENT_WORK_GROUP%SUB_WORK_GROUPS)
      ENDIF
      SUB_WORK_GROUPS(1+PARENT_WORK_GROUP%NUMBER_SUB_WORK_GROUPS)=NEW_WORK_GROUP !=> INSTEAD OF =
    ...
    CALL EXITS("COMPUTATIONAL_WORK_GROUP_ADD_SUBGROUP")
    RETURN
999 CALL ERRORS("COMPUTATIONAL_WORK_GROUP_ADD_SUBGROUP",ERR,ERROR)
    CALL EXITS("COMPUTATIONAL_WORK_GROUP_ADD_SUBGROUP")
    RETURN 1
  END SUBROUTINE COMPUTATIONAL_WORK_GROUP_ADD_SUBGROUP
