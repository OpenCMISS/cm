...
!    TYPE(CACHE_TYPE) :: CACHE 
  ...
  TYPE COMPUTATIONAL_ENVIRONMENT_TYPE
    ...
    INTEGER(INTG) :: MY_COMPUTATIONAL_NODE_NUMBER !<The node number of the running process
...
999 CALL ERRORS("COMPUTATIONAL_ENVIRONMENT_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE COMPUTATIONAL_ENVIRONMENT_INITIALISE(ERR,ERROR,*)
    ...
    CALL MPI_COMM_SIZE(MPI_COMM_WORLD,COMPUTATIONAL_ENVIRONMENT%NUMBER_COMPUTATIONAL_NODES,MPI_IERROR)
    ...
    CALL MPI_COMM_RANK(MPI_COMM_WORLD,RANK,MPI_IERROR)
    ...
    CALL MPI_ALLGATHER(COMPUTATIONAL_ENVIRONMENT%COMPUTATIONAL_NODES(0),1,MPI_COMPUTATIONAL_NODE_TYPE_DATA%MPI_TYPE, &
      & COMPUTATIONAL_ENVIRONMENT%COMPUTATIONAL_NODES(0),1,MPI_COMPUTATIONAL_NODE_TYPE_DATA%MPI_TYPE,MPI_COMM_WORLD,MPI_IERROR)
