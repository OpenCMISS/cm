...
999 ERRORSEXITS("EQUATIONS_MATRICES_ELEMENT_MATRIX_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MATRICES_ELEMENT_MATRIX_INITIALISE(ELEMENT_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_ELEMENT_MATRIX_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MATRICES_ELEMENT_MATRIX_INITIALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_ELEMENT_MATRIX_INITIALISE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("EQUATIONS_MATRICES_ELEMENT_VECTOR_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MATRICES_ELEMENT_VECTOR_INITIALISE(ELEMENT_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_ELEMENT_VECTOR_INITIALISE",ERR,ERROR,*999)

    ELEMENT_VECTOR%NUMBER_OF_ROWS=0
    ELEMENT_VECTOR%MAX_NUMBER_OF_ROWS=0
       
    EXITS("EQUATIONS_MATRICES_ELEMENT_VECTOR_INITIALISE")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_ELEMENT_VECTOR_INITIALISE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("EQUATIONS_MATRICES_LINEAR_STORAGE_TYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0(EQUATIONS_MATRICES,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1(EQUATIONS_MATRICES,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET(EQUATIONS_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MATRICES_LINEAR_STRUCTURE_TYPE_SET(EQUATIONS_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_LINEAR_STRUCTURE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MATRICES_LINEAR_STRUCTURE_TYPE_SET")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_LINEAR_STRUCTURE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0(EQUATIONS_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1(EQUATIONS_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1",ERR,ERROR,*999)
    ...
    EXITS("EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1")
    RETURN
999 ERRORSEXITS("EQUATIONS_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1",ERR,ERROR)
    RETURN 1
