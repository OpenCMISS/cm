...
999 CALL ERRORS("INTERFACE_MATRIX_STRUCTURE_CALCULATE",ERR,ERROR)
  ...
  SUBROUTINE INTERFACE_MATRICES_ELEMENT_MATRIX_FINALISE(ELEMENT_MATRIX,ERR,ERROR,*)
    ...
    CALL ENTERS("INTERFACE_MATRICES_ELEMENT_MATRIX_FINALISE",ERR,ERROR,*999)

!!TODO: SHOULD THIS CALL EQUATIONS_MATRICES_ELEMENT_MATRIX_FINALISE???
    ...
    CALL EXITS("INTERFACE_MATRICES_ELEMENT_MATRIX_FINALISE")
    RETURN
999 CALL ERRORS("INTERFACE_MATRICES_ELEMENT_MATRIX_FINALISE",ERR,ERROR)
    CALL EXITS("INTERFACE_MATRICES_ELEMENT_MATRIX_FINALISE")
    RETURN 1
  END SUBROUTINE INTERFACE_MATRICES_ELEMENT_MATRIX_FINALISE
  ...
  SUBROUTINE INTERFACE_MATRICES_ELEMENT_MATRIX_INITIALISE(ELEMENT_MATRIX,ERR,ERROR,*)
    ...
    CALL ENTERS("INTERFACE_MATRICES_ELEMENT_MATRIX_INITIALISE",ERR,ERROR,*999)

!!TODO: SHOULD THIS CALL EQUATIONS_MATRICES_ELEMENT_MATRIX_INITIALISE???
    ...
    CALL EXITS("INTERFACE_MATRICES_ELEMENT_MATRIX_INITIALISE")
    RETURN
999 CALL ERRORS("INTERFACE_MATRICES_ELEMENT_MATRIX_INITIALISE",ERR,ERROR)
    CALL EXITS("INTERFACE_MATRICES_ELEMENT_MATRIX_INITIALISE")
    RETURN 1
  END SUBROUTINE INTERFACE_MATRICES_ELEMENT_MATRIX_INITIALISE
