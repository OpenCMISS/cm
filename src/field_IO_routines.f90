  ...
  FUNCTION FIELD_IO_BASIS_LHTP_FAMILY_LABEL(BASIS, num_scl, num_node, LABEL_TYPE, ERR, ERROR)
    ...
    SELECT CASE(LABEL_TYPE)
       CASE (FIELD_IO_SCALE_FACTORS_NUMBER_TYPE)
          FIELD_IO_BASIS_LHTP_FAMILY_LABEL=TRIM(FIELD_IO_BASIS_LHTP_FAMILY_LABEL)//", #Scale factor="//TRIM(NUMBER_TO_VSTRING&
               &(num_scl,"*",ERR,ERROR))
...
999 CALL ERRORS("FIELD_IO_BASIS_LHTP_FAMILY_LABEL",ERR,ERROR)
  ...
  !>Write the header of a group elements using FORTRAIN 
  SUBROUTINE FIELD_IO_EXPORT_ELEMENTAL_GROUP_HEADER_FORTRAIN(LOCAL_PROCESS_ELEMENTAL_INFO_SET, LOCAL_ELEMENTAL_NUMBER,  MAX_NODE_CPMP_INDEX,&
    ...
    RETURN
999 CALL ERRORS("FIELD_IO_EXPORT_ELEMENTAL_GROUP_HEADER_FORTRAIN",ERR,ERROR)
    CALL EXITS("FIELD_IO_EXPORT_ELEMENTAL_GROUP_HEADER_FORTRAIN")
    RETURN 1       
  END SUBROUTINE FIELD_IO_EXPORT_ELEMENTAL_GROUP_HEADER_FORTRAIN  
    ...
    DO elem_idx=1, LOCAL_PROCESS_ELEMENTAL_INFO_SET%NUMBER_OF_ELEMENTS
       ...
       IF(LOCAL_PROCESS_ELEMENTAL_INFO_SET%ELEMENTAL_INFO_SET(elem_idx)%SAME_HEADER==.FALSE.) THEN
          !print * ,"elem_idx:", elem_idx, "in", my_computational_node_number
           !write out the nodal header
           CALL FIELD_IO_EXPORT_ELEMENTAL_GROUP_HEADER_FORTRAIN(LOCAL_PROCESS_ELEMENTAL_INFO_SET, elem_idx, MAX_NODE_CPMP_INDEX, &
...
999 CALL ERRORS("FIELD_IO_MULTI_FILES_INFO_GET",ERR,ERROR)
  ...
  SUBROUTINE FIELD_IO_MPIIO_FILE_WRITE_STRING(FILE_ID, STRING_DATA, LEN_OF_DATA, ERR,ERROR,*)
    ...
    INTEGER(INTG) :: TMP_LEN !<length of string    
    ...
    CALL MPI_FILE_WRITE(FILE_ID, CHAR(TMP_LEN), TMP_LEN, MPI_CHARACTER, MPI_STATUS_IGNORE, ERR)
...
999 CALL ERRORS("FIELD_IO_MPIIO_FILE_WRITE_STRING",ERR,ERROR)
  ...
  SUBROUTINE FIELD_IO_FORTRAN_FILE_READ_STRING(FILE_ID, STRING_DATA, LEN_OF_DATA, ERR,ERROR,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    CHARACTER (LEN=LEN_OF_DATA) :: TEMP_STR
    ...
    READ(FILE_ID, "(A)"), TEMP_STR 
    STRING_DATA=TEMP_STR
...
999 CALL ERRORS("FIELD_IO_FORTRAN_FILE_WRITE_STRING",ERR,ERROR)
  ...
  SUBROUTINE FIELD_IO_MPIIO_FILE_WRITE_DP(FILE_ID, REAL_DATA, LEN_OF_DATA, ERR,ERROR,*)
    ...
    CALL MPI_FILE_WRITE(FILE_ID, CHAR(STRING_DATA), LEN_OF_DATA, MPI_CHARACTER, MPI_STATUS_IGNORE, ERR)
...
999 CALL ERRORS("FIELD_IO_MPIIO_FILE_WRITE_DP",ERR,ERROR)
  ...
  SUBROUTINE FIELD_IO_FORTRAN_FILE_READ_DP(FILE_ID, REAL_DATA, LEN_OF_DATA, ERR,ERROR,*)
    ...
    DP_FMT="("//TRIM(NUMBER_TO_VSTRING(LEN_OF_DATA,"*",ERR,ERROR))//"ES)"
    READ(FILE_ID, CHAR(DP_FMT)), REAL_DATA(1:LEN_OF_DATA)
