...
!       CALL MPI_BCAST(FIELDTYPE,1,MPI_LOGICAL,MASTER_COMPUTATIONAL_NUMBER,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_BCAST(FIELDTYPE,1,MPI_LOGICAL,MASTER_COMPUTATIONAL_NUMBER,DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM, &
         & MPI_IERROR)
...
!    CALL MPI_BCAST(total_number_of_comps,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
    CALL MPI_BCAST(total_number_of_comps,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT &
      & %MPI_COMM,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
...
!       CALL MPI_BCAST(FILE_END,1,MPI_LOGICAL,MASTER_COMPUTATIONAL_NUMBER,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_BCAST(FILE_END,1,MPI_LOGICAL,MASTER_COMPUTATIONAL_NUMBER,DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM, &
         & MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
...
!       CALL MPI_BCAST(total_number_of_devs,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_BCAST(total_number_of_devs,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT% &
         & MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
...
!	& COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_BCAST(LIST_DEV_POS,total_number_of_comps,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER, &
  & DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
       !broadcasting total_number_of_devs
       CALL MPI_BCAST(LIST_DEV,total_number_of_devs,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,DECOMPOSITION%WORK_GROUP% &
         & COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
...
!	 & COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
   ...
   & DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
       CALL MPI_BCAST(NODAL_USER_NUMBER,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,DECOMPOSITION%WORK_GROUP% & 
         & COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
...
999 CALL ERRORS("FIELD_IO_CREATE_FIELDS",ERR,ERROR)
  ...
  !>Create decompition
  SUBROUTINE FIELD_IO_CREATE_DECOMPISTION(WORK_GROUP,DECOMPOSITION, DECOMPOSITION_USER_NUMBER, DECOMPOSITION_METHOD, MESH, &
    & NUMBER_OF_DOMAINS, ERR, ERROR, *)
    !Argument variables
    TYPE(COMPUTATIONAL_WORK_GROUP_TYPE), POINTER, INTENT(IN)  :: WORK_GROUP !<the work group 
    ...
    CALL DECOMPOSITION_WORK_GROUP_SET(DECOMPOSITION,WORK_GROUP,ERR,ERROR,*999)
...
999 CALL ERRORS("FIELD_IO_CREATE_DECOMPISTION",ERR,ERROR)
  ...
  SUBROUTINE FIELD_IO_FIELDS_IMPORT(NAME, METHOD, WORK_GROUP, REGION, MESH, MESH_USER_NUMBER, DECOMPOSITION, &
    DECOMPOSITION_USER_NUMBER,DECOMPOSITION_METHOD, FIELD_VALUES_SET_TYPE, FIELD_SCALING_TYPE, ERR, ERROR, *)
    !Argument variables
    TYPE(VARYING_STRING), INTENT(IN) :: NAME !<name of input
    TYPE(VARYING_STRING), INTENT(IN) :: METHOD !<method used for import
    TYPE(COMPUTATIONAL_WORK_GROUP_TYPE), POINTER, INTENT(IN)  :: WORK_GROUP !<the work group for import
    TYPE(REGION_TYPE), POINTER :: REGION !<region
    TYPE(MESH_TYPE), POINTER :: MESH !<mesh type
    ...
    COMPUTATIONAL_NODE_NUMBERS=COMPUTATIONAL_NODES_NUMBER_GET(WORK_GROUP,ERR,ERROR)
    IF(ERR/=0) GOTO 999
    !Get my computational node number
    MY_COMPUTATIONAL_NODE_NUMBER=COMPUTATIONAL_NODE_NUMBER_GET(WORK_GROUP,ERR,ERROR)
    IF(ERR/=0) GOTO 999

    MASTER_COMPUTATIONAL_NUMBER=0

    IF(METHOD=="FORTRAN") THEN
       CALL FIELD_IO_IMPORT_GLOBAL_MESH(NAME,WORK_GROUP, REGION, MESH, MESH_USER_NUMBER, MASTER_COMPUTATIONAL_NUMBER, &
       ...
       CALL FIELD_IO_CREATE_DECOMPISTION(WORK_GROUP,DECOMPOSITION, DECOMPOSITION_USER_NUMBER, DECOMPOSITION_METHOD, MESH, &
...
999 CALL ERRORS("FIELD_IO_FILL_BASIS_INFO",ERR,ERROR)
  ...
  SUBROUTINE FIELD_IO_IMPORT_GLOBAL_MESH(NAME, WORK_GROUP,REGION, MESH, MESH_USER_NUMBER, MASTER_COMPUTATIONAL_NUMBER, &
    & my_computational_node_number, &!USER_NODAL_NUMBER_MAP_GLOBAL_NODAL_NUMBER,
    &MESH_COMPONENTS_OF_FIELD_COMPONENTS, &
    ...
    CALL MPI_BCAST(NUMBER_OF_FIELDS,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
    IF(MASTER_COMPUTATIONAL_NUMBER/=my_computational_node_number) THEN
       CALL REALLOCATE( COMPONENTS_IN_FIELDS, NUMBER_OF_FIELDS, &
         & "can not allocate the memory for outputing components in field", ERR, ERROR, *999 )
    ...
    CALL MPI_BCAST(NUMBER_OF_ELEMENTS,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
    ...
    CALL MPI_BCAST(NUMBER_OF_EXNODE_FILES,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
    !broadcasting the number of nodes
    CALL MPI_BCAST(NUMBER_OF_NODES,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
    NULLIFY(NODES)
    ...
    CALL MPI_BCAST(NUMBER_OF_COMPONENTS,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
    CALL MPI_BCAST(NUMBER_OF_MESH_COMPONENTS,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,& 
      & MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
    ...
    CALL MPI_BCAST(NUMBER_OF_EXELEM_FILES,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
    ...
    DO WHILE(idx_exelem<NUMBER_OF_EXELEM_FILES)
       ...
       CALL MPI_BCAST(FILE_END,1,MPI_LOGICAL,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
       ...
       CALL MPI_BCAST(number_of_node,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
       ...
       CALL MPI_BCAST(LIST_COMP_NODAL_INDEX,number_of_node*NUMBER_OF_COMPONENTS,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER, &
         & WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
       CALL MPI_BCAST(SHAPE_INDEX,SHAPE_SIZE,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,&
         & MPI_IERROR)
       CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
...
999 CALL ERRORS("FIELD_IO_TRANSLATE_LABEL_INTO_INTERPOLATION_TYPE",ERR,ERROR)
  ...
  !  CALL MPI_BCAST(NUMBER_OF_BASES,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
  !  CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
  !
  !  IF(NUMBER_OF_BASES/=0) THEN
  ...
  !     CALL MPI_BCAST(NUM_INTERPOLATION_XI,1,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
  !     CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
  !     CALL BASIS_NUMBER_OF_XI_SET(BASIS,NUM_INTERPOLATION_XI,ERR,ERROR,*999)
  !
  !     !broadcasting the number of XI
  !     CALL MPI_BCAST(INTERPOLATION_XI,NUM_INTERPOLATION_XI,MPI_INTEGER,MASTER_COMPUTATIONAL_NUMBER, &
  !     ! COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
  !     CALL MPI_ERROR_CHECK("MPI_BCAST",MPI_IERROR,ERR,ERROR,*999)
...
999 CALL ERRORS("FIELD_IO_INFO_SET_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE FIELD_IO_NODES_EXPORT(FIELDS, FILE_NAME, METHOD, ERR,ERROR,*)
    ...
    !Get the number of computational nodes
!    computational_node_numbers=COMPUTATIONAL_NODES_NUMBER_GET(ERR,ERROR)
    computational_node_numbers=COMPUTATIONAL_NODES_NUMBER_GET(FIELDS%FIELDS(1)%PTR%DECOMPOSITION%WORK_GROUP,ERR,ERROR)

    IF(ERR/=0) GOTO 999
    !Get my computational node number
!    my_computational_node_number=COMPUTATIONAL_NODE_NUMBER_GET(ERR,ERROR)
    my_computational_node_number=COMPUTATIONAL_NODE_NUMBER_GET(FIELDS%FIELDS(1)%PTR%DECOMPOSITION%WORK_GROUP,ERR,ERROR)
    IF(ERR/=0) GOTO 999
    IF(METHOD=="FORTRAN") THEN
