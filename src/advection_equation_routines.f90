...
999 CALL ERRORS("ADVECTION_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE ADVECTION_EQUATION_EQUATIONS_SET_LINEAR_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    !Local Variables
    INTEGER(INTG) :: GEOMETRIC_MESH_COMPONENT,GEOMETRIC_SCALING_TYPE,NUMBER_OF_DIMENSIONS,NUMBER_OF_INDEPENDENT_COMPONENTS,I
    INTEGER(INTG) :: DEPENDENT_FIELD_NUMBER_OF_VARIABLES,DEPENDENT_FIELD_NUMBER_OF_COMPONENTS,INDEPENDENT_FIELD_NUMBER_OF_VARIABLES
    INTEGER(INTG) :: coupledVariableNumberOfComponents,dependentVariableNumberOfComponents,component_idx,GEOMETRIC_COMPONENT_NUMBER
...
999 CALL ERRORS("ADVECTION_EQUATION_PROBLEM_LINEAR_SETUP",ERR,ERROR)
  ...
  SUBROUTINE ADVECTION_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    REAL(DP) :: JGW,SUM,DXI_DX,DPHIMS_DXI,DPHINS_DXI,PHIMS,PHINS,ADV_VEL,lengthScale,alphaParam,Diff,Peclet,ADV_FLOW,ADV_AREA
        ...
        CASE(EQUATIONS_SET_ADVECTION_SUBTYPE)
          ...
          CASE(EQUATIONS_SET_ADVECTION_SUBTYPE)
            ...
            DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
              ...
              ADV_FLOW=EQUATIONS%INTERPOLATION%DEPENDENT_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,NO_PART_DERIV)
              ADV_AREA=EQUATIONS%INTERPOLATION%DEPENDENT_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,NO_PART_DERIV)
              ADV_VEL=ADV_FLOW/ADV_AREA
              ! Calculate Peclet number 
              Diff=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,NO_PART_DERIV)
              lengthScale=0.0
              ! alphaParam=0.0
              !Peclet=ADV_VEL*lengthScale/Diff
              !IF(Peclet<0.1)THEN
              !  alphaParam=0.0
                  ...
                  DO ns=1,DEPENDENT_BASIS%NUMBER_OF_ELEMENT_PARAMETERS
                    ...
                    IF(UPDATE_STIFFNESS_MATRIX) THEN
                      SUM=((Diff*DPHIMS_DXI*DXI_DX)+ &                                                  !Diffusion Term
                        & ADV_VEL*(PHIMS+lengthScale*alphaParam*DPHIMS_DXI*DXI_DX))*DPHINS_DXI*DXI_DX   !Advection Term
