...
MODULE BIOELECTRIC_ROUTINES
  ...
  USE BASE_ROUTINES
  USE BIOELEC_DOMAIN_EQUATION_ROUTINES
  ...
  PUBLIC BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_SET,BIOELECTRIC_FINITE_ELEMENT_CALCULATE, &
    & BIOELECTRIC_EQUATIONS_SET_SETUP,BIOELECTRIC_PROBLEM_CLASS_TYPE_SET,BIOELECTRIC_PROBLEM_SETUP
  ...
  SUBROUTINE BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_SET(EQUATIONS_SET,EQUATIONS_TYPE,EQUATIONS_SUBTYPE, &
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
        CALL BIOELEC_DOMAIN_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SUBTYPE,ERR,ERROR,*999)
...
999 CALL ERRORS("BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE BIOELECTRIC_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
        CALL BIOELEC_DOMAIN_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*999)
      CASE(EQUATIONS_SET_BIDOMAIN_EQUATION_TYPE)
        CALL BIOELEC_DOMAIN_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*999)
      CASE DEFAULT
...
999 CALL ERRORS("BIOELECTRIC_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
  ...
  SUBROUTINE BIOELECTRIC_EQUATIONS_SET_SETUP(EQUATIONS_SET,SETUP_TYPE,ACTION_TYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      SELECT CASE(EQUATIONS_SET%TYPE)
      CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
        CALL BIOELEC_DOMAIN_EQUATION_EQUATIONS_SET_SETUP(EQUATIONS_SET,SETUP_TYPE,ACTION_TYPE,ERR,ERROR,*999)
      CASE(EQUATIONS_SET_BIDOMAIN_EQUATION_TYPE)
        CALL BIOELEC_DOMAIN_EQUATION_EQUATIONS_SET_SETUP(EQUATIONS_SET,SETUP_TYPE,ACTION_TYPE,ERR,ERROR,*999)
      CASE DEFAULT
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CASE(PROBLEM_MONODOMAIN_EQUATION_TYPE,PROBLEM_BIDOMAIN_EQUATION_TYPE)
        ...
        CASE(PROBLEM_NO_SUBTYPE)        
          ...
          CALL BIOELEC_DOMAIN_EQUATION_PROBLEM_SETUP(PROBLEM,PROBLEM_SETUP_INITIAL_TYPE,PROBLEM_SETUP_START_ACTION, &
            & ERR,ERROR,*999)
        CASE DEFAULT
...
999 CALL ERRORS("BIOELECTRIC_PROBLEM_CLASS_TYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE BIOELECTRIC_PROBLEM_SETUP(PROBLEM,SETUP_TYPE,ACTION_TYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CASE(PROBLEM_MONODOMAIN_EQUATION_TYPE)
        CALL BIOELEC_DOMAIN_EQUATION_PROBLEM_SETUP(PROBLEM,SETUP_TYPE,ACTION_TYPE,ERR,ERROR,*999)
