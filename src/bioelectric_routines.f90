...
999 ERRORSEXITS("BIOELECTRIC_CONTROL_LOOP_POST_LOOP",ERR,ERROR)
  ...
  SUBROUTINE BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_GET(EQUATIONS_SET,EQUATIONS_TYPE,EQUATIONS_SUBTYPE, &
    ...
    ENTERS("BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_GET",ERR,ERROR,*999)
    ...
    RETURN
999 ERRORSEXITS("BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_SET(EQUATIONS_SET,EQUATIONS_TYPE,EQUATIONS_SUBTYPE, &
    ...
    ENTERS("BIOELECTRIC_EQUATIONS_SET_CLASS_SET",ERR,ERROR,*999)
    ...
    RETURN
999 ERRORSEXITS("BIOELECTRIC_EQUATIONS_SET_CLASS_TYPE_SET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("BIOELECTRIC_POST_SOLVE",ERR,ERROR)
  ...
  SUBROUTINE BIOELECTRIC_PROBLEM_CLASS_TYPE_GET(PROBLEM,PROBLEM_EQUATION_TYPE,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("BIOELECTRIC_PROBLEM_CLASS_TYPE_GET",ERR,ERROR,*999)
    ...
    RETURN
999 ERRORSEXITS("BIOELECTRIC_PROBLEM_CLASS_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE BIOELECTRIC_PROBLEM_CLASS_TYPE_SET(PROBLEM,PROBLEM_EQUATION_TYPE,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("BIOELECTRIC_PROBLEM_CLASS_SET",ERR,ERROR,*999)
    ...
    RETURN
999 ERRORSEXITS("BIOELECTRIC_PROBLEM_CLASS_TYPE_SET",ERR,ERROR)
    RETURN 1
