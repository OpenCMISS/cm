...
! temporary input for vector-source
  ...
  PUBLIC POISSON_EQUATION_EQUATIONS_SET_SETUP,POISSON_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET, &
    ...
    & POISSON_EQUATION_PROBLEM_SUBTYPE_SET,POISSON_EQUATION_PROBLEM_SETUP,POISSON_PRE_SOLVE_UPDATE_INPUT_DATA
  ...
  SUBROUTINE POISSON_EQUATION_EQUATIONS_SET_LINEAR_SOURCE_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_CONSTANT_SOURCE_POISSON_SUBTYPE.OR. &
        ...
        & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_STOKES_POISSON_SUBTYPE.OR. & 
        ...
        CASE(EQUATIONS_SET_NAVIER_STOKES_POISSON_SUBTYPE,EQUATIONS_SET_STOKES_POISSON_SUBTYPE)
          ...
          DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
            ...
            IF(RHS_VECTOR%UPDATE_VECTOR) THEN
              W_VALUE(1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(1,NO_PART_DERIV)
              W_VALUE(2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(2,NO_PART_DERIV)
              W_VALUE(3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(3,NO_PART_DERIV)

              W_DERIV(1,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(1,PART_DERIV_S1)
              W_DERIV(1,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(1,PART_DERIV_S2)
              W_DERIV(1,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(1,PART_DERIV_S3)
              W_DERIV(2,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(2,PART_DERIV_S1)
              W_DERIV(2,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(2,PART_DERIV_S2)
              W_DERIV(2,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(2,PART_DERIV_S3) 
              W_DERIV(3,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(3,PART_DERIV_S1)
              W_DERIV(3,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(3,PART_DERIV_S2)
              W_DERIV(3,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(3,PART_DERIV_S3)

              W_SECOND(1,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(1,PART_DERIV_S1_S1)
              W_SECOND(1,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(1,PART_DERIV_S2_S2)
              W_SECOND(1,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(1,PART_DERIV_S3_S3)
              W_SECOND(2,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(2,PART_DERIV_S1_S1)
              W_SECOND(2,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(2,PART_DERIV_S2_S2)
              W_SECOND(2,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(2,PART_DERIV_S3_S3) 
              W_SECOND(3,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(3,PART_DERIV_S1_S1)
              W_SECOND(3,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(3,PART_DERIV_S2_S2)
              W_SECOND(3,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT%VALUES(3,PART_DERIV_S3_S3)
...
999 CALL ERRORS("POISSON_EQUATION_PROBLEM_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE POISSON_EQUATION_PROBLEM_LINEAR_SOURCE_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    NULLIFY(SOLVERS)
    IF(ASSOCIATED(PROBLEM)) THEN
      IF(PROBLEM%SUBTYPE==PROBLEM_LINEAR_SOURCE_POISSON_SUBTYPE.OR.PROBLEM%SUBTYPE==PROBLEM_NAVIER_STOKES_POISSON_SUBTYPE.OR. &
        & PROBLEM%SUBTYPE==PROBLEM_STOKES_POISSON_SUBTYPE) THEN
