...
!!TODO: CHANGE ELEMENT CALCULATE TO WORK OF ns ???
        ...
        CASE(EQUATIONS_SET_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE)
          ...
          DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
            ...
            CALL COORDINATE_SYSTEM_CALCULATE_DNUDXI(GEOMETRIC_INTERP_POINT_METRICS,GEOMETRIC_INTERPOLATED_POINT, &
              & FIBRE_INTERPOLATED_POINT,DNUDXI,DXIDNU,ERR,ERROR,*999)
