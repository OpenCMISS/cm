...
999 CALL ERRORS("POISSON_EQUATION_PROBLEM_SETUP",ERR,ERROR)
  ...
  SUBROUTINE POISSON_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    INTEGER(INTG) FIELD_VAR_TYPE,ng,mh,mhs,mi,ms,nh,nhs,ni,ns,I,J,K,L,M !,k1sum,k2sum
    REAL(DP) :: RWG,SUM,PGMSI(3),PGNSI(3),SUM2,DXI_DX(3,3),DELTA_T,DXI_DX_DX(3,3)
    REAL(DP) :: W_VALUE(3),W_DERIV(3,3),RHO_PARAM,MU_PARAM,W_OLD(3),W_SECOND(3,3,3),X(3),B(3)
        ...
        CASE(EQUATIONS_SET_NAVIER_STOKES_POISSON_SUBTYPE,EQUATIONS_SET_STOKES_POISSON_SUBTYPE)
          ...
          DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
            ...
            IF(SOURCE_VECTOR%UPDATE_VECTOR) THEN
              ...
              W_SECOND(1,1,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S1_S1)
              W_SECOND(1,1,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S1_S2)
              W_SECOND(1,1,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S1_S3)
              W_SECOND(1,2,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S1_S2)
              W_SECOND(1,2,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S2_S2)
              W_SECOND(1,2,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S2_S3)
              W_SECOND(1,3,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S1_S3)
              W_SECOND(1,3,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S2_S3)
              W_SECOND(1,3,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,PART_DERIV_S3_S3)

              W_SECOND(2,1,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S1_S1)
              W_SECOND(2,1,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S1_S2)
              W_SECOND(2,1,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S1_S3)
              W_SECOND(2,2,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S1_S2)
              W_SECOND(2,2,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S2_S2)
              W_SECOND(2,2,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S2_S3)
              W_SECOND(2,3,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S1_S3)
              W_SECOND(2,3,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S2_S3)
              W_SECOND(2,3,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,PART_DERIV_S3_S3)

              W_SECOND(3,1,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S1_S1)
              W_SECOND(3,1,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S1_S2)
              W_SECOND(3,1,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S1_S3)
              W_SECOND(3,2,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S1_S2)
              W_SECOND(3,2,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S2_S2)
              W_SECOND(3,2,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S2_S3)
              W_SECOND(3,3,1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S1_S3)
              W_SECOND(3,3,2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S2_S3)
              W_SECOND(3,3,3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,PART_DERIV_S3_S3)
              ...
              W_OLD(1)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(1,NO_PART_DERIV)
              W_OLD(2)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,NO_PART_DERIV)
              W_OLD(3)=EQUATIONS%INTERPOLATION%SOURCE_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(3,NO_PART_DERIV)
                ...
                IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_STOKES_POISSON_SUBTYPE) THEN
                  ...
                  IF(SOURCE_VECTOR%UPDATE_VECTOR) THEN
                    DO I=1,3
                      ...
                      B(I)=-RHO_PARAM*((W_VALUE(1)-W_OLD(1))/DELTA_T)
! !                       this is the first viscous term
!                       DO K=1,3
!                         DO L=1,3
!                           B(I)=B(I)+W_DERIV(I,L)*DXI_DX_DX(L,K)
!                         ENDDO  
!                       ENDDO  
!                       this is the second viscous term
                      DO K=1,3
                        DO L=1,3
                          DO M=1,3
                            B(I)=B(I)+MU_PARAM*W_SECOND(I,L,M)*DXI_DX(M,K)*DXI_DX(L,K)
                          ENDDO  
                        ENDDO  
                      ENDDO  
                    !eventually it gets combined to the RHS (source) term
                      DO J=1,3
                        SUM=SUM+B(I)*PGMSI(J)*DXI_DX(J,I)
                      ENDDO
                    ENDDO
                ...
                ELSE IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_NAVIER_STOKES_POISSON_SUBTYPE) THEN
                  ...
                  IF(SOURCE_VECTOR%UPDATE_VECTOR) THEN
                    DO I=1,3
                      ...
                      DO K=1,3
                        DO L=1,3
                          B(I)=B(I)-RHO_PARAM*W_VALUE(K)*W_DERIV(I,L)*DXI_DX(L,K)
                        ENDDO
                      ENDDO
!!                       this is the first viscous term
!                       DO K=1,3
                  ...
                  IF(ASSOCIATED(EQUATIONS)) THEN
                    ...
                    IF(ASSOCIATED(EQUATIONS_SET)) THEN
                      ...
                      CALL FLUID_MECHANICS_IO_READ_DATA(SOLVER_LINEAR_TYPE,INPUT_DATA2, & 
                        & NUMBER_OF_DIMENSIONS,INPUT_TYPE,INPUT_OPTION,CURRENT_TIME)
                      !here we need to add the calculation of the boundary field
