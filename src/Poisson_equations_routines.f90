...
! temporary input for vector-source
  ...
  PUBLIC POISSON_EQUATION_EQUATIONS_SET_SETUP,POISSON_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET, &
    ...
    & POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI      
  ...
  SUBROUTINE POISSON_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_CLASSICAL_FIELD_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_POISSON_EQUATION_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE
      !!MMend          
...
!!MM
  ...
  SUBROUTINE POISSON_EQN_EQNS_SET_EXTRACELLULAR_BIDOMAIN_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    !Local Variables
    INTEGER(INTG) :: component_idx,GEOMETRIC_COMPONENT_NUMBER,GEOMETRIC_SCALING_TYPE,NUMBER_OF_DIMENSIONS, &
      & NUMBER_OF_MATERIALS_COMPONENTS, GEOMETRIC_MESH_COMPONENT,I!,INDEPENDENT_FIELD_NUMBER_OF_COMPONENTS, &
      !& INDEPENDENT_FIELD_NUMBER_OF_VARIABLES
    TYPE(FIELD_TYPE), POINTER :: ANALYTIC_FIELD,DEPENDENT_FIELD,GEOMETRIC_FIELD     
    TYPE(DECOMPOSITION_TYPE), POINTER :: GEOMETRIC_DECOMPOSITION
    TYPE(EQUATIONS_TYPE), POINTER :: EQUATIONS
    TYPE(EQUATIONS_MAPPING_TYPE), POINTER :: EQUATIONS_MAPPING
    ...
    CALL ENTERS("POISSON_EQN_EQNS_SET_EXTRACELLULAR_BIDOMAIN_SETUP",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE) THEN
        SELECT CASE(EQUATIONS_SET_SETUP%SETUP_TYPE)
        CASE(EQUATIONS_SET_SETUP_INITIAL_TYPE)
          SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_DELUDELN_VARIABLE_TYPE,"del Phi/del n", &
                & ERR,ERROR,*999)    
              CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE,"V_m",ERR,ERROR,*999)
              ...
              CALL FIELD_COMPONENT_LABEL_SET(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE,1,"V_m",ERR,ERROR,*999)
               
              !Default to the geometric interpolation setup
              CALL FIELD_COMPONENT_MESH_COMPONENT_GET(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD,FIELD_U_VARIABLE_TYPE,1, &
                & GEOMETRIC_COMPONENT_NUMBER,ERR,ERROR,*999)
              !!MM needed ?
              CALL FIELD_COMPONENT_MESH_COMPONENT_GET(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD,FIELD_V_VARIABLE_TYPE,1, &
                & GEOMETRIC_COMPONENT_NUMBER,ERR,ERROR,*999)                
              ...
              CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
                ...
                CALL FIELD_COMPONENT_INTERPOLATION_SET_AND_LOCK(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD, &
                  & FIELD_DELUDELN_VARIABLE_TYPE,1,FIELD_NODE_BASED_INTERPOLATION,ERR,ERROR,*999)
                CALL FIELD_COMPONENT_INTERPOLATION_SET_AND_LOCK(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE,1, &
                  & FIELD_NODE_BASED_INTERPOLATION,ERR,ERROR,*999)                  
                !Default the scaling to the geometric field scaling
                CALL FIELD_SCALING_TYPE_GET(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD,GEOMETRIC_SCALING_TYPE,ERR,ERROR,*999)
                CALL FIELD_SCALING_TYPE_SET(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,GEOMETRIC_SCALING_TYPE,ERR,ERROR,*999)
            ...
            ELSE
              ...
              CALL FIELD_VARIABLE_TYPES_CHECK(EQUATIONS_SET_SETUP%FIELD, &              
                & (/FIELD_U_VARIABLE_TYPE,FIELD_DELUDELN_VARIABLE_TYPE,FIELD_V_VARIABLE_TYPE/),ERR,ERROR,*999)
                
              CALL FIELD_DIMENSION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_U_VARIABLE_TYPE,FIELD_SCALAR_DIMENSION_TYPE,ERR,ERROR,*999)
              CALL FIELD_DIMENSION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_DELUDELN_VARIABLE_TYPE,FIELD_SCALAR_DIMENSION_TYPE, &
                & ERR,ERROR,*999)
              CALL FIELD_DIMENSION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_V_VARIABLE_TYPE,FIELD_SCALAR_DIMENSION_TYPE,ERR,ERROR,*999)
            ...
            IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
              IF(EQUATIONS_MATERIALS%MATERIALS_FIELD_AUTO_CREATED) THEN
                ...
                ELSEIF(NUMBER_OF_DIMENSIONS==3) THEN
                  NUMBER_OF_MATERIALS_COMPONENTS=12
                ENDIF                                
                !First set the k values to 1.0 --> MM needed?? / change??
...
!                  ENDIF    
              ...
              CASE DEFAULT
                LOCAL_ERROR="The action type of "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET_SETUP%ACTION_TYPE,"*",ERR,ERROR))// &
                & " for a setup type of "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET_SETUP%SETUP_TYPE,"*",ERR,ERROR))// &
                & " is invalid for a extracellular bidomain Poisson subtype"
                CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
              END SELECT
            CASE DEFAULT
              LOCAL_ERROR="The equation set subtype of "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET%SUBTYPE,"*",ERR,ERROR))// &
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ...
            CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
              ...
              IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE) THEN   
                ...
                CALL EQUATIONS_MAPPING_RHS_VARIABLE_TYPE_SET(EQUATIONS_MAPPING,FIELD_DELUDELN_VARIABLE_TYPE,ERR,ERROR,*999)   
              ELSE
                LOCAL_ERROR="The equations set subtype "// &
                  & TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET%SUBTYPE,"*",ERR,ERROR))//" is invalid."
              ENDIF    
              CALL EQUATIONS_MAPPING_CREATE_FINISH(EQUATIONS_MAPPING,ERR,ERROR,*999)
              !Create the equations matrices
              CALL EQUATIONS_MATRICES_CREATE_START(EQUATIONS,EQUATIONS_MATRICES,ERR,ERROR,*999)
    ...
    CALL EXITS("POISSON_EQN_EQNS_SET_EXTRACELLULAR_BIDOMAIN_SETUP")
    RETURN
999 CALL ERRORS("POISSON_EQN_EQNS_SET_EXTRACELLULAR_BIDOMAIN_SETUP",ERR,ERROR)
    CALL EXITS("POISSON_EQN_EQNS_SET_EXTRACELLULAR_BIDOMAIN_SETUP")
    RETURN 1
  END SUBROUTINE POISSON_EQN_EQNS_SET_EXTRACELLULAR_BIDOMAIN_SETUP
!!MMend
  !
  !================================================================================================================================
  !
...
!Local Variables
    ...
    REAL(DP) :: RWG,SUM,PGMSI(3),PGNSI(3),SUM1,SUM2,DXI_DX(3,3),DELTA_T,DXI_DX_DX(3,3),PHINS
    REAL(DP) :: CONDUCTIVITY_MATERIAL(3,3),CONDUCTIVITY(3,3),CONDUCTIVITY_TEMP(3,3),DNUDXI(3,3),DXIDNU(3,3)
    ...
    TYPE(EQUATIONS_MATRIX_TYPE), POINTER :: EQUATIONS_MATRIX,RHS_MATRIX
...
!!TODO: CHANGE ELEMENT CALCULATE TO WORK OF ns ???
        ...
        CASE(EQUATIONS_SET_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE)
          ...
          LINEAR_MATRICES=>EQUATIONS_MATRICES%LINEAR_MATRICES
          EQUATIONS_MATRIX=>LINEAR_MATRICES%MATRICES(1)%PTR
          RHS_MATRIX=>LINEAR_MATRICES%MATRICES(2)%PTR
          RHS_VECTOR=>EQUATIONS_MATRICES%RHS_VECTOR
          EQUATIONS_MAPPING=>EQUATIONS%EQUATIONS_MAPPING
          LINEAR_MAPPING=>EQUATIONS_MAPPING%LINEAR_MAPPING
          FIELD_VARIABLE=>LINEAR_MAPPING%EQUATIONS_MATRIX_TO_VAR_MAPS(1)%VARIABLE
          ...
          DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
            ...
            CONDUCTIVITY_MATERIAL=0.0_DP  !intra- plus extracellular
            ...
            IF(NUMBER_OF_DIMENSIONS==2) THEN
              ...
              CONDUCTIVITY_I_MATERIAL(1,1)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(4,1)
              CONDUCTIVITY_I_MATERIAL(2,2)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(5,1)
              CONDUCTIVITY_I_MATERIAL(1,2)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(6,1)
            ...
            ELSE
              ...
              CONDUCTIVITY_I_MATERIAL(1,1)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(7,1)
              CONDUCTIVITY_I_MATERIAL(2,2)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(8,1)
              CONDUCTIVITY_I_MATERIAL(3,3)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(9,1)
              CONDUCTIVITY_I_MATERIAL(1,2)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(10,1)
              CONDUCTIVITY_I_MATERIAL(2,1)=CONDUCTIVITY_I_MATERIAL(1,2)
              CONDUCTIVITY_I_MATERIAL(2,3)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(11,1)
              CONDUCTIVITY_I_MATERIAL(3,2)=CONDUCTIVITY_I_MATERIAL(2,3)
              CONDUCTIVITY_I_MATERIAL(1,3)=EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(12,1)
              CONDUCTIVITY_I_MATERIAL(3,1)=CONDUCTIVITY_I_MATERIAL(1,3)
            ENDIF
  
            !rotate the conductivities in material coordinates to get the effective conductivity
            CALL POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI(GEOMETRIC_INTERPOLATED_POINT,FIBRE_INTERPOLATED_POINT,&
            ...
            !now add the RHS-matrix
            IF(RHS_MATRIX%UPDATE_MATRIX) THEN
              !Loop over field components
              mhs=0          
              DO mh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                !Loop over element rows
                  ...
                  DO nh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                    DO ns=1,DEPENDENT_BASIS%NUMBER_OF_ELEMENT_PARAMETERS
                      ...
                      DO I=1,DEPENDENT_BASIS%NUMBER_OF_XI
                        DO K=1,DEPENDENT_BASIS%NUMBER_OF_XI
                          DO H=1,DEPENDENT_BASIS%NUMBER_OF_XI
                            SUM=SUM+CONDUCTIVITY_I(I,K)*PGNSI(K)*PGMSI(H)*EQUATIONS%INTERPOLATION% &
                            & GEOMETRIC_INTERP_POINT_METRICS(FIELD_U_VARIABLE_TYPE)%PTR%GU(I,H)
                          ENDDO !H
                        ENDDO !K
                      ENDDO !I
                        
                      RHS_MATRIX%ELEMENT_MATRIX%MATRIX(mhs,nhs)=RHS_MATRIX%ELEMENT_MATRIX%MATRIX(mhs,nhs)+SUM*RWG
            ...
            ! initialise element RHS_VECTORs with 0 - later global RHS_VECTOR = RHS_MATRIX * V_m^n             
...
!                  ENDDO !nh
!                ENDIF
!                IF(RHS_VECTOR%UPDATE_VECTOR) RHS_VECTOR%ELEMENT_VECTOR%VECTOR(mhs)=RHS_VECTOR% &
  ...
  SUBROUTINE POISSON_EQUATION_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CASE(PROBLEM_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE)        
        ...
        PROBLEM%SUBTYPE=PROBLEM_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE     
      CASE(PROBLEM_LINEAR_SOURCE_POISSON_SUBTYPE)        
        PROBLEM%CLASS=PROBLEM_CLASSICAL_FIELD_CLASS
        PROBLEM%TYPE=PROBLEM_POISSON_EQUATION_TYPE
...
!!MM
  ...
  SUBROUTINE POISSON_EQUATION_PROBLEM_EXTRACELLULAR_BIDOMAIN_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("POISSON_EQUATION_PROBLEM_EXTRACELLULAR_BIDOMAIN_SETUP",ERR,ERROR,*999)
    ...
    NULLIFY(SOLVERS)
    IF(ASSOCIATED(PROBLEM)) THEN
      IF(PROBLEM%SUBTYPE==PROBLEM_EXTRACELLULAR_BIDOMAIN_POISSON_SUBTYPE) THEN
    ...
    CALL EXITS("POISSON_EQUATION_PROBLEM_EXTRACELLULAR_BIDOMAIN_SETUP")
    RETURN
999 CALL ERRORS("POISSON_EQUATION_PROBLEM_EXTRACELLULAR_BIDOMAIN_SETUP",ERR,ERROR)
    CALL EXITS("POISSON_EQUATION_PROBLEM_EXTRACELLULAR_BIDOMAIN_SETUP")
    RETURN 1
  END SUBROUTINE POISSON_EQUATION_PROBLEM_EXTRACELLULAR_BIDOMAIN_SETUP
!!MMend
...
999 CALL ERRORS("POISSON_POST_SOLVE_OUTPUT_DATA",ERR,ERROR)
  ...
  SUBROUTINE POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI(GEOMETRIC_INTERPOLATED_POINT,FIBRE_INTERPOLATED_POINT,&
              & DIMEN,NUMBER_OF_XI,DNUDXI,DXIDNU,ERR,ERROR,*)
  
  !Argument variables
  TYPE (FIELD_INTERPOLATED_POINT_TYPE), POINTER :: GEOMETRIC_INTERPOLATED_POINT,FIBRE_INTERPOLATED_POINT
  INTEGER(INTG), INTENT(IN) :: DIMEN,NUMBER_OF_XI   !<The number of dimensions and the number of xi directions
  ...
  REAL(DP) :: DXDXI(DIMEN,DIMEN)
  REAL(DP) :: DXDNU(DIMEN,DIMEN),DNUDX(DIMEN,DIMEN)
  REAL(DP) :: DNUDXI_TEMP(DIMEN,DIMEN)
  REAL(DP) :: Jnuxi
  
  CALL ENTERS("POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI",ERR,ERROR,*999)
  ...
  CALL EXITS("POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI")
    RETURN
999 CALL ERRORS("POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI",ERR,ERROR)
    CALL EXITS("POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI")
    RETURN 1
  
  END SUBROUTINE POISSON_EQUATION_FINITE_ELEMENT_CALCULATE_DNUDXI
