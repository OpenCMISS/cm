...
PROGRAM OPENCMISSTEST
  ...
  CHARACTER(LEN=MAXSTRLEN) :: DIAG_ROUTINE_LIST(1),TIMING_ROUTINE_LIST(3)
  ...
  TIMING_ROUTINE_LIST(1)="LIST_ITEM_ADD_INTG_DA"
  TIMING_ROUTINE_LIST(2)="DECOMPOSITION_ELEMENT_DOMAIN_CALCULATE"
  TIMING_ROUTINE_LIST(3)="MESH_CREATE_REGULAR"
  !CALL TIMING_SET_ON(IN_TIMING_TYPE,.TRUE.,"OpenCMISSTest",TIMING_ROUTINE_LIST,ERR,ERROR,*999)
  ...
  !CALL COORDINATE_SYSTEM_SET_DIMENSION(COORDINATE_SYSTEM,3,ERR,ERROR,*999)
  ...
  !Get a pointer to the depdendent field
  CALL PROBLEM_DEPENDENT_DEPENDENT_FIELD_GET(PROBLEM,DEPENDENT_FIELD,ERR,ERROR,*999)
