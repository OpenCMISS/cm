...
PROGRAM OPENCMISSTEST
  ...
  !CALL PROBLEM_SOLVER_OUTPUT_TYPE_SET(PROBLEM,SOLVER_NO_OUTPUT,ERR,ERROR,*999)
  !CALL PROBLEM_SOLVER_OUTPUT_TYPE_SET(PROBLEM,SOLVER_TIMING_OUTPUT,ERR,ERROR,*999)
  !CALL PROBLEM_SOLVER_OUTPUT_TYPE_SET(PROBLEM,SOLVER_SOLVER_OUTPUT,ERR,ERROR,*999)
  CALL PROBLEM_SOLVER_OUTPUT_TYPE_SET(PROBLEM,SOLVER_SOLVER_OUTPUT,ERR,ERROR,*999)
