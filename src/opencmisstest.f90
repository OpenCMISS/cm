...
PROGRAM OPENCMISSTEST
  ...
  DIAG_ROUTINE_LIST(1)="DISTRIBUTED_MATRIX_STORAGE_LOCATIONS_SET"
  DIAG_ROUTINE_LIST(1)="GLOBAL_MATRIX_STRUCTURE_CALCULATE"
  DIAG_ROUTINE_LIST(1)="SOLUTION_MAPPING_SOLVER_MATRIX_MAPS_CALCULATE"
  DIAG_ROUTINE_LIST(1)="DISTRIBUTED_MATRIX_SOLVER_STRUCTURE_CALCULATE_FROM_MAP"
  ...
  !CALL DIAGNOSTICS_SET_ON(IN_DIAG_TYPE,DIAG_LEVEL_LIST,"openCMISSTest",DIAG_ROUTINE_LIST,ERR,ERROR,*999)
  ...
  ELSE
    CALL MESH_CREATE_REGULAR(1,REGION,(/0.0_DP,0.0_DP,0.0_DP/),(/WIDTH,HEIGHT,LENGTH/),(/NUMBER_GLOBAL_X_ELEMENTS, &
      & NUMBER_GLOBAL_X_ELEMENTS,NUMBER_GLOBAL_Z_ELEMENTS/),BASIS,MESH,ERR,ERROR,*999)
  ENDIF
  ...
  IF(MY_COMPUTATIONAL_NODE_NUMBER==first_local_rank) &
    & CALL EQUATIONS_SET_FIXED_CONDITIONS_SET_DOF(EQUATIONS_SET,first_local_dof,EQUATIONS_SET_FIXED_BOUNDARY_CONDITION, &
    & 0.0_DP,ERR,ERROR,*999)
  IF(MY_COMPUTATIONAL_NODE_NUMBER==last_local_rank) &
    & CALL EQUATIONS_SET_FIXED_CONDITIONS_SET_DOF(EQUATIONS_SET,last_local_dof,EQUATIONS_SET_FIXED_BOUNDARY_CONDITION, &
  ...
  !CALL EQUATIONS_SET_EQUATIONS_SPARSITY_TYPE_SET(EQUATIONS_SET,EQUATIONS_SET_FULL_MATRICES,ERR,ERROR,*999)
  !Set the equations set output
  CALL EQUATIONS_SET_EQUATIONS_OUTPUT_TYPE_SET(EQUATIONS_SET,EQUATIONS_SET_TIMING_OUTPUT,ERR,ERROR,*999)
  !CALL EQUATIONS_SET_EQUATIONS_OUTPUT_TYPE_SET(EQUATIONS_SET,EQUATIONS_SET_EQUATIONS_MATRIX_OUTPUT,ERR,ERROR,*999)
  !CALL EQUATIONS_SET_EQUATIONS_OUTPUT_TYPE_SET(EQUATIONS_SET,EQUATIONS_SET_ELEMENT_MATRIX_OUTPUT,ERR,ERROR,*999)
  ...
  CALL PROBLEM_SOLUTION_EQUATIONS_SET_ADD(PROBLEM,1,EQUATIONS_SET,ERR,ERROR,*999)
  !CALL PROBLEM_SOLUTION_OUTPUT_TYPE_SET(PROBLEM,1,PROBLEM_SOLUTION_NO_OUTPUT,ERR,ERROR,*999)
  !CALL PROBLEM_SOLUTION_OUTPUT_TYPE_SET(PROBLEM,1,PROBLEM_SOLUTION_TIMING_OUTPUT,ERR,ERROR,*999)
  CALL PROBLEM_SOLUTION_OUTPUT_TYPE_SET(PROBLEM,1,PROBLEM_SOLUTION_MATRIX_OUTPUT,ERR,ERROR,*999)
  ...
  !CALL PROBLEM_SOLVER_OUTPUT_TYPE_SET(PROBLEM,PROBLEM_SOLVER_TIMING_OUTPUT,ERR,ERROR,*999)
  CALL PROBLEM_SOLVER_OUTPUT_TYPE_SET(PROBLEM,1,PROBLEM_SOLVER_SOLVER_OUTPUT,ERR,ERROR,*999)
