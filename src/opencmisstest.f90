...
PROGRAM OPENCMISSTEST
  ...
  CALL EQUATIONS_SET_EQUATIONS_OUTPUT_TYPE_SET(EQUATIONS_SET,EQUATIONS_SET_MATRIX_OUTPUT,ERR,ERROR,*999)
  ...
  !CALL SOLVER_SPARSITY_TYPE_SET(SOLVER,SOLVER_FULL_MATRICES,ERR,ERROR,*999)
