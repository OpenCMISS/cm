...
MODULE INTERFACE_CONDITIONS_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_FRICTIONLESS_CONTACT_OPERATOR=5!<Frictionless contact operator, i.e., lambda.(g_1.n-g_2.n). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  !>@}
