...
MODULE INTERFACE_CONDITIONS_CONSTANTS
  ...
  !> \see INTERFACE_CONDITIONS_CONSTANTS
  !>@{
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_FIELD_GAUSS_CONTINUITY_OPERATOR=1 !<Continuous field operator defined at gauss points, i.e., W_gauss*lambda.(u1_gauss-u2_gauss). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_FIELD_NODE_CONTINUITY_OPERATOR=2 !<Continuous field operator defined at element nodes, i.e.,  W_node*lambda.(u1_node-u2_node). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_FIELD_GAUSS_NODE_CONTINUITY_OPERATOR=3 !<Continuous field operator defined as a weighted combination of element gauss points and nodes, i.e., W_gauss*lambda.(u1_gauss-u2_gauss) + W_node*lambda.(u1_node-u2_node). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
