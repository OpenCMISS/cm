...
MODULE INTERFACE_CONDITIONS_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_FIELD_NORMAL_CONTINUITY_OPERATOR=4 !<Continuous field normal operator, i.e., lambda(u_1.n_1-u_2.n_2). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_FLS_CONTACT_OPERATOR=5!<Frictionless contact operator, i.e., lambda.(x_1.n-x_2.n). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_FLS_CONTACT_REPROJECT_OPERATOR=6!<Frictionless contact operator, reproject at each newton iteration and has geometric linearisation terms i.e., lambda.(x_1.n-x_2.n). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_SOLID_FLUID_OPERATOR=7 !<Solid fluid operator, i.e., lambda.(v_f-du_s/dt). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_SOLID_FLUID_NORMAL_OPERATOR=8 !<Solid fluid normal operator, i.e., lambda(v_f.n_f-du_s/dt.n_s). \see INTERFACE_CONDITIONS_CONSTANTS_Operators,INTERFACE_CONDITIONS_CONSTANTS 
  !>@}
