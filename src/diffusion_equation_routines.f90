...
999 CALL ERRORS("DIFFUSION_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE DIFFUSION_EQUATION_EQUATIONS_SET_LINEAR_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    TYPE(VARYING_STRING) :: LOCAL_ERROR
    INTEGER(INTG) :: COMPARTMENT_NUMBER,num_var    
...
!=== tob: Create the equations set field for multi-compartment diffusion
...
!                    ENDDO !component_idx
                ...
                !uses number of compartments to check that appropriate number and type of variables have been set on the dependent field
                  CALL FIELD_TYPE_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_GENERAL_TYPE,ERR,ERROR,*999)
                  CALL FIELD_DEPENDENT_TYPE_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_DEPENDENT_TYPE,ERR,ERROR,*999)                 
                  !ALLOCATE(EQUATIONS_SET_FIELD_DATA(2))
...
!                     VARIABLE_TYPES(num_var)=FIELD_U_VARIABLE_TYPE+(FIELD_NUMBER_OF_VARIABLE_SUBTYPES*(num_var-1))
!                     write (*,*) VARIABLE_TYPES(num_var)
...
!                     & FIELD_SCALAR_DIMENSION_TYPE,ERR,ERROR,*999)
!                   CALL FIELD_DIMENSION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_DELU2DELN_VARIABLE_TYPE,FIELD_SCALAR_DIMENSION_TYPE, &
!                     & ERR,ERROR,*999)
!                   CALL FIELD_DIMENSION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_U3_VARIABLE_TYPE, & 
!                     & FIELD_SCALAR_DIMENSION_TYPE,ERR,ERROR,*999)
!                   CALL FIELD_DIMENSION_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_DELU3DELN_VARIABLE_TYPE,FIELD_SCALAR_DIMENSION_TYPE, &
!                     & ERR,ERROR,*999)
!                   CALL FIELD_DATA_TYPE_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_U_VARIABLE_TYPE,FIELD_DP_TYPE,ERR,ERROR,*999)
!                   CALL FIELD_DATA_TYPE_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_DELUDELN_VARIABLE_TYPE,FIELD_DP_TYPE,ERR,ERROR,*999)
