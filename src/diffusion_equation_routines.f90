...
999 CALL ERRORS("DIFFUSION_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE DIFFUSION_EQUATION_EQUATIONS_SET_LINEAR_SETUP(EQUATIONS_SET,SETUP_TYPE,ACTION_TYPE,ERR,ERROR,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    INTEGER(INTG) :: component_idx,GEOMETRIC_MESH_COMPONENT,GEOMETRIC_SCALING_TYPE,NEXT_NUMBER,NUMBER_OF_DIMENSIONS, &
      ...
      IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_NO_SOURCE_DIFFUSION_SUBTYPE) THEN
        ...
        CASE(EQUATIONS_SET_SETUP_INITIAL_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            EQUATIONS_SET%TIME_DEPENDENCE=EQUATIONS_SET_FIRST_ORDER_DYNAMIC
...
!!TODO: maybe given negative user numbers to openCMISS generated fields???
            ...
            CALL FIELD_COMPONENT_MESH_COMPONENT_GET(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD,FIELD_STANDARD_VARIABLE_TYPE,1, &
        ...
        CASE(EQUATIONS_SET_SETUP_MATERIALS_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
              ...
              CALL FIELD_NUMBER_OF_COMPONENTS_GET(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD,FIELD_STANDARD_VARIABLE_TYPE, &
              ...
              DO component_idx=1,NUMBER_OF_DIMENSIONS
                CALL FIELD_COMPONENT_MESH_COMPONENT_GET(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD,FIELD_STANDARD_VARIABLE_TYPE, &
              ...
              IF(ASSOCIATED(DEPENDENT_FIELD)) THEN
                ...
                IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
                  IF(EQUATIONS_MATERIALS%MATERIALS_FINISHED) THEN
                    ...
                    CALL FIELD_PARAMETER_SET_CREATE(DEPENDENT_FIELD,FIELD_INITIAL_VALUES_SET_TYPE,ERR,ERROR,*999)
                  ELSE
          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ...
            CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
              ...
              IF(ASSOCIATED(EQUATIONS)) THEN
                ...
                CALL EQUATIONS_MAPPING_DYNAMIC_VARIABLE_TYPE_SET(EQUATIONS_MAPPING,FIELD_STANDARD_VARIABLE_TYPE,ERR,ERROR,*999)
                ...
                !Set up lumping
                IF(EQUATIONS%LUMPING_TYPE==EQUATIONS_SET_LUMPED_MATRICES) THEN
