...
999 ERRORSEXITS("FLUID_MECHANICS_ANALYTIC_FUNCTIONS_EVALUATE",ERR,ERROR)
  ...
  SUBROUTINE FLUID_MECHANICS_EQUATIONS_SET_CLASS_TYPE_GET(EQUATIONS_SET,EQUATIONS_TYPE,EQUATIONS_SUBTYPE, &
    ...
    ENTERS("FLUID_MECHANICS_EQUATIONS_SET_CLASS_TYPE_GET",ERR,ERROR,*999)
    ...
    EXITS("FLUID_MECHANICS_EQUATIONS_SET_CLASS_TYPE_GET")
    RETURN
999 ERRORSEXITS("FLUID_MECHANICS_EQUATIONS_SET_CLASS_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE FLUID_MECHANICS_EQUATIONS_SET_CLASS_TYPE_SET(EQUATIONS_SET,EQUATIONS_TYPE,EQUATIONS_SUBTYPE, &
    ...
    EXITS("FLUID_MECHANICS_EQUATIONS_SET_CLASS_TYPE_SET")
    RETURN
999 ERRORSEXITS("FLUID_MECHANICS_EQUATIONS_SET_CLASS_TYPE_SET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("FLUID_MECHANICS_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
  ...
  SUBROUTINE FLUID_MECHANICS_FINITE_ELEMENT_JACOBIAN_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("FLUID_MECHANICS_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR,*999)
    ...
    EXITS("FLUID_MECHANICS_FINITE_ELEMENT_JACOBIAN_EVALUATE")
    RETURN
999 ERRORSEXITS("FLUID_MECHANICS_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE FLUID_MECHANICS_FINITE_ELEMENT_RESIDUAL_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("FLUID_MECHANICS_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR,*999)
    ...
    EXITS("FLUID_MECHANICS_FINITE_ELEMENT_RESIDUAL_EVALUATE")
    RETURN
999 ERRORSEXITS("FLUID_MECHANICS_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("FLUID_MECHANICS_EQUATIONS_SET_SETUP",ERR,ERROR)
  ...
  SUBROUTINE FLUID_MECHANICS_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    EXITS("FLUID_MECHANICS_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("FLUID_MECHANICS_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE FLUID_MECHANICS_EQUATIONS_BOUNDARY_CONDITIONS_ANALYTIC(EQUATIONS_SET,BOUNDARY_CONDITIONS,ERR,ERROR,*)
    ...
    ENTERS("FLUID_MECHANICS_EQUATIONS_BOUNDARY_CONDITIONS_ANALYTIC",ERR,ERROR,*999)
    ...
    EXITS("FLUID_MECHANICS_EQUATIONS_BOUNDARY_CONDITIONS_ANALYTIC")
    RETURN
999 ERRORSEXITS("FLUID_MECHANICS_EQUATIONS_BOUNDARY_CONDITIONS_ANALYTIC",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("FLUID_MECHANICS_CONTROL_LOOP_POST_LOOP",ERR,ERROR)
  ...
  SUBROUTINE FluidMechanics_FiniteElementPreResidualEvaluate(equationsSet,err,error,*)
    ...
    RETURN
999 ERRORSEXITS("FluidMechanics_FiniteElementPreResidualEvaluate",err,error)
    RETURN 1
