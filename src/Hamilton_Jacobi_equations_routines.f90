...
CONTAINS
  ...
  SUBROUTINE HJ_EQUATION_ANALYTIC_CALCULATE(EQUATIONS_SET,BOUNDARY_CONDITIONS,ERR,ERROR,*)
    ...
    ENTERS("HJ_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("HJ_EQUATION_ANALYTIC_CALCULATE")
    RETURN
999 ERRORSEXITS("HJ_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("HJ_EQUATION_EQUATIONS_SET_SETUP",ERR,ERROR)
  ...
  SUBROUTINE HJ_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("HJ_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
...
!          CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
    ...
    EXITS("HJ_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("HJ_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE HJ_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("HJ_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("HJ_EQUATION_EQUATIONS_SET_SUBTYPE_SET")
    RETURN
999 ERRORSEXITS("HJ_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("HJ_EQUATION_PROBLEM_SETUP",ERR,ERROR)
  ...
  SUBROUTINE HJ_EQUATION_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("HJ_EQUATION_PROBLEM_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("HJ_EQUATION_PROBLEM_SUBTYPE_SET")
    RETURN
999 ERRORSEXITS("HJ_EQUATION_PROBLEM_SUBTYPE_SET",ERR,ERROR)
    RETURN 1
...
!    ENTERS("GENERATE_STATUS_MASK",Err)
...
!   ENTERS("MATRIX_VECTOR_PRODUCT",Err)
...
!    EXITS("MATRIX_VECTOR_PRODUCT")
!    RETURN
!999 ERRORSEXITS("MATRIX_VECTOR_PRODUCT",ERR,ERROR)
!    RETURN 1
...
!    ENTERS("VECTOR_VECTOR_PRODUCT",Err)
