...
!!MERGE: move
  ...
  PUBLIC HJ_EQUATION_FINITE_ELEMENT_CALCULATE,HJ_EQUATION_EQUATIONS_SET_SETUP,HJ_BoundaryConditionsAnalyticCalculate, &
    & HJEquation_EquationsSetSolutionMethodSet,HJ_EQUATION_EQUATIONS_SET_SUBTYPE_SET, &
