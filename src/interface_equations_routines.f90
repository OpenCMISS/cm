...
999 ERRORSEXITS("INTERFACE_EQUATIONS_DESTROY",ERR,ERROR)
  ...
  SUBROUTINE INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_FINALISE(DOMAIN_INTERPOLATION,ERR,ERROR,*)
    ...
    ENTERS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_FINALISE")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_INITIALISE(DOMAIN_INTERPOLATION,ERR,ERROR,*)
    ...
    ENTERS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_INITIALISE")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE INTERFACE_EQUATIONS_DOMAIN_INTERFACE_INTERPOLATION_(DOMAIN_INTERPOLATION,GEOMETRIC_FIELD,LAGRANGE_FIELD, &
    ...
    ENTERS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_SETUP",ERR,ERROR,*998)
    ...
    EXITS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_SETUP")
    RETURN
999 CALL INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_FINALISE(DOMAIN_INTERPOLATION,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_SETUP",ERR,ERROR)
    RETURN 1
...
998 ERRORSEXITS("INTERFACE_EQUATIONS_DOMAIN_INTERPOLATION_SETUP",ERR,ERROR)
  ...
  SUBROUTINE INTERFACE_EQUATIONS_INTERFACE_INTERP_SETS_NUMBER_SET(INTERFACE_EQUATIONS,NUMBER_OF_GEOMETRIC_SETS, &
    ...
    ENTERS("INTERFACE_EQUATIONS_INTERFACE_INTERP_SETS_NUMBER_SET",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_INTERFACE_INTERP_SETS_NUMBER_SET")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_INTERFACE_INTERP_SETS_NUMBER_SET",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("INTERFACE_EQUATIONS_INTERPOLATION_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE INTERFACE_EQUATIONS_INTERPOLATION_INITIALISE(INTERFACE_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("INTERFACE_EQUATIONS_INTERPOLATION_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("INTERFACE_EQUATIONS_INTERPOLATION_INITIALISE")
    RETURN
999 CALL INTERFACE_EQUATIONS_INTERPOLATION_FINALISE(INTERFACE_EQUATIONS%INTERPOLATION,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("INTERFACE_EQUATIONS_INTERPOLATION_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE INTERFACE_EQUATIONS_INTERPOLATION_SET_FINALISE(INTERPOLATION_SET,ERR,ERROR,*)
    ...
    ENTERS("INTERFACE_EQUATIONS_INTERPOLATION_SET_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_INTERPOLATION_SET_FINALISE")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_INTERPOLATION_SET_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE INTERFACE_EQUATIONS_INTERPOLATION_SET_INITIALISE(INTERPOLATION_SET,ERR,ERROR,*)
    ...
    ENTERS("INTERFACE_EQUATIONS_INTERPOLATION_SET_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_INTERPOLATION_SET_INITIALISE")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_INTERPOLATION_SET_INITIALISE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("INTERFACE_EQUATIONS_LINEARITY_TYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_GET(INTERFACE_EQUATIONS,TIME_DEPENDENCE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_GET",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_GET")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_SET(INTERFACE_EQUATIONS,TIME_DEPENDENCE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_SET")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_TIME_DEPENDENCE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE INTERFACE_EQUATIONS_VARIABLE_INTERP_SETS_NUMBER_SET(INTERFACE_EQUATIONS,VARIABLE_INDEX, &
    ...
    ENTERS("INTERFACE_EQUATIONS_VARIABLE_INTERP_SETS_NUMBER_SET",ERR,ERROR,*999)
    ...
    EXITS("INTERFACE_EQUATIONS_VARIABLE_INTERP_SETS_NUMBER_SET")
    RETURN
999 ERRORSEXITS("INTERFACE_EQUATIONS_VARIABLE_INTERP_SETS_NUMBER_SET",ERR,ERROR)
    RETURN 1
