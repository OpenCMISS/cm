...
MODULE DARCY_EQUATIONS_ROUTINES
  ...
  PUBLIC DarcyEquation_EquationsSetSpecificationSet
  ...
  PUBLIC DarcyEquation_ProblemSpecificationSet
...
999 CALL ERRORS("DarcyEquation_FiniteElementFaceIntegrate",err,error)
  ...
  SUBROUTINE DarcyEquation_EquationsSetSpecificationSet(equationsSet,specification,err,error,*)
    ...
    CALL Enters("DarcyEquation_EquationsSetSpecificationSet",err,error,*999)
    ...
    CALL Exits("DarcyEquation_EquationsSetSpecificationSet")
    RETURN
999 CALL Errors("DarcyEquation_EquationsSetSpecificationSet",err,error)
    CALL Exits("DarcyEquation_EquationsSetSpecificationSet")
    RETURN 1
  END SUBROUTINE DarcyEquation_EquationsSetSpecificationSet
  ...
  SUBROUTINE DarcyEquation_ProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    CALL Enters("DarcyEquation_ProblemSpecificationSet",err,error,*999)
    ...
    IF(ASSOCIATED(problem)) THEN
      ...
      ELSE
        CALL FlagError("Darcy problem specification must have three entries.",err,error,*999)
      END IF
    ELSE
      CALL FlagError("Problem is not associated.",err,error,*999)
    END IF

    CALL Exits("DarcyEquation_ProblemSpecificationSet")
    RETURN
999 CALL Errors("DarcyEquation_ProblemSpecificationSet",err,error)
    CALL Exits("DarcyEquation_ProblemSpecificationSet")
    RETURN 1
  END SUBROUTINE DarcyEquation_ProblemSpecificationSet
