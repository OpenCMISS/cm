...
!=== tob: Create the equations set field for multi-compartment Darcy
              ...
              !ASK_CHRIS: How do we get 'EQUATIONS_EQUATIONS_SET_FIELD' into this routine ?
              !  At the moment, it points nowhere.
              ...
              IF(EQUATIONS_EQUATIONS_SET_FIELD%EQUATIONS_SET_FIELD_AUTO_CREATED) THEN
                ...
                CALL FIELD_CREATE_START(EQUATIONS_SET_SETUP%FIELD_USER_NUMBER,EQUATIONS_SET%REGION, &
                  & EQUATIONS_SET_FIELD_FIELD,ERR,ERROR,*999)
...
!                     MESH_COMPONENT = 3
              ...
              ELSE
                ...
                CASE(EQUATIONS_SET_MULTI_COMPARTMENT_DARCY_SUBTYPE)
                  !Check the field created by Darcy routines for the coupled problem
                  CALL FIELD_TYPE_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_GENERAL_TYPE,ERR,ERROR,*999)
                  CALL FIELD_DEPENDENT_TYPE_CHECK(EQUATIONS_SET_SETUP%FIELD,FIELD_DEPENDENT_TYPE,ERR,ERROR,*999)
