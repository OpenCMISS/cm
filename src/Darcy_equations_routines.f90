...
999 CALL ERRORS("DARCY_CONTROL_TIME_LOOP_PRE_LOOP",ERR,ERROR)
  ...
  SUBROUTINE DARCY_CONTROL_TIME_LOOP_POST_LOOP(CONTROL_LOOP,ERR,ERROR,*)
    ...
    CALL ENTERS("DARCY_CONTROL_TIME_LOOP_POST_LOOP",ERR,ERROR,*999)
    ...
    RETURN
999 CALL ERRORS("DARCY_CONTROL_TIME_LOOP_POST_LOOP",ERR,ERROR)
    CALL EXITS("DARCY_CONTROL_TIME_LOOP_POST_LOOP")
    RETURN 1
  END SUBROUTINE DARCY_CONTROL_TIME_LOOP_POST_LOOP
