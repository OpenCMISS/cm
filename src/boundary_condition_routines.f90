...
!          IF(COMPUTATIONAL_ENVIRONMENT%NUMBER_COMPUTATIONAL_NODES>0) THEN
          IF(BOUNDARY_CONDITIONS%BOUNDARY_CONDITIONS_VARIABLE_TYPE_MAP(1)%PTR%VARIABLE%FIELD%DECOMPOSITION%WORK_GROUP% &
            & COMP_ENVIRONMENT%NUMBER_COMPUTATIONAL_NODES>0) THEN
...
!                      & SEND_COUNT,MPI_INTEGER,MPI_SUM,COMPUTATIONAL_ENVIRONMENT%MPI_COMM,MPI_IERROR)
                       ...
                       & variable_type_idx)%PTR%VARIABLE%FIELD%DECOMPOSITION%WORK_GROUP%COMP_ENVIRONMENT%MPI_COMM,MPI_IERROR)
