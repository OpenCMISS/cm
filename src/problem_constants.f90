...
!  INTEGER(INTG), PARAMETER :: PROBLEM_HJ_SUBTYPE=6
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_TransientRBS_NAVIER_STOKES_SUBTYPE=9
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_1dTransientAdv_NAVIER_STOKES_SUBTYPE=13
  INTEGER(INTG), PARAMETER :: PROBLEM_Coupled1D0DAdv_NAVIER_STOKES_SUBTYPE=14
  INTEGER(INTG), PARAMETER :: PROBLEM_Stree1D0D_NAVIER_STOKES_SUBTYPE=15
  INTEGER(INTG), PARAMETER :: PROBLEM_Stree1D0DAdv_NAVIER_STOKES_SUBTYPE=16
  !  Darcy equation
