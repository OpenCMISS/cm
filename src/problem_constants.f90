...
MODULE PROBLEM_CONSTANTS
  ...
  !Optimisation class
  INTEGER(INTG), PARAMETER :: PROBLEM_OPTIMISATION_KALMAN_TYPE=1
...
!!TODO: We don't really have two problem types here? Maybe a different type with nonlinear boundary conditions???
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_STOKES_POISSON_SUBTYPE=3
  INTEGER(INTG), PARAMETER :: PROBLEM_NAVIER_STOKES_POISSON_SUBTYPE=4
  !  Helmholtz equation
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_OPTIMISATION_KALMAN_SAMPLING_SUBTYPE=1
  INTEGER(INTG), PARAMETER :: PROBLEM_OPTIMISATION_KALMAN_UKF_SUBTYPE=2
