...
MODULE PROBLEM_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_FMM_CLASS=10
...
!!TODO: We don't really have two problem types here? Maybe a different type with nonlinear boundary conditions???
  ...
  INTEGER(INTG), PARAMETER :: SOLVER_EQUATIONS_STATEITERATION=3 !<Solver equations are nonlinear \see PROBLEM_CONSTANTS_EquationLinearityTypes,PROBLEM_CONSTANTS
  !>@}
