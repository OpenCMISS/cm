!> \file
!> $Id: binary_file_f.f90 27 2007-07-24 16:52:51Z cpb $
...
CONTAINS
  ...
  FUNCTION INQUIRE_EOF_BINARY_FILE(FILEID, ERR, ERROR)
    ...
    CALL ENTERS("INQUIRE_EOF_BINARY_FILE",ERR,ERROR,*999)
    ...
    CALL EXITS("INQUIRE_EOF_BINARY_FILE")
    RETURN
999 CALL ERRORS("INQUIRE_EOF_BINARY_FILE",ERR,ERROR)
    CALL EXITS("INQUIRE_EOF_BINARY_FILE")
    RETURN
  END FUNCTION 
  ...
  SUBROUTINE CLOSE_BINARY_FILE(FILEID,ERR,ERROR,*)
    ...
    CALL ENTERS("CLOSE_BINARY_FILE",ERR,ERROR,*999)
    ...
    CALL EXITS("CLOSE_BINARY_FILE")
    RETURN
999 CALL ERRORS("CLOSE_BINARY_FILE",ERR,ERROR)
    CALL EXITS("CLOSE_BINARY_FILE")
    RETURN 1
  ...
  SUBROUTINE CLOSE_CMISS_BINARY_FILE(FILEID,ERR,ERROR,*)
    ...
    CALL ENTERS("CLOSE_CMISS_BINARY_FILE",ERR,ERROR,*999)

    CALL CLOSE_BINARY_FILE(FILEID,ERR,ERROR,*999)

    CALL EXITS("CLOSE_CMISS_BINARY_FILE")
    RETURN
999 CALL ERRORS("CLOSE_CMISS_BINARY_FILE",ERR,ERROR)
    CALL EXITS("CLOSE_CMISS_BINARY_FILE")
    RETURN 1
  ...
  SUBROUTINE OPEN_BINARY_FILE(FILEID,COMMAND,FILENAME,ERR,ERROR,*)
    ...
    CALL ENTERS("OPEN_BINARY_FILE",ERR,ERROR,*999)
    ...
    CALL EXITS("OPEN_BINARY_FILE")
    RETURN
999 IF(ASSOCIATED(FILEID%FILE_INFORMATION)) THEN
      BINARY_FILE_USED(FILEID%FILE_INFORMATION%FILE_NUMBER)=.FALSE.
      DEALLOCATE(FILEID%FILE_INFORMATION)
    ENDIF
    CALL ERRORS("OPEN_BINARY_FILE",ERR,ERROR)
    CALL EXITS("OPEN_BINARY_FILE")
    RETURN 1
  ...
  SUBROUTINE OPEN_CMISS_BINARY_FILE(FILEID,FILE_TYPE,NUMBER_TAGS,&
    ...
    CALL ENTERS("OPEN_CMISS_BINARY_FILE",ERR,ERROR,*999)
    ...
    CALL EXITS("OPEN_CMISS_BINARY_FILE")
    RETURN
999 CALL ERRORS("OPEN_CMISS_BINARY_FILE",ERR,ERROR)
    CALL EXITS("OPEN_CMISS_BINARY_FILE")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_INTG(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_INTG",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_INTG")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_INTG",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_INTG")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_INTG1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_INTG1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_INTG1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_INTG1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_INTG1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_SINTG(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_SINTG",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_SINTG")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_SINTG",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_SINTG")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_SINTG1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_SINTG1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_SINTG1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_SINTG1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_SINTG1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_LINTG(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_LINTG",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_LINTG")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_LINTG",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_LINTG")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_LINTG1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_LINTG1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_LINTG1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_LINTG1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_LINTG1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_SP(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_SP",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_SP")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_SP",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_SP")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_SP1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_SP1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_SP1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_SP1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_SP1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_DP(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_DP",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_DP")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_DP",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_DP")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_DP1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_DP1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_DP1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_DP1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_DP1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_CHARACTER(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_CHARACTER",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_CHARACTER")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_CHARACTER",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_CHARACTER")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_LOGICAL(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_LOGICAL",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_LOGICAL")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_LOGICAL",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_LOGICAL")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_LOGICAL1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_LOGICAL1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_LOGICAL1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_LOGICAL1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_LOGICAL1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_SPC(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_SPC",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_SPC")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_SPC",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_SPC")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_SPC1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_SPC1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_SPC1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_SPC1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_SPC1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_DPC(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_DPC",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_DPC")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_DPC",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_DPC")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_FILE_DPC1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_FILE_DPC1",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_FILE_DPC1")
    RETURN
999 CALL ERRORS("READ_BINARY_FILE_DPC1",ERR,ERROR)
    CALL EXITS("READ_BINARY_FILE_DPC1")
    RETURN 1
  ...
  SUBROUTINE READ_BINARY_TAG_HEADER(FILEID,TAG,ERR,ERROR,*)
    ...
    CALL ENTERS("READ_BINARY_TAG_HEADER",ERR,ERROR,*999)
    ...
    CALL EXITS("READ_BINARY_TAG_HEADER")
    RETURN
999 CALL ERRORS("READ_BINARY_TAG_HEADER",ERR,ERROR)
    CALL EXITS("READ_BINARY_TAG_HEADER")
    RETURN 1
...
!!      OF TAGS AT A SPECIFIED LEVEL IN THE TAG HIERACHY
    ...
    CALL ENTERS("RESET_BINARY_NUMBER_TAGS",ERR,ERROR,*999)
    ...
    CALL EXITS("RESET_BINARY_NUMBER_TAGS")
    RETURN
999 CALL ERRORS("RESET_BINARY_NUMBER_TAGS",ERR,ERROR)
    CALL EXITS("RESET_BINARY_NUMBER_TAGS")
    RETURN 1
  ...
  SUBROUTINE SET_BINARY_FILE(FILEID,SET_CODE,ERR,ERROR,*)
    ...
    CALL ENTERS("SET_BINARY_FILE",ERR,ERROR,*999)
    ...
    CALL EXITS("SET_BINARY_FILE")
    RETURN
999 CALL ERRORS("SET_BINARY_FILE",ERR,ERROR)
    CALL EXITS("SET_BINARY_FILE")
    RETURN 1
  ...
  SUBROUTINE SKIP_CM_BINARY_HEADER(FILEID,SKIP,ERR,ERROR,*)
    ...
    CALL ENTERS("SKIP_CM_BINARY_HEADER",ERR,ERROR,*999)
    ...
    CALL EXITS("SKIP_CM_BINARY_HEADER")
    RETURN
999 CALL ERRORS("SKIP_CM_BINARY_HEADER",ERR,ERROR)
    CALL EXITS("SKIP_CM_BINARY_HEADER")
    RETURN 1
  ...
  SUBROUTINE SKIP_BINARY_FILE(FILEID,NUMBER_BYTES,ERR,ERROR,*)
    ...
    CALL ENTERS("SKIP_BINARY_FILE",ERR,ERROR,*999)
    ...
    CALL EXITS("SKIP_BINARY_FILE")
    RETURN
999 CALL ERRORS("SKIP_BINARY_FILE",ERR,ERROR)
    CALL EXITS("SKIP_BINARY_FILE")
    RETURN 1
  ...
  RECURSIVE SUBROUTINE SKIP_BINARY_TAGS(FILEID,TAG,ERR,ERROR,*)
    ...
    CALL ENTERS("SKIP_BINARY_TAGS",ERR,ERROR,*999)
    ...
    CALL EXITS("SKIP_BINARY_TAGS")
    RETURN
999 CALL ERRORS("SKIP_BINARY_TAGS",ERR,ERROR)
    CALL EXITS("SKIP_BINARY_TAGS")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_INTG(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_INTG",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_INTG")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_INTG",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_INTG")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_INTG1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_INTG1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_INTG1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_INTG1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_INTG1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_SINTG(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_SINTG",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_SINTG")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_SINTG",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_SINTG")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_SINTG1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_SINTG1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_SINTG1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_SINTG1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_SINTG1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_LINTG(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_LINTG",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_LINTG")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_LINTG",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_LINTG")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_LINTG1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_LINTG1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_LINTG1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_LINTG1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_LINTG1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_SP(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_SP",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_SP")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_SP",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_SP")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_SP1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_SP1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_SP1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_SP1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_SP1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_DP(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_DP",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_DP")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_DP",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_DP")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_DP1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_DP1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_DP1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_DP1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_DP1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_CHARACTER(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_CHARACTER",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_CHARACTER")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_CHARACTER",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_CHARACTER")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_LOGICAL(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_LOGICAL",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_LOGICAL")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_LOGICAL",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_LOGICAL")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_LOGICAL1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_LOGICAL1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_LOGICAL1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_LOGICAL1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_LOGICAL1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_SPC(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_SPC",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_SPC")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_SPC",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_SPC")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_SPC1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_SPC1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_SPC1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_SPC1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_SPC1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_DPC(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_DPC",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_DPC")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_DPC",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_DPC")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_FILE_DPC1(FILEID,NUM_DATA,DATA,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_FILE_DPC1",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_FILE_DPC1")
    RETURN
999 CALL ERRORS("WRITE_BINARY_FILE_DPC1",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_FILE_DPC1")
    RETURN 1
  ...
  SUBROUTINE WRITE_BINARY_TAG_HEADER(FILEID,TAG,ERR,ERROR,*)
    ...
    CALL ENTERS("WRITE_BINARY_TAG_HEADER",ERR,ERROR,*999)
    ...
    CALL EXITS("WRITE_BINARY_TAG_HEADER")
    RETURN
999 CALL ERRORS("WRITE_BINARY_TAG_HEADER",ERR,ERROR)
    CALL EXITS("WRITE_BINARY_TAG_HEADER")
    RETURN 1
