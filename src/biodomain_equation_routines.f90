...
MODULE BIODOMAIN_EQUATION_ROUTINES
  ...
  PUBLIC BIODOMAIN_EQUATION_EQUATIONS_SET_SUBTYPE_SET
        ...
        CASE(EQUATIONS_SET_SETUP_START_ACTION)
          ...
          CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
            IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_NO_SUBTYPE) THEN
              ...
              ELSE IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_1D3D_MONODOMAIN_ELASTICITY_SUBTYPE) THEN
          ...
          CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
            ...
            CASE(EQUATIONS_SET_1D3D_MONODOMAIN_ELASTICITY_SUBTYPE)
              IF(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD_AUTO_CREATED) THEN
                ...
                CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,1, &
                  & ERR,ERROR,*999)
...
999 CALL ERRORS("BIODOMAIN_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
  ...
  SUBROUTINE BIODOMAIN_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_TYPE_,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
...
999 CALL ERRORS("BIODOMAIN_EQUATION_PROBLEM_SETUP",ERR,ERROR)
  ...
  SUBROUTINE BIODOMAIN_EQUATION_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_EQUATION_TYPE,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    CALL ENTERS("BIODOMAIN_EQUATION_PROBLEM_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("BIODOMAIN_EQUATION_PROBLEM_SUBTYPE_SET")
    RETURN
999 CALL ERRORS("BIODOMAIN_EQUATION_PROBLEM_SUBTYPE_SET",ERR,ERROR)
    CALL EXITS("BIODOMAIN_EQUATION_PROBLEM_SUBTYPE_SET")
    RETURN 1
  ...
  SUBROUTINE BIODOMAIN_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    INTEGER(INTG) FIELD_VAR_TYPE,mh,mhs,ms,na,ng,nh,nhs,ni,nj,ns
    INTEGER(INTG) :: MESH_COMPONENT_1, MESH_COMPONENT_2
    LOGICAL :: USE_FIBRES
    REAL(DP) :: CONDUCTIVITY(3,3),DPHIDX(3,64),RWG,SUM
    TYPE(BASIS_TYPE), POINTER :: DEPENDENT_BASIS,GEOMETRIC_BASIS,FIBRE_BASIS,MATERIALS_BASIS
    TYPE(EQUATIONS_TYPE), POINTER :: EQUATIONS
    TYPE(EQUATIONS_MAPPING_TYPE), POINTER :: EQUATIONS_MAPPING
