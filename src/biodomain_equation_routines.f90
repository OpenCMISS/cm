...
MODULE BIODOMAIN_EQUATION_ROUTINES
  ...
  PUBLIC BIODOMAIN_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET
  
  PUBLIC BiodomainEquation_EquationsSetSpecificationSet
  ...
  PUBLIC BiodomainEquation_ProblemSpecificationSet
...
CONTAINS
  ...
  SUBROUTINE BIODOMAIN_CONTROL_LOOP_POST_LOOP(CONTROL_LOOP,ERR,ERROR,*)
    ...
    CALL EXITS("BIODOMAIN_CONTROL_LOOP_POST_LOOP")
    RETURN
999 CALL ERRORS("BIODOMAIN_CONTROL_LOOP_POST_LOOP",ERR,ERROR)
    CALL EXITS("BIODOMAIN_CONTROL_LOOP_POST_LOOP")
    RETURN 1
        ...
        CASE(EQUATIONS_SET_SETUP_START_ACTION)
          ...
          CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
            IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              IF(EQUATIONS_SET_SPEC_SUBTYPE==EQUATIONS_SET_NO_SUBTYPE) THEN
              ...
              ELSEIF(EQUATIONS_SET_SPEC_SUBTYPE==EQUATIONS_SET_1D3D_MONODOMAIN_ELASTICITY_SUBTYPE) THEN
              ...
              ELSEIF(EQUATIONS_SET_SPEC_SUBTYPE==EQUATIONS_SET_MONODOMAIN_ELASTICITY_W_TITIN_SUBTYPE) THEN
                ...
                CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE,3, &
                  & ERR,ERROR,*999)
              ELSE
                CALL FLAG_ERROR("Equations Set Subtype is not valid for a monodomain equation set.",ERR,ERROR,*999)
              ENDIF
            ...
            CASE(EQUATIONS_SET_1D3D_MONODOMAIN_ELASTICITY_SUBTYPE,EQUATIONS_SET_MONODOMAIN_ELASTICITY_W_TITIN_SUBTYPE)
              IF(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD_AUTO_CREATED) THEN
                ...
                CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD,FIELD_V_VARIABLE_TYPE,5, &
                  & ERR,ERROR,*999)
                CALL FIELD_NUMBER_OF_COMPONENTS_SET_AND_LOCK(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD,FIELD_U1_VARIABLE_TYPE,3, &
                  & ERR,ERROR,*999)
            ...
            IF(ASSOCIATED(EQUATIONS_SET%MATERIALS)) THEN
              IF(EQUATIONS_SET%MATERIALS%MATERIALS_FINISHED) THEN
                ...
                CASE(EQUATIONS_SET_BIDOMAIN_EQUATION_TYPE)
                  ...
                  CASE DEFAULT
                    LOCAL_ERROR="The equations set subtype of "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET_SPEC_SUBTYPE,"*", &
                      & ERR,ERROR))//" is invalid for a bidomain equation type."
                    CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
                  END SELECT
                CASE DEFAULT
                  LOCAL_ERROR="The equations set type of "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET_SPEC_TYPE,"*",ERR,ERROR))// &
...
999 CALL ERRORS("BIODOMAIN_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
  ...
  SUBROUTINE BiodomainEquation_EquationsSetSpecificationSet(equationsSet,specification,err,error,*)
    ...
    CALL Enters("BiodomainEquation_EquationsSetSpecificationSet",err,error,*999)
    ...
    IF(ASSOCIATED(equationsSet)) THEN
      ...
      CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
        ...
        CASE(EQUATIONS_SET_1D3D_MONODOMAIN_ELASTICITY_SUBTYPE, &
          ...
          !ok
        CASE DEFAULT
          localError="The specified equations set subtype of "//TRIM(NumberToVstring(equationsSetSubtype,"*",err,error))// &
      ...
      CASE(EQUATIONS_SET_BIDOMAIN_EQUATION_TYPE)
        ...
        END SELECT
      CASE DEFAULT
        localError="The equations set type "//TRIM(NumberToVstring(equationsSetType,"*",err,error))// &
    ...
    CALL Exits("BiodomainEquation_EquationsSetSpecificationSet")
    RETURN
999 CALL Errors("BiodomainEquation_EquationsSetSpecificationSet",err,error)
    CALL Exits("BiodomainEquation_EquationsSetSpecificationSet")
    RETURN 1
  END SUBROUTINE BiodomainEquation_EquationsSetSpecificationSet
  ...
  SUBROUTINE BIODOMAIN_PRE_SOLVE(SOLVER,ERR,ERROR,*)
    ...
    CALL ENTERS("BIODOMAIN_PRE_SOLVE",ERR,ERROR,*999)
    ...
    CALL EXITS("BIODOMAIN_PRE_SOLVE")
    RETURN
999 CALL ERRORS("BIODOMAIN_PRE_SOLVE",ERR,ERROR)
    CALL EXITS("BIODOMAIN_PRE_SOLVE")
    RETURN 1
...
999 CALL ERRORS("BIODOMAIN_EQUATION_PROBLEM_SETUP",ERR,ERROR)
  ...
  SUBROUTINE BiodomainEquation_ProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    CALL Enters("BiodomainEquation_ProblemSpecificationSet",err,error,*999)
    ...
    IF(ASSOCIATED(problem)) THEN
      IF(SIZE(problemSpecification,1)==3) THEN
        ...
        CASE(PROBLEM_BIDOMAIN_EQUATION_TYPE)
          ...
          END SELECT
        CASE DEFAULT
          localError="The problem type of "//TRIM(NumberToVstring(problemType,"*",err,error))// &
            & " is not valid for a bioelectric equations set class."
          CALL FlagError(localError,err,error,*999)
        END SELECT
    ...
    CALL Exits("BiodomainEquation_ProblemSpecificationSet")
    RETURN
999 CALL Errors("BiodomainEquation_ProblemSpecificationSet",err,error)
    CALL Exits("BiodomainEquation_ProblemSpecificationSet")
    RETURN 1
  END SUBROUTINE BiodomainEquation_ProblemSpecificationSet
