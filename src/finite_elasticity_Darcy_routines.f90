      ...
      IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
        ...
        SELECT CASE(CONTROL_LOOP%LOOP_TYPE)
          ...
          CASE(PROBLEM_CONTROL_WHILE_LOOP_TYPE)
            ...
            !Subiteration work not yet committed
    ...
    IF(ASSOCIATED(CONTROL_LOOP)) THEN
      IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN 
        ...
        CASE(PROBLEM_CONTROL_TIME_LOOP_TYPE)
          ...
          !Update (recursively) dependent field with solution
          !Subroutine not committed yet
        ...
        CASE(PROBLEM_CONTROL_WHILE_LOOP_TYPE)
          ...
          CASE(PROBLEM_QUASISTATIC_ELASTICITY_TRANSIENT_DARCY_SUBTYPE)
            ...
            !CALL DARCY_EQUATION_ACCELERATE_CONVERGENCE(CONTROL_LOOP,SOLVER,ERR,ERROR,*999)
          CASE DEFAULT
            LOCAL_ERROR="Problem subtype "//TRIM(NUMBER_TO_VSTRING(CONTROL_LOOP%PROBLEM%SUBTYPE,"*",ERR,ERROR))// &
