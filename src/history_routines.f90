...
CONTAINS
  ...
  SUBROUTINE HISTORY_CLOSE(HISTORY,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_CLOSE",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_CLOSE")
    RETURN
999 CALL ERRORS("HISTORY_CLOSE",ERR,ERROR)
    CALL EXITS("HISTORY_CLOSE")
    RETURN 1
  ...
  SUBROUTINE HISTORY_CREATE_FINISH(HISTORY,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_CREATE_FINISH",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_CREATE_FINISH")
    RETURN
999 CALL ERRORS("HISTORY_CREATE_FINISH",ERR,ERROR)
    CALL EXITS("HISTORY_CREATE_START")
    RETURN 1
  ...
  SUBROUTINE HISTORY_CREATE_START(CONTROL_LOOP,HISTORY,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_CREATE_START",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_CREATE_START")
    RETURN
999 CALL ERRORS("HISTORY_CREATE_START",ERR,ERROR)
    CALL EXITS("HISTORY_CREATE_START")
    RETURN 1    
  ...
  SUBROUTINE HISTORY_DESTROY(HISTORY,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_DESTROY",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_DESTROY")
    RETURN
999 CALL ERRORS("HISTORY_DESTROY",ERR,ERROR)
    CALL EXITS("HISTORY_DESTROY")
    RETURN 1
  ...
  SUBROUTINE HISTORY_FINALISE(HISTORY,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_FINALISE",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_FINALISE")
    RETURN
999 CALL ERRORS("HISTORY_FINALISE",ERR,ERROR)
    CALL EXITS("HISTORY_FINALISE")
    RETURN 1
  ...
  SUBROUTINE HISTORY_INITIALISE(CONTROL_LOOP,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_INITIALISE",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_INITIALISE")
    RETURN
999 CALL ERRORS("HISTORY_INITIALISE",ERR,ERROR)
    CALL EXITS("HISTORY_INITIALISE")
    RETURN 1
  ...
  SUBROUTINE HISTORY_FILE_FORMAT_SET(HISTORY,FILE_FORMAT,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_FILE_FORMAT_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_FILE_FORMAT_SET")
    RETURN
999 CALL ERRORS("HISTORY_FILE_FORMAT_SET",ERR,ERROR)
    CALL EXITS("HISTORY_FILE_FORMAT_SET")
    RETURN 1
  ...
  SUBROUTINE HISTORY_FILENAME_SET_C(HISTORY,FILENAME,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_FILENAME_SET_C",ERR,ERROR,*999)
...
!!TODO: Check filename???
    ...
    CALL EXITS("HISTORY_FILENAME_SET_C")
    RETURN
999 CALL ERRORS("HISTORY_FILENAME_SET_C",ERR,ERROR)
    CALL EXITS("HISTORY_FILENAME_SET_C")
    RETURN 1
  ...
  SUBROUTINE HISTORY_FILENAME_SET_VS(HISTORY,FILENAME,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_FILENAME_SET_VS",ERR,ERROR,*999)
...
!!TODO: Check filename???
    ...
    CALL EXITS("HISTORY_FILENAME_SET_VS")
    RETURN
999 CALL ERRORS("HISTORY_FILENAME_SET_VS",ERR,ERROR)
    CALL EXITS("HISTORY_FILENAME_SET_VS")
    RETURN 1
  ...
  SUBROUTINE HISTORY_OPEN(HISTORY,ERR,ERROR,*)
    ...
    CALL ENTERS("HISTORY_OPEN",ERR,ERROR,*999)
    ...
    CALL EXITS("HISTORY_OPEN")
    RETURN
999 CALL ERRORS("HISTORY_OPEN",ERR,ERROR)
    CALL EXITS("HISTORY_OPEN")
    RETURN 1
