          ...
          CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
            ...
            CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
              ...
              IF(ASSOCIATED(EQUATIONS)) THEN
                ...
                CALL EQUATIONS_MATRICES_CREATE_START(EQUATIONS_MAPPING,EQUATIONS_MATRICES,ERR,ERROR,*999)
        ...
        CASE(PROBLEM_SETUP_SOLUTION_TYPE)
          ...
          IF(ASSOCIATED(SOLUTION)) THEN
            ...
            CASE(PROBLEM_SETUP_START_ACTION)
              ...
              CALL SOLUTION_MAPPING_EQUATIONS_TO_SOLVER_VARIABLES_SET(SOLUTION_MAPPING,1,1,(/FIELD_STANDARD_VARIABLE_TYPE/), &
                & ERR,ERROR,*999)
           CASE(PROBLEM_SETUP_FINISH_ACTION)
          ...
          IF(ASSOCIATED(SOLUTION)) THEN
            ...
            CASE(PROBLEM_SETUP_FINISH_ACTION)
              ...
              IF(ASSOCIATED(SOLVER)) THEN
                !!TODO: move the sparsity to the solver from the solutions
