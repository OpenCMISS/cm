...
CONTAINS
  ...
  SUBROUTINE LAPLACE_EQUATION_ANALYTIC_CALCULATE(EQUATIONS_SET,ERR,ERROR,*)
...
!!TODO: Think about symmetric problems. 
            ...
            K_VALUE(1)=EQUATIONS%INTERPOLATION%INDEPENDENT_INTERP_POINT%VALUES(1,NO_PART_DERIV)
            K_VALUE(2)=EQUATIONS%INTERPOLATION%INDEPENDENT_INTERP_POINT%VALUES(2,NO_PART_DERIV)
            IF(FIELD_VARIABLE%NUMBER_OF_COMPONENTS==3) THEN
              K_VALUE(3)=EQUATIONS%INTERPOLATION%INDEPENDENT_INTERP_POINT%VALUES(3,NO_PART_DERIV)
            END IF 
  ...
  SUBROUTINE LAPLACE_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_MOVING_MESH_LAPLACE_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_CLASSICAL_FIELD_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_LAPLACE_EQUATION_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_MOVING_MESH_LAPLACE_SUBTYPE
      CASE(EQUATIONS_SET_GENERALISED_LAPLACE_SUBTYPE)
        CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
      CASE DEFAULT
