...
!!MERGE: move
  ...
  PUBLIC LAPLACE_EQUATION_FINITE_ELEMENT_CALCULATE,LAPLACE_EQUATION_EQUATIONS_SET_SETUP,LAPLACE_EQUATION_ANALYTIC_CALCULATE, &
    ...
    & LAPLACE_EQUATION_PROBLEM_SUBTYPE_SET,LAPLACE_EQUATION_PROBLEM_SETUP,FINITE_ELEMENT_CALCULATE_DNUDXI
...
999 CALL ERRORS("LAPLACE_EQUATION_PROBLEM_GENERALISED_SETUP",ERR,ERROR)
  ...
  SUBROUTINE FINITE_ELEMENT_CALCULATE_DNUDXI(GEOMETRIC_INTERPOLATED_POINT,FIBRE_INTERPOLATED_POINT,&
  ...
  CALL ENTERS("FINITE_ELEMENT_CALCULATE_DNUDXI",ERR,ERROR,*999)
  ...
  CALL EXITS("FINITE_ELEMENT_CALCULATE_DNUDXI")
    RETURN
999 CALL ERRORS("FINITE_ELEMENT_CALCULATE_DNUDXI",ERR,ERROR)
    CALL EXITS("FINITE_ELEMENT_CALCULATE_DNUDXI")
    RETURN 1
  
  END SUBROUTINE FINITE_ELEMENT_CALCULATE_DNUDXI
