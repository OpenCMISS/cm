...
!       TYPE(SOLVER_TYPE), POINTER :: ctx
...
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 2 )
  PUBLIC PETSC_PCGASM,PETSC_PCPARMS,PETSC_PCTFS !,PETSC_PCPROMETHEUS,PETSC_PCASA,PETSC_PCHMPI
  PUBLIC PETSC_PCGALERKIN,PETSC_PCEXOTIC, &
  ...
  PUBLIC PETSC_MATINITIALISE,PETSC_MATFINALISE,PETSC_MATASSEMBLYBEGIN,PETSC_MATASSEMBLYEND,PETSC_MATCREATE, &
    ...
    & PETSC_MATFDCOLORINGSETPARAMETERS,PETSC_MATGETINFO,PETSC_MATGETOWNERSHIPRANGE,PETSC_MATGETROW,PETSC_MATGETVALUES, &
    & PETSC_MATRESTOREROW,PETSC_MATSETLOCALTOGLOBALMAPPING,PETSC_MATSETOPTION,PETSC_MATSETSIZES,PETSC_MATSETVALUE, &
  ...
  PUBLIC PETSC_MATCOLORINGAPPLY,PETSC_MATCOLORINGCREATE,PETSC_MATCOLORINGDESTROY,PETSC_MATCOLORINGFINALISE, &
    & PETSC_MATCOLORINGINITIALISE,PETSC_MATCOLORINGSETFROMOPTIONS,PETSC_MATCOLORINGSETTYPE,PETSC_MATFDCOLORINGSETUP
#else
  PUBLIC PETSC_MATGETCOLORING
#endif
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 4 )
  PUBLIC PETSC_MATDENSEGETARRAY,PETSC_MATSEQAIJGETARRAY,PETSC_MATDENSEGETARRAYF90,PETSC_MATSEQAIJGETARRAYF90, &
    & PETSC_MATDENSERESTOREARRAY,PETSC_MATSEQAIJRESTOREARRAY,PETSC_MATDENSERESTOREARRAYF90, &
    & PETSC_MATSEQAIJRESTOREARRAYF90
#else
  PUBLIC PETSC_MATGETARRAY,PETSC_MATGETARRAYF90,PETSC_MATRESTOREARRAY,PETSC_MATRESTOREARRAYF90
#endif
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 3 )
  ...
  PUBLIC PETSC_SNESFINALISE,PETSC_SNESINITIALISE,PETSC_SNESCREATE,PETSC_SNESDESTROY,PETSC_SNESGETCONVERGEDREASON, &
    & petsc_sneslinesearchsetnorms,petsc_sneslinesearchgetnorms,PETSC_SNESGETITERATIONNUMBER,PETSC_SNESGETKSP, &
    & PETSC_SNESMONITORSET,PETSC_SNESSETFROMOPTIONS,PETSC_SNESGETFUNCTION,PETSC_SNESSETFUNCTION,PETSC_SNESSETJACOBIAN, &
    & PETSC_SNESSETTOLERANCES,PETSC_SNESSETTRUSTREGIONTOLERANCE,PETSC_SNESSETTYPE,PETSC_SNESSOLVE,PETSC_SNESSETKSP, & 
    & PETSC_SNESGETJACOBIAN,PETSC_SNESSETCONVERGENCETEST,Petsc_SnesLineSearchGetVecs,Petsc_SnesGetSolutionUpdate
#if ( PETSC_VERSION_MAJOR <= 3 && PETSC_VERSION_MINOR < 5 )
  PUBLIC PETSC_SNESGETFUNCTIONNORM,PETSC_SNESSETFUNCTIONNORM
#endif
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 5 )
...
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 4 )
  PUBLIC PETSC_SNESCOMPUTEJACOBIANDEFAULTCOLOR,PETSC_SNESCOMPUTEJACOBIANDEFAULT
#else
  PUBLIC PETSC_SNESDEFAULTCOMPUTEJACOBIANCOLOR,PETSC_SNESDEFAULTCOMPUTEJACOBIAN 
#endif
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 2 )
...
999 CALL ERRORS("PETSC_INITIALIZE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_ISFINALISE(IS_,ERR,ERROR,*)
    ...
    IF(IS_%IS_/=PETSC_NULL_OBJECT) THEN
...
999 CALL ERRORS("PETSC_KSPGETRESIDUALNORM",ERR,ERROR)
  ...
  SUBROUTINE PETSC_KSPFINALISE(KSP_,ERR,ERROR,*)
    ...
    IF(KSP_%KSP_/=PETSC_NULL_OBJECT) THEN
...
999 CALL ERRORS("PETSC_MATFDCOLORINGSETFUNCTIONSNES",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATFDCOLORINGSETUP(A,ISCOLORING,FDCOLORING,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_MAT_TYPE), INTENT(INOUT) :: A !<The PETSc matrix containing the nonzero structure of the Jacobian 
    TYPE(PETSC_ISCOLORING_TYPE), INTENT(INOUT) :: ISCOLORING !<The index set coloring of the matrix
    TYPE(PETSC_MATFDCOLORING_TYPE), INTENT(INOUT) :: FDCOLORING !<The matrix coloring context
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    ...
    CALL MatFDColoringSetUp(A%MAT,ISCOLORING%ISCOLORING,FDCOLORING%MATFDCOLORING,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatFDColoringSetUp",ERR,ERROR,*999)
    ENDIF
...
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 4 )
  !>Buffer routine to the PETSc MatDenseGetArray routine.
  SUBROUTINE PETSC_MATDENSEGETARRAY(A,ARRAY,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_MATDENSEGETARRAY",ERR,ERROR,*999)
#endif

    IF(ASSOCIATED(ARRAY)) THEN
      CALL FLAG_ERROR("Array is already associated",ERR,ERROR,*999)
    ELSE
      CALL FLAG_ERROR("PETSC_MATDENSEGETARRAY not implemented",ERR,ERROR,*999)
      !CALL MatDenseGetArray(A%MAT,A%MAT_DATA,A%MAT_OFFSET,ERR)
      !IF(ERR/=0) THEN
      !  IF(PETSC_HANDLE_ERROR) THEN
      !    CHKERRQ(ERR)
      !  ENDIF
      !  CALL FLAG_ERROR("PETSc error in MatDenseGetArray",ERR,ERROR,*999)
      !ENDIF
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATDENSEGETARRAY")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATDENSEGETARRAY",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATDENSEGETARRAY")
#endif
    RETURN 1
  END SUBROUTINE PETSC_MATDENSEGETARRAY
    
  !
  !================================================================================================================================
  !

  !>Buffer routine to the PETSc MatSeqAIJGetArray routine.
  SUBROUTINE PETSC_MATSEQAIJGETARRAY(A,ARRAY,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_MATSEQAIJGETARRAY",ERR,ERROR,*999)
#endif

    IF(ASSOCIATED(ARRAY)) THEN
      CALL FLAG_ERROR("Array is already associated",ERR,ERROR,*999)
    ELSE
      CALL FLAG_ERROR("PETSC_MATSEQAIJGETARRAY not implemented",ERR,ERROR,*999)
      !CALL MatSeqAIJGetArray(A%MAT,A%MAT_DATA,A%MAT_OFFSET,ERR)
      !IF(ERR/=0) THEN
      !  IF(PETSC_HANDLE_ERROR) THEN
      !    CHKERRQ(ERR)
      !  ENDIF
      !  CALL FLAG_ERROR("PETSc error in MatSeqAIJGetArray",ERR,ERROR,*999)
      !ENDIF
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJGETARRAY")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATSEQAIJGETARRAY",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJGETARRAY")
#endif
    RETURN 1
  END SUBROUTINE PETSC_MATSEQAIJGETARRAY
...
#if DEBUG
    CALL ENTERS("PETSC_MATDENSEGETARRAYF90",ERR,ERROR,*999)
#endif
    ...
    ELSE
      ...
      IF(ERR/=0) THEN
        IF(PETSC_HANDLE_ERROR) THEN
          CHKERRQ(ERR)
        ENDIF
        CALL FLAG_ERROR("PETSc error in MatDenseGetArrayF90",ERR,ERROR,*999)
      ENDIF
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATDENSEGETARRAYF90")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATDENSEGETARRAYF90",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATDENSEGETARRAYF90")
#endif
    RETURN 1
...
#if DEBUG
    CALL ENTERS("PETSC_MATSEQAIJGETARRAYF90",ERR,ERROR,*999)
#endif
    ...
    ELSE
      ...
      IF(ERR/=0) THEN
        IF(PETSC_HANDLE_ERROR) THEN
          CHKERRQ(ERR)
        ENDIF
        CALL FLAG_ERROR("PETSc error in MatSeqAIJGetArrayF90",ERR,ERROR,*999)
      ENDIF
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJGETARRAYF90")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATSEQAIJGETARRAYF90",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJGETARRAYF90")
#endif
    RETURN 1
...
999 CALL ERRORS("PETSC_MATGETARRAYF90",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATCOLORINGAPPLY(COLORING,ISCOLORING,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_MATCOLORING_TYPE), INTENT(INOUT) :: COLORING !<The matrix coloring to set
    TYPE(PETSC_ISCOLORING_TYPE), INTENT(INOUT) :: ISCOLORING !<The index set coloring
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
...
#if DEBUG
    CALL ENTERS("PETSC_MATCOLORINGAPPLY",ERR,ERROR,*999)
#endif

    CALL MatColoringApply(COLORING%MATCOLORING,ISCOLORING%ISCOLORING,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatColoringApply",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGAPPLY")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATCOLORINGAPPLY",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGAPPLY")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_MATCOLORINGCREATE(A,COLORING,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_MAT_TYPE), INTENT(IN) :: A !<The PETSc matrix to create the FD coloring for
    TYPE(PETSC_MATCOLORING_TYPE), INTENT(OUT) :: COLORING !<On exit, the matrix coloring
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables

#if DEBUG
    CALL ENTERS("PETSC_MATCOLORINGCREATE",ERR,ERROR,*999)
#endif

    CALL MatColoringCreate(A%MAT,COLORING%MATCOLORING,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatColoringCreate",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGCREATE")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATCOLORINGCREATE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGCREATE")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_MATCOLORINGDESTROY(COLORING,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_MATCOLORING_TYPE), INTENT(INOUT) :: COLORING !<The matrix coloring to destroy
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables

#if DEBUG
    CALL ENTERS("PETSC_MATCOLORINGDESTROY",ERR,ERROR,*999)
#endif

    CALL MatColoringDestroy(COLORING%MATCOLORING,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatColoringDestroy",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGDESTROY")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATCOLORINGDESTROY",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGDESTROY")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_MATCOLORINGFINALISE(COLORING,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_MATCOLORING_TYPE), INTENT(INOUT) :: COLORING !<The MatColoring to finalise
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables

#if DEBUG
    CALL ENTERS("PETSC_MATCOLORINGFINALISE",ERR,ERROR,*999)
#endif

    IF(COLORING%MATCOLORING/=PETSC_NULL_OBJECT) THEN
      CALL PETSC_MATCOLORINGDESTROY(COLORING,ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGFINALISE")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATCOLORINGFINALISE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGFINALISE")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_MATCOLORINGINITIALISE(COLORING,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_MATCOLORING_TYPE), INTENT(INOUT) :: COLORING !<The MatColoring to initialise
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables

#if DEBUG
    CALL ENTERS("PETSC_MATCOLORINGINITIALISE",ERR,ERROR,*999)
#endif

    COLORING%MATCOLORING=PETSC_NULL_OBJECT
    
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGINITIALISE")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATCOLORINGINITIALISE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGINITIALISE")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_MATCOLORINGSETFROMOPTIONS(COLORING,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_MATCOLORING_TYPE), INTENT(INOUT) :: COLORING !<The matrix coloring to set from the command line options
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables

#if DEBUG
    CALL ENTERS("PETSC_MATCOLORINGSETFROMOPTIONS",ERR,ERROR,*999)
#endif

    CALL MatColoringSetFromOptions(COLORING%MATCOLORING,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatColoringSetFromOptions",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGSETFROMOPTIONS")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATCOLORINGSETFROMOPTIONS",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGSETFROMOPTIONS")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_MATCOLORINGSETTYPE(COLORING,COLORING_TYPE,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_MATCOLORINGSETTYPE",ERR,ERROR,*999)
#endif

    CALL MatColoringSetType(COLORING%MATCOLORING,COLORING_TYPE,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatColoringSetType",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGSETTYPE")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATCOLORINGSETTYPE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATCOLORINGSETTYPE")
#endif
    RETURN 1
...
#if DEBUG
    CALL ENTERS("PETSC_MATDENSERESTOREARRAY",ERR,ERROR,*999)
#endif

    CALL FLAG_ERROR("PETSC_MATDENSERESTOREARRAY not implemented",ERR,ERROR,*999)
    !CALL MatDenseRestoreArray(A%MAT,A%MAT_DATA,A%MAT_OFFSET,ERR)
    !IF(ERR/=0) THEN
    !  IF(PETSC_HANDLE_ERROR) THEN
    !    CHKERRQ(ERR)
    !  ENDIF
    !  CALL FLAG_ERROR("PETSc error in MatDenseRestoreArray",ERR,ERROR,*999)
    !ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATDENSERESTOREARRAY")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATDENSERESTOREARRAY",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATDENSERESTOREARRAY")
#endif
    RETURN 1
  END SUBROUTINE PETSC_MATDENSERESTOREARRAY
    
  !
  !================================================================================================================================
  !

  !>Buffer routine to the PETSc MatSeqAIJRestoreArray routine.
  SUBROUTINE PETSC_MATSEQAIJRESTOREARRAY(A,ARRAY,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_MATSEQAIJRESTOREARRAY",ERR,ERROR,*999)
#endif

    CALL FLAG_ERROR("PETSC_MATSEQAIJRESTOREARRAY not implemented",ERR,ERROR,*999)
    !CALL MatSeqAIJRestoreArray(A%MAT,A%MAT_DATA,A%MAT_OFFSET,ERR)
    !IF(ERR/=0) THEN
    !  IF(PETSC_HANDLE_ERROR) THEN
    !    CHKERRQ(ERR)
    !  ENDIF
    !  CALL FLAG_ERROR("PETSc error in MatSeqAIJRestoreArray",ERR,ERROR,*999)
    !ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJRESTOREARRAY")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATSEQAIJRESTOREARRAY",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJRESTOREARRAY")
#endif
    RETURN 1
  END SUBROUTINE PETSC_MATSEQAIJRESTOREARRAY
  ...
  SUBROUTINE PETSC_MATDENSERESTOREARRAYF90(A,ARRAY,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_MATDENSERESTOREARRAYF90",ERR,ERROR,*999)
#endif
    ...
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatDenseRestoreArrayF90",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATDENSERESTOREARRAYF90")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATDENSERESTOREARRAYF90",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATDENSERESTOREARRAYF90")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_MATSEQAIJRESTOREARRAYF90(A,ARRAY,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_MATSEQAIJRESTOREARRAYF90",ERR,ERROR,*999)
#endif
    ...
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in MatSeqAIJRestoreArrayF90",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJRESTOREARRAYF90")
#endif
    RETURN
999 CALL ERRORS("PETSC_MATSEQAIJRESTOREARRAYF90",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_MATSEQAIJRESTOREARRAYF90")
#endif
    RETURN 1
...
999 CALL ERRORS("PETSC_MATZEROENTRIES",ERR,ERROR)
  ...
  SUBROUTINE PETSC_PCFINALISE(PC_,ERR,ERROR,*)
    ...
    IF(PC_%PC_/=PETSC_NULL_OBJECT) THEN
...
999 CALL ERRORS("Petsc_MatMumpsSetCntl",err,error)
  ...
  SUBROUTINE PETSC_PCSETREUSEPRECONDITIONER(PC_,FLAG,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_PCSETREUSEPRECONDITIONER",ERR,ERROR,*999)
#endif

    CALL PCSetReusePreconditioner(PC_%PC_,FLAG,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in PCSetReusePreconditioner",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_PCSETREUSEPRECONDITIONER")
#endif
    RETURN
999 CALL ERRORS("PETSC_PCSETREUSEPRECONDITIONER",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_PCSETREUSEPRECONDITIONER")
#endif
    RETURN 1
...
999 CALL ERRORS("PETSC_PCSETTYPE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESFINALISE(SNES_,ERR,ERROR,*)
    ...
    IF(SNES_%SNES_/=PETSC_NULL_OBJECT) THEN
...
999 CALL Errors("Petsc_SnesGetSnesLineSearch",err,error)
  ...
  SUBROUTINE Petsc_SnesGetLineSearch(snes_,lineSearch,err,error,*)
    ...
    CALL Enters("Petsc_SnesGetLineSearch",err,error,*999)
    ...
    CALL Exits("Petsc_SnesGetLineSearch")
    RETURN
999 CALL Errors("Petsc_SnesGetLineSearch",err,error)
    CALL Exits("Petsc_SnesGetLineSearch")
    RETURN 1
...
#if DEBUG
    CALL ENTERS("PETSC_SNESQNSETTYPE",ERR,ERROR,*999)
#endif

    CALL SNESQNSetType(SNES_%SNES_,QTYPE,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in SNESQNSetType",ERR,ERROR,*999)
    ENDIF
...
#endif
    RETURN
999 CALL ERRORS("PETSC_SNESQNSETTYPE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_SNESQNSETTYPE")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_SNESQNSETRESTARTTYPE(SNES_,RTYPE,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_SNESQNSETRESTARTTYPE",ERR,ERROR,*999)
#endif

    CALL SNESQNSetRestartType(SNES_%SNES_,RTYPE,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in SNESQNSetRestartType",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_SNESQNSETRESTARTTYPE")
#endif
    RETURN
999 CALL ERRORS("PETSC_SNESQNSETRESTARTTYPE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_SNESQNSETRESTARTTYPE")
#endif
    RETURN 1
  ...
  SUBROUTINE PETSC_SNESQNSETSCALETYPE(SNES_,STYPE,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_SNESQNSETSCALETYPE",ERR,ERROR,*999)
#endif

    CALL SNESQNSetScaleType(SNES_%SNES_,STYPE,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in SNESQNSetScaleType",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_SNESQNSETSCALETYPE")
#endif
    RETURN
999 CALL ERRORS("PETSC_SNESQNSETSCALETYPE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_SNESQNSETSCALETYPE")
#endif
    RETURN 1
...
999 CALL ERRORS("PETSC_SNESSETFROMOPTIONS",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESGETFUNCTION(SNES_,F,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_SNES_TYPE), INTENT(INOUT) :: SNES_ !<The SNES to get the function from
    TYPE(PETSC_VEC_TYPE), INTENT(OUT) :: F !<The residual vector
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables

#if DEBUG
    CALL ENTERS("PETSC_SNESGETFUNCTION",ERR,ERROR,*999)
#endif

    CALL SNESGetFunction(SNES_%SNES_,F%VEC,PETSC_NULL_FUNCTION,PETSC_NULL_INTEGER,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in SNESGetFunction",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_SNESGETFUNCTION")
#endif
    RETURN
999 CALL ERRORS("PETSC_SNESGETFUNCTION",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_SNESGETFUNCTION")
#endif
    RETURN 1
...
#if DEBUG
    CALL ENTERS("PETSC_SNESGETJACOBIAN_SPECIAL",ERR,ERROR,*999)
#endif
...
999 CALL ERRORS("PETSC_SNESSETJACOBIAN_SOLVER",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESCOMPUTEJACOBIANDEFAULTCOLOR(SNES_,X,J,B,CTX,ERR,ERROR,*)
    ...
    CALL SNESComputeJacobianDefaultColor(SNES_%SNES_,X%VEC,J%MAT,B%MAT,CTX,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
...
999 CALL ERRORS("PETSC_SNESDEFAULTCOMPUTEJACOBIANCOLOR",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESCOMPUTEJACOBIANDEFAULT(SNES_,X,J,B,CTX,ERR,ERROR,*)
    ...
    CALL SNESComputeJacobianDefault(SNES_%SNES_,X%VEC,J%MAT,B%MAT,CTX,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
    ...
    RETURN
999 CALL ERRORS("PETSC_SNESCOMPUTEJACOBIANDEFAULT",ERR,ERROR)
    RETURN
...
#elif ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 4 )
  !>Buffer routine to the PETSc SNESComputeJacobianColor routine for solver contexts.
  SUBROUTINE PETSC_SNESCOMPUTEJACOBIANDEFAULTCOLOR(SNES_,X,J,B,FLAG,CTX,ERR,ERROR,*)
...
999 CALL ERRORS("PETSC_SNESDEFAULTCOMPUTEJACOBIANCOLOR",ERR,ERROR)
  ...
  !>Buffer routine to the PETSc SNESComputeJacobian routine for solver contexts.
  SUBROUTINE PETSC_SNESCOMPUTEJACOBIANDEFAULT(SNES_,X,J,B,FLAG,CTX,ERR,ERROR,*)
...
999 CALL ERRORS("Petsc_SnesLineSearchGetVecs",err,error)
  ...
  SUBROUTINE PETSC_SNESSETNORMSCHEDULE(SNES_,NORMSCHEDULE,ERR,ERROR,*)
...
#if DEBUG
    CALL ENTERS("PETSC_SNESSETNORMSCHEDULE",ERR,ERROR,*999)
#endif

    CALL SNESSetNormSchedule(SNES_%SNES_,NORMSCHEDULE,ERR)
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
      ENDIF
      CALL FLAG_ERROR("PETSc error in SNESSetNormSchedule",ERR,ERROR,*999)
    ENDIF
    
#if DEBUG
    CALL EXITS("PETSC_SNESSETNORMSCHEDULE")
#endif
    RETURN
999 CALL ERRORS("PETSC_SNESSETNORMSCHEDULE",ERR,ERROR)
#if DEBUG
    CALL EXITS("PETSC_SNESSETNORMSCHEDULE")
#endif
    RETURN 1
...
999 CALL ERRORS("PETSC_SNESSOLVE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_TSFINALISE(TS_,ERR,ERROR,*)
    ...
    IF(TS_%TS_/=PETSC_NULL_OBJECT) THEN
...
999 CALL ERRORS("Petsc_VecDot",err,error)
  ...
  SUBROUTINE PETSC_VECNORM(X,NORM_TYPE,VEC_NORM,ERR,ERROR,*)

    !Argument Variables
    TYPE(PETSC_VEC_TYPE), INTENT(IN) :: X !<The vector X
    NormType, INTENT(IN) :: NORM_TYPE !<The norm type
    REAL(DP), INTENT(OUT) :: VEC_NORM !<On exit, the vector norm
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    ...
    CALL VecNorm(X%VEC,NORM_TYPE,VEC_NORM,ERR)
