...
999 CALL ERRORS("PETSC_INITIALIZE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_ISFINALISE(is,ERR,ERROR,*)
    ...
    IF(is%is/=PETSC_NULL_INTEGER) THEN
...
999 CALL ERRORS("PETSC_KSPGETRESIDUALNORM",ERR,ERROR)
  ...
  SUBROUTINE PETSC_KSPFINALISE(ksp,ERR,ERROR,*)
    ...
    IF(ksp%ksp/=PETSC_NULL_INTEGER) THEN
...
999 CALL ERRORS("PETSC_KSPSETOPERATORS",ERR,ERROR)
  ...
  SUBROUTINE PETSc_KSPSetReusePreconditioner(ksp,flag,err,error,*)
    ...
    CALL Enters("PETSc_KSPSetReusePreconditioner",err,error,*999)
    ...
    CALL Exits("PETSc_KSPSetReusePreconditioner")
    RETURN
999 CALL Errors("PETSc_KSPSetReusePreconditioner",err,error)
    CALL Exits("PETSc_KSPSetReusePreconditioner")
    RETURN 1
...
999 CALL ERRORS("Petsc_MatColoringDestroy",err,error)
  ...
  SUBROUTINE Petsc_MatColoringFinalise(matColoring,err,error,*)
    ...
    IF(matColoring%matColoring/=PETSC_NULL_INTEGER) THEN
...
999 CALL ERRORS("Petsc_MatColoringFinalise",err,error)
  ...
  SUBROUTINE Petsc_MatColoringInitialise(matColoring,err,error,*)
    ...
    matColoring%matColoring=PETSC_NULL_INTEGER
...
999 CALL ERRORS("PETSC_MATGETARRAYF90",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATGETCOLORING(A,COLORING_TYPE,iscoloring,ERR,ERROR,*)
    ...
    TYPE(PetscISColoringType), INTENT(OUT) :: iscoloring !<On exit, the index set coloring
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
#if ( PETSC_VERSION_GE(3,5,0)
...
999 CALL ERRORS("PETSC_MATFINALISE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATINITIALISE(MAT_,ERR,ERROR,*)
    ...
    !Argument Variables
    TYPE(PetscMatType), INTENT(INOUT) :: MAT_ !<The MAT to initialise
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
...
999 CALL ERRORS("PETSC_MATZEROENTRIES",ERR,ERROR)
  ...
  SUBROUTINE PETSC_PCFINALISE(pc,ERR,ERROR,*)
    ...
    IF(pc%pc/=PETSC_NULL_INTEGER) THEN
...
999 CALL ERRORS("PETSC_PCSETTYPE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESFINALISE(snes,ERR,ERROR,*)
    ...
    IF(snes%snes/=PETSC_NULL_INTEGER) THEN
...
999 CALL ERRORS("PETSC_SNESGETCONVERGEDREASON",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESGETFUNCTIONNORM(snes,FUNCTION_NORM,ERR,ERROR,*)
...
#if ( PETSC_VERSION_GE(3,5,0) )
    CALL SNESGetFunction(snes%snes,FUNCTION_NORM,ERR)
    CALL VecNorm(snes%snes,FUNCTION_NORM,ERR)
#else
    CALL SNESGetFunctionNorm(snes%snes,FUNCTION_NORM,ERR)
#endif
    IF(ERR/=0) THEN
      IF(PETSC_HANDLE_ERROR) THEN
        CHKERRQ(ERR)
...
999 CALL ERRORS("PETSC_SNESSOLVE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_TSFINALISE(ts,ERR,ERROR,*)
    ...
    IF(ts%ts/=PETSC_NULL_INTEGER) THEN
