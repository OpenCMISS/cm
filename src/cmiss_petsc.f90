...
#include "include/finclude/petscviewer.h"
  ...
  PUBLIC PETSC_KSPCREATE,PETSC_KSPDESTROY,PETSC_KSPGETITERATIONNUMBER,PETSC_KSPGETPC,PETSC_KSPFINALISE,PETSC_KSPINITIALISE, &
    & PETSC_KSPSETFROMOPTIONS,PETSC_KSPSETTYPE,PETSC_KSPSETUP,PETSC_KSPSETTOLERANCES,PETSC_KSPSOLVE
  ...
  PUBLIC PETSC_MATINITIALISE,PETSC_MATFINALISE,PETSC_MATASSEMBLYBEGIN,PETSC_MATASSEMBLYEND,PETSC_MATCREATE, &
    ...
    & PETSC_MATSETOPTION,PETSC_MATSETSIZES,PETSC_MATSETVALUES,PETSC_MATSETVALUESLOCAL,PETSC_MATVIEW,PETSC_MATZEROENTRIES
