...
MODULE CMISS_PETSC
  ...
  USE BASE_ROUTINES
  USE CMISS_PETSC_TYPES, ONLY : PETSC_IS_TYPE,PETSC_ISLOCALTOGLOBALMAPPING_TYPE,PETSC_ISCOLORING_TYPE,PETSC_KSP_TYPE, &
    & PETSC_MAT_TYPE,PETSC_MATFDCOLORING_TYPE,PETSC_PC_TYPE,PETSC_SNES_TYPE,PETSC_VEC_TYPE
  USE KINDS
