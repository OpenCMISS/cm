...
!       TYPE(SOLVER_TYPE), POINTER :: ctx
...
#if ( PETSC_VERSION_MAJOR >= 3 && PETSC_VERSION_MINOR >= 2 )
  PUBLIC PETSC_PCGASM,PETSC_PCPARMS,PETSC_PCTFS !,PETSC_PCPROMETHEUS
  PUBLIC PETSC_PCGALERKIN,PETSC_PCEXOTIC,PETSC_PCHMPI, &
  ...
  PUBLIC PETSC_MATINITIALISE,PETSC_MATFINALISE,PETSC_MATASSEMBLYBEGIN,PETSC_MATASSEMBLYEND,PETSC_MATCREATE, &
    ...
    & PETSC_MATGETCOLORING,PETSC_MATGETINFO,PETSC_MATGETOWNERSHIPRANGE, &
  ...
  PUBLIC PETSC_SNESFINALISE,PETSC_SNESINITIALISE,PETSC_SNESCREATE,PETSC_SNESDESTROY,PETSC_SNESGETCONVERGEDREASON, &
    ...
    & PETSC_SNESSETKSP,PETSC_SNESGETJACOBIAN,PETSC_SNESSETCONVERGENCETEST,Petsc_SnesLineSearchGetVecs,PETSC_SNESSETNORMTYPE, &
