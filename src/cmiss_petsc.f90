...
999 ERRORSEXITS("PETSC_MATFDCOLORINGSETUP",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATDENSEGETARRAY(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATDENSEGETARRAY",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATDENSEGETARRAY")
    RETURN
999 ERRORSEXITS("PETSC_MATDENSEGETARRAY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE PETSC_MATSEQAIJGETARRAY(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATSEQAIJGETARRAY",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATSEQAIJGETARRAY")
    RETURN
999 ERRORSEXITS("PETSC_MATSEQAIJGETARRAY",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("PETSC_MATSEQAIJGETARRAYF90",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATGETARRAY(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATGETARRAY",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATGETARRAY")
    RETURN
999 ERRORSEXITS("PETSC_MATGETARRAY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE PETSC_MATGETARRAYF90(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATGETARRAYF90",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATGETARRAYF90")
    RETURN
999 ERRORSEXITS("PETSC_MATGETARRAYF90",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("PETSC_MATCOLORINGSETTYPE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATGETCOLORING(A,COLORING_TYPE,ISCOLORING,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATGETCOLORING",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATGETCOLORING")
    RETURN
999 ERRORSEXITS("PETSC_MATGETCOLORING",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("PETSC_MATINITIALISE",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATDENSERESTOREARRAY(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATDENSERESTOREARRAY",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATDENSERESTOREARRAY")
    RETURN
999 ERRORSEXITS("PETSC_MATDENSERESTOREARRAY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE PETSC_MATSEQAIJRESTOREARRAY(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATSEQAIJRESTOREARRAY",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATSEQAIJRESTOREARRAY")
    RETURN
999 ERRORSEXITS("PETSC_MATSEQAIJRESTOREARRAY",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("PETSC_MATSEQAIJRESTOREARRAYF90",ERR,ERROR)
  ...
  SUBROUTINE PETSC_MATRESTOREARRAY(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATRESTOREARRAY",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATRESTOREARRAY")
    RETURN
999 ERRORSEXITS("PETSC_MATRESTOREARRAY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE PETSC_MATRESTOREARRAYF90(A,ARRAY,ERR,ERROR,*)
    ...
    ENTERS("PETSC_MATRESTOREARRAYF90",ERR,ERROR,*999)
    ...
    EXITS("PETSC_MATRESTOREARRAYF90")
    RETURN
999 ERRORSEXITS("PETSC_MATRESTOREARRAYF90",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("PETSC_SNESGETCONVERGEDREASON",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESGETFUNCTIONNORM(SNES_,FUNCTION_NORM,ERR,ERROR,*)
    ...
    ENTERS("PETSC_SNESGETFUNCTIONNORM",ERR,ERROR,*999)
    ...
    EXITS("PETSC_SNESGETFUNCTIONNORM")
    RETURN
999 ERRORSEXITS("PETSC_SNESGETFUNCTIONNORM",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("PETSC_SNESSETJACOBIAN_SOLVER",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESCOMPUTEJACOBIANDEFAULTCOLOR(SNES_,X,J,B,CTX,ERR,ERROR,*)
    ...
    EXITS("PETSC_SNESDEFAULTCOMPUTEJACOBIANCOLOR")
    RETURN
999 ERRORSEXITS("PETSC_SNESDEFAULTCOMPUTEJACOBIANCOLOR",ERR,ERROR)
    RETURN
...
999 ERRORSEXITS("PETSC_SNESDEFAULTCOMPUTEJACOBIANCOLOR",ERR,ERROR)
  ...
  SUBROUTINE PETSC_SNESDEFAULTCOMPUTEJACOBIAN(SNES_,X,J,B,FLAG,CTX,ERR,ERROR,*)
    ...
    RETURN
999 ERRORSEXITS("PETSC_SNESDEFAULTCOMPUTEJACOBIAN",ERR,ERROR)
    RETURN
...
!    ENTERS("PETSC_VECRESTOREARRAY",ERR,ERROR,*999)
...
!    EXITS("PETSC_VECRESTOREARRAY")
!    RETURN
!999 ERRORSEXITS("PETSC_VECRESTOREARRAY",ERR,ERROR)
!    EXITS("PETSC_VECRESTOREARRAY")
!    RETURN 1
