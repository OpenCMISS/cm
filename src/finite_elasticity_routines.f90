...
999 CALL ERRORS("FINITE_ELASTICITY_GAUSS_DFDZ",ERR,ERROR)
  ...
  SUBROUTINE FINITE_ELASTICITY_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    LOGICAL :: PURELY_NODAL_INTERPOLATION
    PURELY_NODAL_INTERPOLATION=.FALSE.
...
!kmith
            ...
            SELECT CASE(EQUATIONS_SET%SOLUTION_METHOD)
              CASE(EQUATIONS_SET_FEM_SOLUTION_METHOD)
                IF(PURELY_NODAL_INTERPOLATION) THEN
                  DO component_idx=1,NUMBER_OF_DIMENSIONS +1  !chrm76 19/02/10: Use node-based interpolation also for pressure
...
!                         CALL FLUID_MECHANICS_IO_WRITE_CMGUI(EQUATIONS_SET%REGION,"STATICSOLIDSOLUTION",ERR,ERROR,*999)
