...
!                   & FIELD_DELUDELN_VARIABLE_TYPE,NUMBER_OF_COMPONENTS,FIELD_ELEMENT_BASED_INTERPOLATION,ERR,ERROR,*999)
           ...
           CASE DEFAULT
             LOCAL_ERROR="The equations set subtype "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET_SUBTYPE,"*",ERR,ERROR))// &
...
999 CALL ERRORS("FINITE_ELASTICITY_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
  ...
  SUBROUTINE FiniteElasticity_EquationsSetSpecificationSet(equationsSet,specification,err,error,*)
    ...
    CALL Enters("FiniteElasticity_EquationsSetSpecificationSet",err,error,*999)
    ...
    IF(ASSOCIATED(equationsSet)) THEN
      ...
      CASE(EQUATIONS_SET_MEMBRANE_SUBTYPE,EQUATIONS_SET_MOONEY_RIVLIN_SUBTYPE, &
        ...
        END IF
        equationsSet%specification=[EQUATIONS_SET_ELASTICITY_CLASS,EQUATIONS_SET_FINITE_ELASTICITY_TYPE,subtype]
      CASE DEFAULT
    ...
    CALL Exits("FiniteElasticity_EquationsSetSpecificationSet")
    RETURN
999 CALL Errors("FiniteElasticity_EquationsSetSpecificationSet",err,error)
    CALL Exits("FiniteElasticity_EquationsSetSpecificationSet")
    RETURN 1
      ...
      CASE(PROBLEM_NO_SUBTYPE,PROBLEM_QUASISTATIC_FINITE_ELASTICITY_SUBTYPE,PROBLEM_FINITE_ELASTICITY_CELLML_SUBTYPE)
        ...
        CASE(PROBLEM_SETUP_CONTROL_TYPE)
          ...
          CASE(PROBLEM_SETUP_START_ACTION)
            ...
            IF(PROBLEM_SUBTYPE == PROBLEM_QUASISTATIC_FINITE_ELASTICITY_SUBTYPE) THEN
        ...
        CASE(PROBLEM_SETUP_SOLVERS_TYPE)
          ...
          CASE(PROBLEM_SETUP_START_ACTION)
            ...
            IF(PROBLEM_SUBTYPE==PROBLEM_FINITE_ELASTICITY_CELLML_SUBTYPE) THEN
...
999 CALL ERRORS("FiniteElasticity_ContactProblemSetup",ERR,ERROR)
  ...
  SUBROUTINE FiniteElasticity_ProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    CALL Enters("FiniteElasticity_ProblemSpecificationSet",err,error,*999)
    ...
    CALL Exits("FiniteElasticity_ProblemSpecificationSet")
    RETURN
999 CALL Errors("FiniteElasticity_ProblemSpecificationSet",err,error)
    CALL Exits("FiniteElasticity_ProblemSpecificationSet")
    RETURN 1
  ...
  SUBROUTINE FiniteElasticity_ContactProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    CALL Enters("FiniteElasticity_ContactProblemSpecificationSet",err,error,*999)
    ...
    CALL Exits("FiniteElasticity_ContactProblemSpecificationSet")
    RETURN
999 CALL Errors("FiniteElasticity_ContactProblemSpecificationSet",err,error)
    CALL Exits("FiniteElasticity_ContactProblemSpecificationSet")
    RETURN 1
              ...
              IF(ASSOCIATED(SOLVER_EQUATIONS)) THEN
                ...
                IF(ASSOCIATED(SOLVER_MAPPING)) THEN
                  ...
                  DO equations_set_idx=1,SOLVER_MAPPING%NUMBER_OF_EQUATIONS_SETS
                    ...
                    END IF
                    IF(EQUATIONS_SET%SPECIFICATION(3)==EQUATIONS_SET_CONSTITUTIVE_LAW_IN_CELLML_EVALUATE_SUBTYPE) THEN
                      VALID_SUBTYPE=.TRUE.
                  ...
                  IF(VALID_SUBTYPE .NEQV. .TRUE.) THEN
                    LOCAL_ERROR="The equations set subtype of number "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET%SPECIFICATION(3), &
                      & "*",ERR,ERROR))//"is not valid for a finite elasticity problem subtype of number "//TRIM( &
