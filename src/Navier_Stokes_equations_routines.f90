...
!
  ...
  SUBROUTINE NAVIER_STOKES_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_FLUID_MECHANICS_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE
      ...
      CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
                        ...
                        IF(ASSOCIATED(GEOMETRIC_FIELD)) THEN
                          ...
                          CASE(EQUATIONS_SET_NAVIER_STOKES_EQUATION_FlowrateAorta, &
                            ...
                            IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_1DTRANSIENT_NAVIER_STOKES_SUBTYPE .OR. &
                              ...
                              & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE .OR. &
        ...
        CASE(EQUATIONS_SET_SETUP_SOURCE_TYPE)
          ...
          CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
            ...
            & EQUATIONS_SET_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_TRANSIENT_RBS_NAVIER_STOKES_SUBTYPE, &
            & EQUATIONS_SET_COUPLED1D0D_ADV_NAVIER_STOKES_SUBTYPE)
        ...
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          ...
          CASE(PROBLEM_FLUID_MECHANICS_CLASS)
            ...
            CASE(PROBLEM_1DTRANSIENT_NAVIER_STOKES_SUBTYPE, &
              ...
              &  PROBLEM_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE, &
...
!
  ...
  SUBROUTINE NAVIER_STOKES_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CASE(PROBLEM_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE)
        PROBLEM%CLASS=PROBLEM_FLUID_MECHANICS_CLASS
        PROBLEM%TYPE=PROBLEM_NAVIER_STOKES_EQUATION_TYPE
        PROBLEM%SUBTYPE=PROBLEM_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      SELECT CASE(PROBLEM%SUBTYPE)
        ...
        CASE(PROBLEM_1DTRANSIENT_NAVIER_STOKES_SUBTYPE, &    !1D Navier-Stokes
           ...
           & PROBLEM_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE, & !  with coupled advection
          ...
          CASE(PROBLEM_SETUP_CONTROL_TYPE)
            ...
            CASE(PROBLEM_SETUP_START_ACTION)
              ...
              ELSE IF (PROBLEM%SUBTYPE == PROBLEM_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE) THEN
                NULLIFY(iterativeWhileLoop)
                ! The Characteristics branch solver/ Navier-Stokes iterative coupling loop
                CALL CONTROL_LOOP_NUMBER_OF_SUB_LOOPS_SET(CONTROL_LOOP,2,ERR,ERROR,*999)
                CALL CONTROL_LOOP_SUB_LOOP_GET(CONTROL_LOOP,1,iterativeWhileLoop,ERR,ERROR,*999)                
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN
        ...
        CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
          ...
          CASE(EQUATIONS_SET_1DTRANSIENT_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_COUPLED1D0D_NAVIER_STOKES_SUBTYPE, & 
             & EQUATIONS_SET_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_COUPLED1D0D_ADV_NAVIER_STOKES_SUBTYPE)
            DYNAMIC_MATRICES=>EQUATIONS_MATRICES%DYNAMIC_MATRICES
            STIFFNESS_MATRIX=>DYNAMIC_MATRICES%MATRICES(1)%PTR
            DAMPING_MATRIX=>DYNAMIC_MATRICES%MATRICES(2)%PTR
            NONLINEAR_MATRICES=>EQUATIONS_MATRICES%NONLINEAR_MATRICES
        ...
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          ...
          CASE(PROBLEM_FLUID_MECHANICS_CLASS)
            ...
            CASE(PROBLEM_1DTRANSIENT_NAVIER_STOKES_SUBTYPE,PROBLEM_COUPLED1D0D_NAVIER_STOKES_SUBTYPE, &
             & PROBLEM_1DTRANSIENT_ADV_NAVIER_STOKES_SUBTYPE,PROBLEM_COUPLED1D0D_ADV_NAVIER_STOKES_SUBTYPE)
              ! do nothing ???
            CASE(PROBLEM_PGM_NAVIER_STOKES_SUBTYPE)
