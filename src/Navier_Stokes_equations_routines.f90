                  ...
                  IF(UPDATE_NONLINEAR_RESIDUAL) THEN
                    ...
                    IF(mh==1) THEN
                      SUM=(((2.0_DP*K*Q_VALUE*Q_DERIV/A_VALUE)+(-K*A_DERIV*((Q_VALUE/A_VALUE)**2.0_DP))+ &   !Convective
                        ...
                        & ((((A_VALUE*SQRT(A0_PARAM))-(2.0_DP*(A_VALUE**1.5_DP)))/A0_PARAM)*A0_DERIV))* &    !Ref Area Gradient 
                        & Fr*Beta)*DXI_DX(1,1)+(Q_VALUE/A_VALUE)*Re)*PHIMS                                   !Viscosity
            ...
            IF(UPDATE_NONLINEAR_RESIDUAL) THEN
              ...
              DO nodeIdx=1,numberOfElementNodes
                ...
                DO versionIdx=1,ELEMENTS_TOPOLOGY%DOMAIN%TOPOLOGY%NODES%NODES(nodeNumber)% &
                  ...
                  Beta=(4.0_DP*(SQRT(PI))*E_PARAM*H0_PARAM)/(3.0_DP*A0_PARAM)  !(kg/m2/s2)
                  !Pressure equation
                  pressure=80.0_DP+(Beta/SQRT(As))*((SQRT(area))-SQRT(A0_PARAM))*0.0075_DP
      !            pressure=80.0_DP+((Beta/SQRT(As))*((SQRT(area))-SQRT(A0_PARAM))+0.5*1050.0*((Q_VALUE/A_VALUE)**2.0))*0.0075_DP
...
!    CALL EXITS("NAVIER_STOKES_FINITE_ELEMENT_RESIDUAL_EVALUATE")
  ...
  SUBROUTINE NAVIER_STOKES_FINITE_ELEMENT_JACOBIAN_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    REAL(DP) :: MU_PARAM,RHO_PARAM,A0_PARAM,A0_DERIV,E_PARAM,E_DERIV,H0_PARAM,H0_DERIV,Beta,St,Fr,Re,K
            ...
            IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_1DTRANSIENT_NAVIER_STOKES_SUBTYPE .OR. &
              ...
              DO nodeIdx=1,numberOfElementNodes
                ...
                IF(numberOfVersions>1)THEN
                  ...
                  CALL FIELD_PARAMETER_SET_DATA_GET(MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                    & materialsParameters,err,error,*999)
                  FIELD_VARIABLE=>MATERIALS_FIELD%VARIABLE_TYPE_MAP(FIELD_V_VARIABLE_TYPE)%PTR
                  A0_PARAM=materialsParameters(FIELD_VARIABLE%COMPONENTS(1)%PARAM_TO_DOF_MAP%NODE_PARAM2DOF_MAP% & 
                    & NODES(nodeNumber)%DERIVATIVES(1)%VERSIONS(versionIdx))
                  E_PARAM=materialsParameters(FIELD_VARIABLE%COMPONENTS(2)%PARAM_TO_DOF_MAP%NODE_PARAM2DOF_MAP% & 
                    & NODES(nodeNumber)%DERIVATIVES(1)%VERSIONS(versionIdx))
                  H0_PARAM=materialsParameters(FIELD_VARIABLE%COMPONENTS(3)%PARAM_TO_DOF_MAP%NODE_PARAM2DOF_MAP% &
                    & NODES(nodeNumber)%DERIVATIVES(1)%VERSIONS(versionIdx))
                  Beta=(4.0_DP*(SQRT(PI))*E_PARAM*H0_PARAM)/(3.0_DP*A0_PARAM)  !(kg/m2/s2)
                  CALL FIELD_PARAMETER_SET_DATA_RESTORE(MATERIALS_FIELD,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
                    & materialsParameters,err,error,*999)
...
!    CALL EXITS("NAVIER_STOKES_POST_SOLVE")
  ...
  SUBROUTINE NAVIER_STOKES_PRE_SOLVE_UPDATE_BOUNDARY_CONDITIONS(SOLVER,ERR,ERROR,*)
    ...
    REAL(DP) :: T_COORDINATES(20,3),MU_PARAM,RHO_PARAM,X(3)
...
!    CALL EXITS("NavierStokes_AnalyticCalculate")
  ...
  SUBROUTINE NAVIER_STOKES_ANALYTIC_FUNCTIONS_EVALUATE(ANALYTIC_FUNCTION_TYPE,X,TIME,VARIABLE_TYPE,GLOBAL_DERIV_INDEX, &
    ...
    REAL(DP) :: boundaryNormal(3),amplitude,offset,period,delta(500),t(500),q(500),s
    TYPE(VARYING_STRING) :: LOCAL_ERROR
...
t(201)=6.98E-01;q(201)=4.24E+00
               ...
               t(30)= 0.788    ; q(30)= 8.427783
               t(31)= 0.8123   ; q(31)= 8.427783
...
t	(	200	)	=	4.39E-01	;	q	(	200	)	=	-1.93E+00
t	(	201	)	=	4.41E-01	;	q	(	201	)	=	-2.54E+00
t	(	202	)	=	0.441	;	q	(	202	)	=	-3.54E+00
t	(	203	)	=	0.44321	;	q	(	203	)	=	-4.60E+00
t	(	204	)	=	0.44541	;	q	(	204	)	=	-4.60E+00
t	(	205	)	=	0.44762	;	q	(	205	)	=	-4.40E+00
t	(	206	)	=	0.44982	;	q	(	206	)	=	-4.20E+00
t	(	207	)	=	0.452	;	q	(	207	)	=	-2.17E+00
t	(	208	)	=	0.4542	;	q	(	208	)	=	5.32E-01
t	(	209	)	=	0.4564	;	q	(	209	)	=	6.45E+00
t	(	210	)	=	0.4586	;	q	(	210	)	=	1.60E+01
t	(	211	)	=	0.4609	;	q	(	211	)	=	2.81E+01
t	(	212	)	=	0.4631	;	q	(	212	)	=	4.98E+01
t	(	213	)	=	0.4653	;	q	(	213	)	=	7.15E+01
t	(	214	)	=	0.4675	;	q	(	214	)	=	1.06E+02
t	(	215	)	=	0.4697	;	q	(	215	)	=	1.41E+02
t	(	216	)	=	0.4719	;	q	(	216	)	=	1.76E+02
t	(	217	)	=	0.4741	;	q	(	217	)	=	2.12E+02
t	(	218	)	=	0.4763	;	q	(	218	)	=	2.48E+02
t	(	219	)	=	0.4785	;	q	(	219	)	=	2.92E+02
t	(	220	)	=	0.4807	;	q	(	220	)	=	3.35E+02
t	(	221	)	=	0.4829	;	q	(	221	)	=	3.75E+02
t	(	222	)	=	0.4851	;	q	(	222	)	=	4.13E+02
t	(	223	)	=	0.4873	;	q	(	223	)	=	4.47E+02
t	(	224	)	=	0.4895	;	q	(	224	)	=	4.77E+02
t	(	225	)	=	0.4917	;	q	(	225	)	=	5.06E+02
t	(	226	)	=	0.4939	;	q	(	226	)	=	5.28E+02
t	(	227	)	=	0.4961	;	q	(	227	)	=	5.51E+02
t	(	228	)	=	0.4984	;	q	(	228	)	=	5.68E+02
t	(	229	)	=	0.5006	;	q	(	229	)	=	5.85E+02
t	(	230	)	=	0.5028	;	q	(	230	)	=	6.00E+02
t	(	231	)	=	0.505	;	q	(	231	)	=	6.13E+02
t	(	232	)	=	0.5072	;	q	(	232	)	=	6.25E+02
t	(	233	)	=	0.5094	;	q	(	233	)	=	6.36E+02
t	(	234	)	=	0.5116	;	q	(	234	)	=	6.47E+02
t	(	235	)	=	0.5138	;	q	(	235	)	=	6.54E+02
t	(	236	)	=	0.516	;	q	(	236	)	=	6.61E+02
t	(	237	)	=	0.5182	;	q	(	237	)	=	6.63E+02
t	(	238	)	=	0.5204	;	q	(	238	)	=	6.64E+02
t	(	239	)	=	0.5226	;	q	(	239	)	=	6.62E+02
t	(	240	)	=	0.5248	;	q	(	240	)	=	6.58E+02
t	(	241	)	=	0.527	;	q	(	241	)	=	6.52E+02
t	(	242	)	=	0.5292	;	q	(	242	)	=	6.44E+02
t	(	243	)	=	0.5314	;	q	(	243	)	=	6.36E+02
t	(	244	)	=	0.5336	;	q	(	244	)	=	6.27E+02
t	(	245	)	=	0.5359	;	q	(	245	)	=	6.18E+02
t	(	246	)	=	0.5381	;	q	(	246	)	=	6.08E+02
t	(	247	)	=	0.5403	;	q	(	247	)	=	5.94E+02
t	(	248	)	=	0.542	;	q	(	248	)	=	5.80E+02
t	(	249	)	=	0.545	;	q	(	249	)	=	5.63E+02
t	(	250	)	=	0.547	;	q	(	250	)	=	5.46E+02
t	(	251	)	=	0.549	;	q	(	251	)	=	5.29E+02
t	(	252	)	=	0.551	;	q	(	252	)	=	5.12E+02
t	(	253	)	=	0.554	;	q	(	253	)	=	4.95E+02
t	(	254	)	=	0.556	;	q	(	254	)	=	4.79E+02
t	(	255	)	=	0.558	;	q	(	255	)	=	4.62E+02
t	(	256	)	=	0.56	;	q	(	256	)	=	4.47E+02
t	(	257	)	=	0.562	;	q	(	257	)	=	4.31E+02
t	(	258	)	=	0.565	;	q	(	258	)	=	4.17E+02
t	(	259	)	=	0.567	;	q	(	259	)	=	4.02E+02
t	(	260	)	=	0.569	;	q	(	260	)	=	3.87E+02
t	(	261	)	=	0.571	;	q	(	261	)	=	3.72E+02
t	(	262	)	=	0.573	;	q	(	262	)	=	3.57E+02
t	(	263	)	=	0.576	;	q	(	263	)	=	3.42E+02
t	(	264	)	=	0.578	;	q	(	264	)	=	3.27E+02
t	(	265	)	=	0.58	;	q	(	265	)	=	3.11E+02
t	(	266	)	=	0.582	;	q	(	266	)	=	2.95E+02
t	(	267	)	=	0.584	;	q	(	267	)	=	2.79E+02
t	(	268	)	=	0.587	;	q	(	268	)	=	2.63E+02
t	(	269	)	=	0.589	;	q	(	269	)	=	2.49E+02
t	(	270	)	=	0.591	;	q	(	270	)	=	2.37E+02
t	(	271	)	=	0.593	;	q	(	271	)	=	2.24E+02
t	(	272	)	=	0.595	;	q	(	272	)	=	2.10E+02
t	(	273	)	=	0.598	;	q	(	273	)	=	1.95E+02
t	(	274	)	=	0.6	;	q	(	274	)	=	1.81E+02
t	(	275	)	=	0.602	;	q	(	275	)	=	1.67E+02
t	(	276	)	=	0.604	;	q	(	276	)	=	1.53E+02
t	(	277	)	=	0.606	;	q	(	277	)	=	1.39E+02
t	(	278	)	=	0.609	;	q	(	278	)	=	1.26E+02
t	(	279	)	=	0.611	;	q	(	279	)	=	1.12E+02
t	(	280	)	=	0.613	;	q	(	280	)	=	9.87E+01
t	(	281	)	=	0.615	;	q	(	281	)	=	8.56E+01
t	(	282	)	=	0.617	;	q	(	282	)	=	7.26E+01
t	(	283	)	=	0.62	;	q	(	283	)	=	6.01E+01
t	(	284	)	=	0.622	;	q	(	284	)	=	4.79E+01
t	(	285	)	=	0.624	;	q	(	285	)	=	3.61E+01
t	(	286	)	=	0.626	;	q	(	286	)	=	2.50E+01
t	(	287	)	=	0.629	;	q	(	287	)	=	1.40E+01
t	(	288	)	=	0.631	;	q	(	288	)	=	5.11E+00
t	(	289	)	=	0.633	;	q	(	289	)	=	-3.82E+00
t	(	290	)	=	0.635	;	q	(	290	)	=	-1.04E+01
t	(	291	)	=	0.637	;	q	(	291	)	=	-1.64E+01
t	(	292	)	=	0.64	;	q	(	292	)	=	-2.06E+01
t	(	293	)	=	0.642	;	q	(	293	)	=	-2.33E+01
t	(	294	)	=	0.644	;	q	(	294	)	=	-2.53E+01
t	(	295	)	=	0.646	;	q	(	295	)	=	-2.52E+01
t	(	296	)	=	0.648	;	q	(	296	)	=	-2.50E+01
t	(	297	)	=	0.651	;	q	(	297	)	=	-2.36E+01
t	(	298	)	=	0.653	;	q	(	298	)	=	-2.21E+01
t	(	299	)	=	0.655	;	q	(	299	)	=	-2.05E+01
t	(	300	)	=	0.657	;	q	(	300	)	=	-1.83E+01
t	(	301	)	=	0.659	;	q	(	301	)	=	-1.61E+01
t	(	302	)	=	0.662	;	q	(	302	)	=	-1.38E+01
t	(	303	)	=	0.664	;	q	(	303	)	=	-1.16E+01
t	(	304	)	=	0.666	;	q	(	304	)	=	-9.38E+00
t	(	305	)	=	0.668	;	q	(	305	)	=	-7.09E+00
t	(	306	)	=	0.67	;	q	(	306	)	=	-4.72E+00
t	(	307	)	=	0.673	;	q	(	307	)	=	-2.22E+00
t	(	308	)	=	0.675	;	q	(	308	)	=	3.29E-01
t	(	309	)	=	0.677	;	q	(	309	)	=	3.11E+00
t	(	310	)	=	0.679	;	q	(	310	)	=	5.90E+00
t	(	311	)	=	0.681	;	q	(	311	)	=	8.83E+00
t	(	312	)	=	0.684	;	q	(	312	)	=	1.18E+01
t	(	313	)	=	0.686	;	q	(	313	)	=	1.46E+01
t	(	314	)	=	0.688	;	q	(	314	)	=	1.74E+01
t	(	315	)	=	0.69	;	q	(	315	)	=	2.00E+01
t	(	316	)	=	0.692	;	q	(	316	)	=	2.22E+01
t	(	317	)	=	0.695	;	q	(	317	)	=	2.44E+01
t	(	318	)	=	0.697	;	q	(	318	)	=	2.58E+01
t	(	319	)	=	0.699	;	q	(	319	)	=	2.73E+01
...
!               VALUE=0.5-0.5*cos(2*3.1416*CURRENT_TIME/800)
!if (CURRENT_TIME>800) then
!VALUE=0.5-0.5*cos(4*3.1416*CURRENT_TIME/800)
!endif
!if (CURRENT_TIME>1200) then
!VALUE=0.5-0.5*cos(8*3.1416*CURRENT_TIME/800)
!endif
             ELSE
         ...
         CASE(FIELD_U_VARIABLE_TYPE)
           ...
t(92)=2.082254;q(92)=3.806954
t(93)=2.091461;q(93)=3.217226
t(94)=2.102197;q(94)=2.701412
t(95)=2.109866;q(95)=2.332974
t(96)=2.122098;q(96)=2.924284
t(97)=2.131247;q(97)=4.179574
t(98)=2.137312;q(98)=6.098846
t(99)=2.189909;q(99)=37.615716
t(100)=2.198982;q(100)=41.232631
t(101)=2.209627;q(101)=43.595045
t(102)=2.22643;q(102)=44.924702
t(103)=2.243287;q(103)=44.556941
t(104)=2.266316;q(104)=42.713618
t(105)=2.289379;q(105)=39.837085
t(106)=2.318637;q(106)=34.746981
t(107)=2.349492;q(107)=27.59057
t(108)=2.446938;q(108)=-2.882015
t(109)=2.46543;q(109)=-6.496895
t(110)=2.476187;q(110)=-7.676916
t(111)=2.48693;q(111)=-8.414132
t(112)=2.500722;q(112)=-8.708318
t(113)=2.520612;q(113)=-8.116442
t(114)=2.555723;q(114)=-4.645208
t(115)=2.609158;q(115)=0.524799
t(116)=2.650402;q(116)=3.775083
t(117)=2.697826;q(117)=5.328402
t(118)=2.745287;q(118)=5.700909
t(119)=2.788164;q(119)=5.777874
t(120)=2.863218;q(120)=5.266807
t(121)=2.922957;q(121)=4.82841
t(122)=2.970442;q(122)=4.46291
t(123)=2.994946;q(123)=4.390918
...
!    CALL EXITS("NavierStokes_CalculateBoundaryFlux")
  ...
  SUBROUTINE NavierStokes_Couple1D0D(controlLoop,err,error,*)
    ...
    INTEGER(INTG) :: nodeIdx,derivativeIdx,versionIdx,componentIdx,numberOfLocalNodes1D,solver1DNavierStokesNumber,numberOfVersions
    INTEGER(INTG) :: globalIdx,i
    REAL(DP) :: A0_PARAM,E_PARAM,H0_PARAM,Beta,As,pCellML,aCellML,cCellML,El,qBoundary,aBoundary,areaCalculated,normalWave(2)
...
!    CALL ENTERS("NavierStokes_Couple1D0D",ERR,ERROR,*999)
    ...
    DO nodeIdx=1,numberOfLocalNodes1D
      ...
      numberOfVersions=dependentField%DECOMPOSITION%DOMAIN(dependentField%DECOMPOSITION%MESH_COMPONENT_NUMBER)%PTR% &
        & TOPOLOGY%NODES%NODES(nodeIdx)%DERIVATIVES(1)%numberofversions
      globalIdx=dependentField%DECOMPOSITION%DOMAIN(dependentField%DECOMPOSITION%MESH_COMPONENT_NUMBER)%PTR% &
        & TOPOLOGY%NODES%NODES(nodeIdx)%global_number
      ...
      IF(ABS(normalWave(1))>ZERO_TOLERANCE .AND. boundaryNode) THEN
        ...
        CALL Field_ParameterSetGetLocalNode(dependentField,FIELD_U1_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
          & versionIdx,derivativeIdx,3,1,cCellML,err,error,*999)
        
 !       El=400000*(1+cCellML/6.0)
 !       IF(El>600000) THEN
 !         DO i=20,67
 !           CALL FIELD_PARAMETER_SET_UPDATE_LOCAL_NODE(materialsField,FIELD_V_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
 !             & versionIdx,derivativeIdx,i,2,El,err,error,*999)
 !         ENDDO
 !       ENDIF       

        !Recalculate A at boundary node 
        aCellML=((pCellML*133.32_DP*SQRT(As)/Beta)+SQRT(A0_PARAM))**2.0_DP
