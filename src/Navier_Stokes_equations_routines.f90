...
!  PUBLIC  NAVIER_STOKES_FINITE_ELEMENT_CALCULATE ! needed for linear Stokes only
  PUBLIC NAVIER_STOKES_FINITE_ELEMENT_JACOBIAN_EVALUATE
  PUBLIC NAVIER_STOKES_FINITE_ELEMENT_RESIDUAL_EVALUATE
  PUBLIC NAVIER_STOKES_EQUATION_POST_SOLVE_SET
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
          ...
          SELECT CASE(EQUATIONS_SET%SUBTYPE)
            ...
            CASE(EQUATIONS_SET_TRANSIENT_NAVIER_STOKES_SUBTYPE)
!sebk 26/08/09 are the pointers correct?
!|
...
999 CALL ERRORS("NAVIER_STOKES_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR)
  ...
  SUBROUTINE NAVIER_STOKES_EQUATION_POST_SOLVE_SET(CONTROL_LOOP,EQUATIONS_SET,ERR,ERROR,*)
...
!    INTEGER(INTG) :: REGION_USER_NUMBER
    ...
    CALL ENTERS("NAVIER_STOKES_EQUATION_POST_SOLVE_SET",ERR,ERROR,*999)
!    NULLIFY(REGION)
  ...
  !          FILE="TRANSIENT_OUTPUT"
    ...
    CALL EXITS("NAVIER_STOKES_EQUATION_POST_SOLVE_SET")
    RETURN
999 CALL ERRORS("NAVIER_STOKES_EQUATION_POST_SOLVE_SET",ERR,ERROR)
    CALL EXITS("NAVIER_STOKES_EQUATION_POST_SOLVE_SET")
    RETURN 1
  END SUBROUTINE NAVIER_STOKES_EQUATION_POST_SOLVE_SET
