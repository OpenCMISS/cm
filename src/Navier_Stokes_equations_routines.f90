  ...
  SUBROUTINE NAVIER_STOKES_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
        & EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE, &
        & EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
        & EQUATIONS_SET_TRANSIENT_NAVIER_STOKES_SUBTYPE, &
        & EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE, &
        & EQUATIONS_SET_Multiscale3D_NAVIER_STOKES_SUBTYPE, &
        & EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE, &
...
!
  ...
  SUBROUTINE NAVIER_STOKES_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_FLUID_MECHANICS_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE
      ...
      CASE(EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_FLUID_MECHANICS_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE
      ...
      CASE(EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE)
        EQUATIONS_SET%CLASS=EQUATIONS_SET_FLUID_MECHANICS_CLASS
        EQUATIONS_SET%TYPE=EQUATIONS_SET_NAVIER_STOKES_EQUATION_TYPE
        EQUATIONS_SET%SUBTYPE=EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE
      ...
      CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE, &
            ...
            CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
              IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN
                ...
                CALL FIELD_NUMBER_OF_COMPONENTS_GET(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & DEPENDENT_FIELD_NUMBER_OF_COMPONENTS,ERR,ERROR,*999)
                IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE .OR. &
                 & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE .OR. &
        ...
        CASE(EQUATIONS_SET_SETUP_SOURCE_TYPE)
          ...
          CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
            ...
            & EQUATIONS_SET_1dTransientAdv_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE, &
            & EQUATIONS_SET_Coupled1D0DAdv_NAVIER_STOKES_SUBTYPE)
        ...
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          ...
          CASE(PROBLEM_FLUID_MECHANICS_CLASS)
            ...
            CASE(PROBLEM_TRANSIENT_NAVIER_STOKES_SUBTYPE)
              ...
              CALL NAVIER_STOKES_PRE_SOLVE_UPDATE_BOUNDARY_CONDITIONS(SOLVER,ERR,ERROR,*999)
            CASE(PROBLEM_TransientRBS_NAVIER_STOKES_SUBTYPE)
  ...
  SUBROUTINE NAVIER_STOKES_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CASE(PROBLEM_TransientRBS_NAVIER_STOKES_SUBTYPE)
        PROBLEM%CLASS=PROBLEM_FLUID_MECHANICS_CLASS
        PROBLEM%TYPE=PROBLEM_NAVIER_STOKES_EQUATION_TYPE
        PROBLEM%SUBTYPE=PROBLEM_TransientRBS_NAVIER_STOKES_SUBTYPE
      CASE(PROBLEM_Multiscale_NAVIER_STOKES_SUBTYPE)
        PROBLEM%CLASS=PROBLEM_FLUID_MECHANICS_CLASS
        PROBLEM%TYPE=PROBLEM_NAVIER_STOKES_EQUATION_TYPE
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      SELECT CASE(PROBLEM%SUBTYPE)
        ...
        CASE(PROBLEM_TRANSIENT_NAVIER_STOKES_SUBTYPE, &
           ...
           & PROBLEM_TransientRBS_NAVIER_STOKES_SUBTYPE, &
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN
        ...
        CASE(EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_LAPLACE_NAVIER_STOKES_SUBTYPE, &
          ...
          & EQUATIONS_SET_1dTransient_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_Coupled1D0D_NAVIER_STOKES_SUBTYPE, &
          & EQUATIONS_SET_1dTransientAdv_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE, &
          & EQUATIONS_SET_Multiscale3D_NAVIER_STOKES_SUBTYPE,EQUATIONS_SET_Coupled1D0DAdv_NAVIER_STOKES_SUBTYPE, &
          & EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE)
          ...
          DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
            ...
            IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_STATIC_NAVIER_STOKES_SUBTYPE.OR. &
              ...
              & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE.OR. &
              ...
              & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE.OR. &
                    ...
                    DO nh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                      ...
                      DO ns=1,DEPENDENT_BASIS2%NUMBER_OF_ELEMENT_PARAMETERS
                        ...
                        IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_TRANSIENT_NAVIER_STOKES_SUBTYPE.OR. &
                          ...
                          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE.OR. &
                          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_Multiscale3D_NAVIER_STOKES_SUBTYPE .OR. &
                          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
            ...
            !------------------------------------------------------------------
            IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_TransientRBS_NAVIER_STOKES_SUBTYPE.OR. &
              & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE.OR. &
              & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_Multiscale3D_NAVIER_STOKES_SUBTYPE) THEN
            ...
            CASE(PROBLEM_Multiscale_NAVIER_STOKES_SUBTYPE)
              ...
              DO equationsSetNumber=1,SOLVER%SOLVER_EQUATIONS%SOLVER_MAPPING%NUMBER_OF_EQUATIONS_SETS
                ...
                IF (SOLVER%SOLVER_EQUATIONS%SOLVER_MAPPING%EQUATIONS_SETS(equationsSetNumber)%PTR% &
                 &  EQUATIONS%EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ConstitutiveMu_NAVIER_STOKES_SUBTYPE) THEN
      ...
      IF(ASSOCIATED(SOLVERS)) THEN
        ...
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          ...
          CASE(PROBLEM_FLUID_MECHANICS_CLASS)
            ...
            CASE(PROBLEM_TRANSIENT_NAVIER_STOKES_SUBTYPE)
              ! do nothing ???
            CASE(PROBLEM_TransientRBS_NAVIER_STOKES_SUBTYPE,PROBLEM_Multiscale_NAVIER_STOKES_SUBTYPE)
              ! do nothing ???
        ...
        IF(ASSOCIATED(equations)) THEN
          ...
          IF(ASSOCIATED(equationsSetField)) THEN
            ...
            IF (stabilisationType > 0) THEN
              ...
              IF(equationsSet%SUBTYPE/=EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE .AND. timeIncrement < ZERO_TOLERANCE) THEN
              ...
              IF (equationsSet%SUBTYPE /= EQUATIONS_SET_StaticRBS_NAVIER_STOKES_SUBTYPE) THEN
...
999 CALL ERRORS("NavierStokes_CoupleCharacteristics",err,error)
  ...
  SUBROUTINE NavierStokes_ShearRateCalculate(equationsSet,ERR,ERROR,*)
    ...
    CALL ENTERS("NavierStokes_ShearRateCalculate",err,error,*999)
    ...
    CALL EXITS("NavierStokes_ShearRateCalculate")
    RETURN

999 CALL ERRORS("NavierStokes_ShearRateCalculate",ERR,ERROR)
    CALL EXITS("NavierStokes_ShearRateCalculate")
    RETURN 1
