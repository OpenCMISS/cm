...
CONTAINS
  ...
  SUBROUTINE CMISS_ERROR_HANDLING_MODE_GET(ERROR_HANDLING_MODE,ERR,ERROR,*)
    ...
    ENTERS("CMISS_ERROR_HANDLING_MODE_GET",ERR,ERROR,*999)

    ERROR_HANDLING_MODE=CMISS_ERROR_HANDLING_MODE
    
    EXITS("CMISS_ERROR_HANDLING_MODE_GET")
    RETURN
999 ERRORSEXITS("CMISS_ERROR_HANDLING_MODE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CMISS_ERROR_HANDLING_MODE_SET(ERROR_HANDLING_MODE,ERR,ERROR,*)
    ...
    ENTERS("CMISS_ERROR_HANDLING_MODE_SET",ERR,ERROR,*999)
    ...
    END SELECT
     ...
     EXITS("CMISS_ERROR_HANDLING_MODE_SET")
    RETURN
999 ERRORSEXITS("CMISS_ERROR_HANDLING_MODE_SET",ERR,ERROR)
    RETURN 1
