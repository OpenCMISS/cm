...
CONTAINS
  ...
  SUBROUTINE HELMHOLTZ_EQUATION_ANALYTIC_CALCULATE(EQUATIONS_SET,BOUNDARY_CONDITIONS,ERR,ERROR,*)
    ...
    ENTERS("HELMHOLTZ_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("HELMHOLTZ_EQUATION_ANALYTIC_CALCULATE")
    RETURN
999 ERRORSEXITS("HELMHOLTZ_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("HELMHOLTZ_EQUATION_EQUATIONS_SET_SETUP",ERR,ERROR)
  ...
  SUBROUTINE HELMHOLTZ_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("HELMHOLTZ_EQUATION_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
...
999 ERRORSEXITS("HELMHOLTZ_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE HELMHOLTZ_EQUATION_EQUATIONS_SET_STANDARD_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    EXITS("HELMHOLTZ_EQUATION_EQUATIONS_SET_STANDARD_SETUP")
    RETURN
999 ERRORSEXITS("HELMHOLTZ_EQUATION_EQUATIONS_SET_STANDARD_SETUP",ERR,ERROR)
    RETURN 1
