...
!          & %ptr%number_of_nodes_xi(2)-1.0)
        IF(EQUATIONS_SET%SPECIFICATION(3)==EQUATIONS_SET_1DTRANSIENT_NAVIER_STOKES_SUBTYPE.OR. &
...
!           !--- Remaining tensor material data of permeability tensor
        ...
        ELSE !default to FIELD_CONSTANT_INTERPOLATION
          ...
          IF(EQUATIONS_SET%SPECIFICATION(3)==EQUATIONS_SET_1DTRANSIENT_NAVIER_STOKES_SUBTYPE) THEN
...
!---toe
      ...
      IF( (EQUATIONS_SET%SPECIFICATION(1)==EQUATIONS_SET_FLUID_MECHANICS_CLASS) & 
        & .AND.(EQUATIONS_SET%SPECIFICATION(3)==EQUATIONS_SET_1DTRANSIENT_NAVIER_STOKES_SUBTYPE)) THEN
