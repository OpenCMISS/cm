...
CONTAINS
  ...
  SUBROUTINE DARCY_PRESSURE_FINITE_ELEMENT_RESIDUAL_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    REAL(DP) :: K(3,3),density,V_VALUE
    REAL(DP) :: DZDNU(3,3),SIGMA(3,3),DNUDZ(3,3),DNUDZT(3,3),TEMP_MATRIX(3,3),DZDNUT(3,3),AZL(3,3),AZU(3,3)
    REAL(DP) :: DXDNU(3,3),DNUDX(3,3)
    REAL(DP) :: Jznu,Jxxi,Jnuz,I3
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN
        ...
        CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_STATIC_INRIA_SUBTYPE, &
          ...
          DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
            ...
            CALL FINITE_ELASTICITY_GAUSS_DEFORMATION_GRADIENT_TENSOR(SOLID_DEPENDENT_INTERPOLATED_POINT, &
              & GEOMETRIC_INTERPOLATED_POINT,FIBRE_INTERPOLATED_POINT,NUMBER_OF_DIMENSIONS, &
              & SOLID_NUMBER_OF_XI,DZDNU,Jxxi,ERR,ERROR,*999)
