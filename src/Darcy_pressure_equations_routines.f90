...
MODULE DARCY_PRESSURE_EQUATIONS_ROUTINES
  ...
  PUBLIC DARCY_PRESSURE_EQUATION_FINITE_ELEMENT_CALCULATE,DARCY_PRESSURE_EQUATION_EQUATIONS_SET_SETUP, &
...
CONTAINS
  ...
  !>Calculates the element stiffness matrices and RHS for a Darcy pressure equation finite element equations set.
  SUBROUTINE DARCY_PRESSURE_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    CALL ENTERS("DARCY_PRESSURE_EQUATION_FINITE_ELEMENT_CALCULATE",ERR,ERROR,*999)
                    ...
                    DO ns=1,DEPENDENT_BASIS%NUMBER_OF_ELEMENT_PARAMETERS
                      ...
                      DO mi=1,DEPENDENT_BASIS%NUMBER_OF_XI
                        DO ni=1,DEPENDENT_BASIS%NUMBER_OF_XI
                          ...
                          SUM=SUM+PGMSI(mi)*PGNSI(ni)*TEMP_MATRIX(mi,ni)
                        ENDDO !ni
                      ENDDO !mi
    ...
    CALL EXITS("DARCY_PRESSURE_EQUATION_FINITE_ELEMENT_CALCULATE")
    RETURN
999 CALL ERRORS("DARCY_PRESSURE_EQUATION_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
    CALL EXITS("DARCY_PRESSURE_EQUATION_FINITE_ELEMENT_CALCULATE")
    RETURN 1
  END SUBROUTINE DARCY_PRESSURE_EQUATION_FINITE_ELEMENT_CALCULATE
