...
CONTAINS
  ...
  SUBROUTINE DARCY_PRESSURE_FINITE_ELEMENT_RESIDUAL_EVALUATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("DARCY_PRESSURE_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR,*999)
    ...
    EXITS("DARCY_PRESSURE_FINITE_ELEMENT_RESIDUAL_EVALUATE")
    RETURN
999 ERRORSEXITS("DARCY_PRESSURE_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR)
    RETURN 1
...
999 ERRORSEXITS("DARCY_PRESSURE_EQUATION_EQUATIONS_SET_SETUP",ERR,ERROR)
  ...
  SUBROUTINE DARCY_PRESSURE_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("DARCY_PRESSURE_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    EXITS("DARCY_PRESSURE_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("DARCY_PRESSURE_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE DARCY_PRESSURE_EQUATION_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    ENTERS("DARCY_PRESSURE_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("DARCY_PRESSURE_EQUATION_EQUATIONS_SET_SUBTYPE_SET")
    RETURN
999 ERRORSEXITS("DARCY_PRESSURE_EQUATION_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
    RETURN 1
