...
!!MERGE: move
  ...
  PUBLIC DATA_FITTING_EQUATIONS_SET_SETUP
  PUBLIC DATA_FITTING_EQUATIONS_SET_SUBTYPE_SET
  PUBLIC DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET

  PUBLIC DATA_FITTING_PROBLEM_SETUP
  PUBLIC DATA_FITTING_PROBLEM_SUBTYPE_SET

  PUBLIC DATA_FITTING_FINITE_ELEMENT_CALCULATE
...
! ! !   SUBROUTINE DATA_FITTING_ANALYTIC_CALCULATE(EQUATIONS_SET,ERR,ERROR,*)
! ! ! 
! ! !     !Argument variables
...
! ! !     
! ! !     CALL ENTERS("DATA_FITTING_ANALYTIC_CALCULATE",ERR,ERROR,*999)
! ! !     
...
! ! !                               CASE(EQUATIONS_SET_DATA_FITTING_TWO_DIM_1)
! ! !                                 !u=x^2+2.x.y-y^2
...
! ! !                                   CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
! ! !                                 END SELECT                                
! ! !                               CASE(EQUATIONS_SET_DATA_FITTING_TWO_DIM_2)
! ! !                                 !u=cos(x).cosh(y)
! ! !                                 SELECT CASE(variable_type)
! ! !                                 CASE(FIELD_U_VARIABLE_TYPE)
! ! !                                   SELECT CASE(DOMAIN_NODES%NODES(node_idx)%GLOBAL_DERIVATIVE_INDEX(deriv_idx))
...
! ! !                                   CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
! ! !                                 END SELECT                                
! ! !                               CASE(EQUATIONS_SET_DATA_FITTING_THREE_DIM_1)
! ! !                                 !u=x^2+y^2-2.z^2
! ! !                                 SELECT CASE(variable_type)
! ! !                                 CASE(FIELD_U_VARIABLE_TYPE)
! ! !                                   SELECT CASE(DOMAIN_NODES%NODES(node_idx)%GLOBAL_DERIVATIVE_INDEX(deriv_idx))
...
! ! !                                   CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
! ! !                                 END SELECT                                
! ! !                               CASE(EQUATIONS_SET_DATA_FITTING_THREE_DIM_2)
! ! !                                 !u=cos(x).cosh(y).z
! ! !                                 SELECT CASE(variable_type)
! ! !                                 CASE(FIELD_U_VARIABLE_TYPE)
! ! !                                   SELECT CASE(DOMAIN_NODES%NODES(node_idx)%GLOBAL_DERIVATIVE_INDEX(deriv_idx))
...
! ! !     ENDIF
! ! !     
! ! !     CALL EXITS("DATA_FITTING_ANALYTIC_CALCULATE")
! ! !     RETURN
! ! ! 999 CALL ERRORS("DATA_FITTING_ANALYTIC_CALCULATE",ERR,ERROR)
! ! !     CALL EXITS("DATA_FITTING_ANALYTIC_CALCULATE")
! ! !     RETURN 1
! ! !   END SUBROUTINE DATA_FITTING_ANALYTIC_CALCULATE
  ...
  SUBROUTINE DATA_FITTING_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_FITTING_FINITE_ELEMENT_CALCULATE",ERR,ERROR,*999)
...
!-----------------------------------------------------------------------------------------------------------------------------------
    ...
    CALL EXITS("DATA_FITTING_FINITE_ELEMENT_CALCULATE")
    RETURN
999 CALL ERRORS("DATA_FITTING_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
    CALL EXITS("DATA_FITTING_FINITE_ELEMENT_CALCULATE")
    RETURN 1
  END SUBROUTINE DATA_FITTING_FINITE_ELEMENT_CALCULATE
  ...
  SUBROUTINE DATA_FITTING_EQUATIONS_SET_MAT_PROPERTIES_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
...
!     TYPE(FIELD_TYPE), POINTER :: ANALYTIC_FIELD,DEPENDENT_FIELD,GEOMETRIC_FIELD
    ...
    CALL ENTERS("DATA_FITTING_EQUATIONS_SET_MAT_PROPERTIES_SETUP",ERR,ERROR,*999)
      ...
      IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_MAT_PROPERTIES_DATA_FITTING_SUBTYPE.OR. &
        ...
        CASE(EQUATIONS_SET_SETUP_INITIAL_TYPE)
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            CALL DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,EQUATIONS_SET_FEM_SOLUTION_METHOD, &
              & ERR,ERROR,*999)
...
! ! !                     EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_DATA_FITTING_TWO_DIM_1
! ! !                   CASE(EQUATIONS_SET_DATA_FITTING_TWO_DIM_2)
! ! !                     !Check that we are in 2D
! ! !                     IF(NUMBER_OF_DIMENSIONS/=2) THEN
! ! !                       LOCAL_ERROR="The number of geometric dimensions of "// &
...
! ! !                     !Create analytic field if required
! ! !                     !Set analtyic function type
! ! !                     EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_DATA_FITTING_TWO_DIM_2
! ! !                   CASE(EQUATIONS_SET_DATA_FITTING_THREE_DIM_1)
...
! ! !                     !Create analytic field if required
! ! !                     !Set analtyic function type
! ! !                     EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_DATA_FITTING_THREE_DIM_1
! ! !                   CASE(EQUATIONS_SET_DATA_FITTING_THREE_DIM_2)
! ! !                     !Check that we are in 3D
! ! !                     IF(NUMBER_OF_DIMENSIONS/=3) THEN
! ! !                       LOCAL_ERROR="The number of geometric dimensions of "// &
...
! ! !                     !Create analytic field if required
! ! !                     !Set analtyic function type
! ! !                     EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE=EQUATIONS_SET_DATA_FITTING_THREE_DIM_2
! ! !                   CASE DEFAULT
...
! ! !                   CALL DATA_FITTING_ANALYTIC_CALCULATE(EQUATIONS_SET,ERR,ERROR,*999)
! ! !                 ELSE
...
! ! !           END SELECT
    ...
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_MAT_PROPERTIES_SETUP")
    RETURN
999 CALL ERRORS("DATA_FITTING_EQUATIONS_SET_MAT_PROPERTIES_SETUP",ERR,ERROR)
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_MAT_PROPERTIES_SETUP")
    RETURN 1
  END SUBROUTINE DATA_FITTING_EQUATIONS_SET_MAT_PROPERTIES_SETUP
  ...
  SUBROUTINE DATA_FITTING_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_FITTING_EQUATIONS_SET_SETUP",ERR,ERROR,*999)

    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      SELECT CASE(EQUATIONS_SET%SUBTYPE)
      CASE(EQUATIONS_SET_STANDARD_DATA_FITTING_SUBTYPE)
        CALL DATA_FITTING_EQUATIONS_SET_STANDARD_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*999)
      CASE(EQUATIONS_SET_MAT_PROPERTIES_DATA_FITTING_SUBTYPE, &
        & EQUATIONS_SET_MAT_PROPERTIES_INRIA_MODEL_GALERKIN_PROJ_SUBTYPE)
        CALL DATA_FITTING_EQUATIONS_SET_MAT_PROPERTIES_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*999)
      CASE(EQUATIONS_SET_GENERALISED_DATA_FITTING_SUBTYPE)
        CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
      CASE DEFAULT
        LOCAL_ERROR="Equations set subtype "//TRIM(NUMBER_TO_VSTRING(EQUATIONS_SET%SUBTYPE,"*",ERR,ERROR))// &
    ...
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_SETUP")
    RETURN
999 CALL ERRORS("DATA_FITTING_EQUATIONS_SET_SETUP",ERR,ERROR)
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_SETUP")
    RETURN 1
  END SUBROUTINE DATA_FITTING_EQUATIONS_SET_SETUP
  ...
  SUBROUTINE DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 CALL ERRORS("DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN 1
  END SUBROUTINE DATA_FITTING_EQUATIONS_SET_SOLUTION_METHOD_SET
  ...
  SUBROUTINE DATA_FITTING_EQUATIONS_SET_SUBTYPE_SET(EQUATIONS_SET,EQUATIONS_SET_SUBTYPE,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_FITTING_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_SUBTYPE_SET")
    RETURN
999 CALL ERRORS("DATA_FITTING_EQUATIONS_SET_SUBTYPE_SET",ERR,ERROR)
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_SUBTYPE_SET")
    RETURN 1
  END SUBROUTINE DATA_FITTING_EQUATIONS_SET_SUBTYPE_SET
  ...
  SUBROUTINE DATA_FITTING_EQUATIONS_SET_STANDARD_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
...
!     TYPE(FIELD_TYPE), POINTER :: ANALYTIC_FIELD,DEPENDENT_FIELD,GEOMETRIC_FIELD
    ...
    CALL ENTERS("DATA_FITTING_EQUATION_SET_STANDARD_SETUP",ERR,ERROR,*999)
...
! ! !           END SELECT
    ...
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_STANDARD_SETUP")
    RETURN
999 CALL ERRORS("DATA_FITTING_EQUATIONS_SET_STANDARD_SETUP",ERR,ERROR)
    CALL EXITS("DATA_FITTING_EQUATIONS_SET_STANDARD_SETUP")
    RETURN 1
  END SUBROUTINE DATA_FITTING_EQUATIONS_SET_STANDARD_SETUP
  ...
  SUBROUTINE DATA_FITTING_PROBLEM_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_FITTING_PROBLEM_SETUP",ERR,ERROR,*999)

    IF(ASSOCIATED(PROBLEM)) THEN
      SELECT CASE(PROBLEM%SUBTYPE)
      CASE(PROBLEM_STANDARD_DATA_FITTING_SUBTYPE)
        CALL DATA_FITTING_PROBLEM_STANDARD_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*999)
    ...
    CALL EXITS("DATA_FITTING_PROBLEM_SETUP")
    RETURN
999 CALL ERRORS("DATA_FITTING_PROBLEM_SETUP",ERR,ERROR)
    CALL EXITS("DATA_FITTING_PROBLEM_SETUP")
    RETURN 1
  END SUBROUTINE DATA_FITTING_PROBLEM_SETUP
  ...
  SUBROUTINE DATA_FITTING_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_FITTING_PROBLEM_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("DATA_FITTING_PROBLEM_SUBTYPE_SET")
    RETURN
999 CALL ERRORS("DATA_FITTING_PROBLEM_SUBTYPE_SET",ERR,ERROR)
    CALL EXITS("DATA_FITTING_PROBLEM_SUBTYPE_SET")
    RETURN 1
  END SUBROUTINE DATA_FITTING_PROBLEM_SUBTYPE_SET
  ...
  SUBROUTINE DATA_FITTING_PROBLEM_STANDARD_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_FITTING_PROBLEM_STANDARD_SETUP",ERR,ERROR,*999)
    ...
    CALL EXITS("DATA_FITTING_PROBLEM_STANDARD_SETUP")
    RETURN
999 CALL ERRORS("DATA_FITTING_PROBLEM_STANDARD_SETUP",ERR,ERROR)
    CALL EXITS("DATA_FITTING_PROBLEM_STANDARD_SETUP")
    RETURN 1
  END SUBROUTINE DATA_FITTING_PROBLEM_STANDARD_SETUP
  ...
  SUBROUTINE DATA_FITTING_GAUSS_DEFORMATION_GRADIENT_TENSOR(REFERENCE_GEOMETRIC_INTERPOLATED_POINT, &
    ...
    CALL ENTERS("DATA_FITTING_GAUSS_DEFORMATION_GRADIENT_TENSOR",ERR,ERROR,*999)
    ...
    CALL EXITS("DATA_FITTING_GAUSS_DEFORMATION_GRADIENT_TENSOR")
    RETURN
999 CALL ERRORS("DATA_FITTING_GAUSS_DEFORMATION_GRADIENT_TENSOR",ERR,ERROR)
    CALL EXITS("DATA_FITTING_GAUSS_DEFORMATION_GRADIENT_TENSOR")
    RETURN 1
  END SUBROUTINE DATA_FITTING_GAUSS_DEFORMATION_GRADIENT_TENSOR

  !
  !================================================================================================================================

 
END MODULE DATA_FITTING_ROUTINES
