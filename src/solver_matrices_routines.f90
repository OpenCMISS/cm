...
MODULE SOLVER_MATRICES_ROUTINES
  ...
  PUBLIC SOLVER_MATRICES_ALL,SOLVER_MATRICES_DYNAMIC_ONLY,SOLVER_MATRICES_LINEAR_ONLY,SOLVER_MATRICES_NONLINEAR_ONLY, &
    & SOLVER_MATRICES_JACOBIAN_ONLY,SOLVER_MATRICES_RESIDUAL_ONLY,SOLVER_MATRICES_RHS_ONLY,SOLVER_MATRICES_RHS_RESIDUAL_ONLY
