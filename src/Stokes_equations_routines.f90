...
!
  ...
  SUBROUTINE STOKES_EQUATIONS_SET_SOLUTION_METHOD_SET(EQUATIONS_SET,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("STOKES_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    EXITS("STOKES_EQUATIONS_SET_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("STOKES_EQUATIONS_SET_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
...
! ! !     INTEGER(INTG) :: number_of_element_nodes,temp_local_ny,temp_node_number,velocity_DOF_check,temp_local_node_number    
    ...
    ENTERS("STOKES_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR,*999)
...
! ! !             ENDIF
  ...
  WRITE(*,*)'NUMBER OF BOUNDARIES SET ',BOUND_COUNT
    ...
    EXITS("STOKES_EQUATION_ANALYTIC_CALCULATE")
    RETURN
999 ERRORSEXITS("STOKES_EQUATION_ANALYTIC_CALCULATE",ERR,ERROR)
    RETURN 1    
