...
999 CALL ERRORS("STOKES_EQUATION_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
  ...
  SUBROUTINE STOKES_EQUATION_POST_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*)
...
!    NULLIFY(REGION)
  ...
  !                    FILE="TRANSIENT_OUTPUT"
    ...
    CALL EXITS("STOKES_EQUATION_POST_SOLVE")
    RETURN
999 CALL ERRORS("STOKES_EQUATION_POST_SOLVE",ERR,ERROR)
    CALL EXITS("STOKES_EQUATION_POST_SOLVE")
    RETURN 1
  END SUBROUTINE STOKES_EQUATION_POST_SOLVE
