    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
     ...
     CASE(EQUATIONS_SET_HJ_EQUATION_TYPE)
      ...
      CASE(EQUATIONS_SET_BIHARMONIC_EQUATION_TYPE)
        CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
      CASE(EQUATIONS_SET_BURGERS_EQUATION_TYPE)
        CALL BURGERS_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*999)
      CASE DEFAULT
...
999 CALL ERRORS("CLASSICAL_FIELD_PROBLEM_SETUP",ERR,ERROR)
  ...
  SUBROUTINE CLASSICAL_FIELD_PRE_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
      ...
      CASE(PROBLEM_BURGERS_EQUATION_TYPE)
        CALL BURGERS_EQUATION_PRE_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*999)
      CASE DEFAULT
