!> \file
!> $Id: classical_field_routines.f90 28 2007-07-27 08:35:14Z cpb $
...
MODULE CLASSICAL_FIELD_ROUTINES
  ...
  PUBLIC CLASSICAL_FIELD_EQUATIONS_SET_CLASS_TYPE_SET,CLASSICAL_FIELD_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE, &
...
999 CALL ERRORS("CLASSICAL_FIELD_EQUATIONS_SET_CLASS_TYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE CLASSICAL_FIELD_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    CALL ENTERS("CLASSICAL_FIELD_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE",ERR,ERROR,*999)

    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      SELECT CASE(EQUATIONS_SET%TYPE)
      CASE(EQUATIONS_SET_LAPLACE_EQUATION_TYPE)
        CALL LAPLACE_EQUATION_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*999)
      CASE(EQUATIONS_SET_POISSON_EQUATION_TYPE)
        CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
      CASE(EQUATIONS_SET_HELMHOLTZ_EQUATION_TYPE)
        CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
    ...
    CALL EXITS("CLASSICAL_FIELD_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE")
    RETURN
999 CALL ERRORS("CLASSICAL_FIELD_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
    CALL EXITS("CLASSICAL_FIELD_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE")
    RETURN 1
  END SUBROUTINE CLASSICAL_FIELD_EQUATIONS_SET_FINITE_ELEMENT_CALCULATE
