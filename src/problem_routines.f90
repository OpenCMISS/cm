            ...
            IF(ASSOCIATED(PROBLEM_SOLUTION%PROBLEM)) THEN
              ...
              IF(ASSOCIATED(DEPENDENT_FIELD)) THEN                
                ...
                DO matrix_idx=1,GLOBAL_MATRICES%NUMBER_OF_MATRICES
                  ...
                  CALL DISTRIBUTED_MATRIX_CREATE_START(DEPENDENT_VARIABLE_DOMAIN_MAP,DISTRIBUTED_MATRIX_VECTOR_CMISS_TYPE, &
                    & GLOBAL_MATRICES%MATRICES(matrix_idx)%MATRIX,ERR,ERROR,*999)
                  ...
                  IF(GLOBAL_MATRICES%MATRICES(matrix_idx)%STORAGE_TYPE/=MATRIX_BLOCK_STORAGE_TYPE) THEN
                    CALL PROBLEM_GLOBAL_MATRIX_STRUCTURE_CALCULATE(GLOBAL_MATRICES,matrix_idx,NUMBER_OF_NON_ZEROS,ROW_INDICES, &
