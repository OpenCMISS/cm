  ...
  SUBROUTINE PROBLEM_INTERPOLATION_INITIALISE(PROBLEM_SOLUTION,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM_SOLUTION)) THEN
      ...
      ELSE
        ...
        CALL FIELD_INTERPOLATION_PARAMETERS_INITIALISE(PROBLEM_SOLUTION%INTERPOLATION%GEOMETRIC_FIELD,FIELD_STANDARD_VARIABLE_TYPE, &
          & PROBLEM_SOLUTION%INTERPOLATION%GEOMETRIC_INTERP_PARAMETERS,ERR,ERROR,*999)
        ...
        CALL FIELD_INTERPOLATION_PARAMETERS_INITIALISE(PROBLEM_SOLUTION%INTERPOLATION%DEPENDENT_FIELD,FIELD_STANDARD_VARIABLE_TYPE, &
          & PROBLEM_SOLUTION%INTERPOLATION%DEPENDENT_INTERP_PARAMETERS,ERR,ERROR,*999)
        ...
        IF(ASSOCIATED(PROBLEM_SOLUTION%INTERPOLATION%FIBRE_FIELD)) THEN
          CALL FIELD_INTERPOLATION_PARAMETERS_INITIALISE(PROBLEM_SOLUTION%INTERPOLATION%FIBRE_FIELD,FIELD_STANDARD_VARIABLE_TYPE,  &
            & PROBLEM_SOLUTION%INTERPOLATION%FIBRE_INTERP_PARAMETERS,ERR,ERROR,*999)
        ...
        IF(ASSOCIATED(PROBLEM_SOLUTION%INTERPOLATION%MATERIAL_FIELD)) THEN
          CALL FIELD_INTERPOLATION_PARAMETERS_INITIALISE(PROBLEM_SOLUTION%INTERPOLATION%MATERIAL_FIELD,FIELD_STANDARD_VARIABLE_TYPE,  &
            & PROBLEM_SOLUTION%INTERPOLATION%MATERIAL_INTERP_PARAMETERS,ERR,ERROR,*999)
        ...
        IF(ASSOCIATED(PROBLEM_SOLUTION%INTERPOLATION%SOURCE_FIELD)) THEN
          CALL FIELD_INTERPOLATION_PARAMETERS_INITIALISE(PROBLEM_SOLUTION%INTERPOLATION%SOURCE_FIELD,FIELD_STANDARD_VARIABLE_TYPE,  &
            & PROBLEM_SOLUTION%INTERPOLATION%SOURCE_INTERP_PARAMETERS,ERR,ERROR,*999)
