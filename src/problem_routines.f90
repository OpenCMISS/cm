...
999 CALL ERRORS("PROBLEM_CONTROL_LOOP_GET_1",ERR,ERROR)
  ...
  SUBROUTINE PROBLEM_SETUP(PROBLEM,PROBLEM_SETUP_INFO,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CASE(PROBLEM_FITTING_FIELD_CLASS)
        CALL FITTING_FIELD_PROBLEM_SETUP(PROBLEM,PROBLEM_SETUP_INFO,ERR,ERROR,*999)
      ...
      IF(ASSOCIATED(SOLVERS)) THEN
        ...
        IF(ASSOCIATED(CONTROL_LOOP)) THEN
          ...
          IF(ASSOCIATED(PROBLEM)) THEN
            ...
            CASE(PROBLEM_FITTING_FIELD_CLASS)
              CALL FITTING_FIELD_PRE_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*999)
            CASE(PROBLEM_MODAL_CLASS)
              !Do nothing???
            CASE(PROBLEM_MULTI_PHYSICS_CLASS)
      ...
      IF(ASSOCIATED(SOLVERS)) THEN
        ...
        IF(ASSOCIATED(CONTROL_LOOP)) THEN
          ...
          IF(ASSOCIATED(PROBLEM)) THEN
            ...
            CASE(PROBLEM_FITTING_FIELD_CLASS)
              CALL FITTING_FIELD_POST_SOLVE(CONTROL_LOOP,SOLVER,ERR,ERROR,*999)
            CASE(PROBLEM_MODAL_CLASS)
              !Do nothing???
            CASE(PROBLEM_MULTI_PHYSICS_CLASS)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      ELSE
        ...
        CASE(PROBLEM_MODAL_CLASS)
          CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
        CASE(PROBLEM_FITTING_FIELD_CLASS)
          CALL FITTING_FIELD_PROBLEM_CLASS_TYPE_SET(PROBLEM,PROBLEM_EQUATION_TYPE,PROBLEM_SUBTYPE,ERR,ERROR,*999)
        CASE(PROBLEM_OPTIMISATION_CLASS)
          CALL FLAG_ERROR("Not implemented.",ERR,ERROR,*999)
        CASE(PROBLEM_MULTI_PHYSICS_CLASS)
