...
999 CALL ERRORS("PROBLEM_ANALYTIC_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE PROBLEM_ASSEMBLE_LINEAR_STATIC_FEM(PROBLEM,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      CALL FIELD_PARAMETER_SET_UPDATE_START(PROBLEM%DEPENDENT%%DEPENDENT_FIELD,FIELD_VALUES_SET_TYPE,ERR,ERROR,*999)
...
999 CALL ERRORS("PROBLEM_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE PROBLEM_GLOBAL_MATRIX_FINALISE(GLOBAL_MATRIX,ERR,ERROR,*)
    ...
    IF(ALLOCATED(GLOBAL_MATRIX%SOLVER_COLUMN_MAP)) THEN
      ...
      ENDDO !ny
      DEALLOCATE(GLOBAL_MATRIX%SOLVER_COLUMN_MAP(ny),ERR,ERROR,*999)
    ENDIF
    IF(ASSOCIATED(GLOBAL_MATRIX%MATRIX)) CALL DISTRIBUTED_MATRIX_DESTORY(GLOBAL_MATRIX%MATRIX,ERR,ERROR,*999)
    CALL PROBLEM_ELEMENT_MATRIX_FINALISE(GLOBAL_MATRIX%ELEMENT_MATRIX,ERR,ERROR,*999)
...
999 CALL ERRORS("PROBLEM_GLOBAL_MATRIX_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE PROBLEM_GLOBAL_MATRIX_INITIALISE(GLOBAL_MATRIX,ERR,ERROR,*)
    ...
    CALL PROBLEM_ELEMENT_MATRIX_INITIALISE(GLOBAL_MATRIX,ERR,ERROR,*999)
  ...
  SUBROUTINE PROBLEM_GLOBAL_MATRICES_FINALISE(PROBLEM_SOLUTION,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM_SOLUTION)) THEN
      IF(ASSOCIATED(PROBLEM_SOLUTION%GLOBAL_MATRICES)) THEN
        ...
        CALL PROBLEM_ELEMENT_VECTOR_FINALISE(PROBLEM_SOLUTION%GLOBAL_MATRICES,ERR,ERROR,*999)
  ...
  SUBROUTINE PROBLEM_GLOBAL_MATRICES_INITIALISE(PROBLEM_SOLUTION,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM_SOLUTION)) THEN
      ...
      ELSE
        ...
        ENDDO !matrix_idx
        PROBLEM_SOLUTION%GLOBAL_MATRICES%UPDATE_VECTOR=.FALSE.
        NULLIFY(PROBLEM_SOLUTION%GLOBAL_MATRICES%VECTOR)
        CALL PROBLEM_ELEMENT_VECTOR_INITIALISE(PROBLEM_SOLUTION%GLOBAL_MATRICES,ERR,ERROR,*999)
      ENDIF
    ELSE
      CALL FLAG_ERROR("Problem solution is not associated",ERR,ERROR,*999)
    ENDIF
  ...
  SUBROUTINE PROBLEM_SOLVER_MATRICES_FINALISE(PROBLEM_SOLUTION,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(PROBLEM_SOLUTION)) THEN
      IF(ASSOCIATED(PROBLEM_SOLUTION%SOLVER_MATRICES)) THEN
        IF(ALLOCATED(PROBLEM%SOLUTION%SOLVER_MATRICES%SOLVER_TO_GLOBAL_MAP)) THEN
