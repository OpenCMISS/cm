...
\newcommand{\christoffel}[3]{\christoffel2{#1}{#2}{#3}} % Christoffel symbol
                                % (defaults to Christoffel symbol of the
                                % second kind)
\newcommand{\christoffel1}[3]{\ensuremath{ %
    \Gamma_{#1#2#3}
    }} % Christoffel symbol of the first kind e.g. \christoffel{i}{j}{k} => Gamma_{ijk}
\newcommand{\christoffel2}[3]{\ensuremath{ %
    \Gamma_{#1#2}^{#3}
    }} % Christoffel symbol of the second kinde.g. \christoffel{i}{j}{k} => Gamma_{ij}^[k}
\newcommand{\covarderiv}[2]{\ensuremath{ %
    \brac{.}{#1}{|}_{#2}
    }} % covariant derivative e.g. \covarderiv{i}{j} => i | _{j}
\newcommand{\contraderiv}[2]{\ensuremath{ %
    \brac{.}{#1}{|}^{#2}
    }} % contravariant derivative e.g. \contraderiv{i}{j} => i | ^{j}
