...
\begin{equation}
  \matr{M}\ddot{\fnof{\vect{u}}{t}}+\matr{C}\dot{\fnof{\vect{u}}{t}}+\matr{K}\fnof{\vect{u}}{t}+
...
\begin{equation}
  \fnof{\vect{u}}{t_{n}+\tau}\approx\fnof{\hat{\vect{u}}}{t_{n}+\tau}=\vect{u}_{n}+\tau\dot{\vect{u}}_{n}+
...
\begin{equation}
\theta_{1}=\dfrac{\gint{0}{\Delta t}{\fnof{W}{\tau}\tau}{\tau}}{\gint{0}{\Delta t}{\fnof{W}{\tau}}{\tau}}
\end{equation}
we can write
\begin{equation}
  \dfrac{\gint{0}{\Delta t}{\fnof{W}{\tau}\fnof{\vect{g}}{\fnof{\vect{u}}{t_{n+1}}}}{\tau}}
