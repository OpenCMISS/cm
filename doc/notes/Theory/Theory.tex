...
In order to indicate an index that is not summed then parenthases will be used
\ie $a^{(i)}b_{(i)}$ is talking about the singular expession for $i$ \eg
...
Note that if the base vectors are all mutually orthogonal and constant then
